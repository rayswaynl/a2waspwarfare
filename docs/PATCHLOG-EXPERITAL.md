...
### New Structures
- **Federal Reserve / Bank Rossii.** 9,500 supply. Must be placed at least 800 m from HQ/base area; one per side; marked on map for both sides. Pays a $6,000 pool per 5 min split among living players while HQ stands. Destruction reward: +10,000 side supply + $25,000 to the killer.
