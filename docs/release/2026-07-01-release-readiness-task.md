...
- PR #125, `[codex] Prepare WASP release command center`, branch `codex/release-command-center-20260630`: broad release command-center candidate with tooling, package provenance, AICOM work, and runtime collection gates. Current source/package head observed: `64cbc79b185d30193d3eed7b27cbdd5219550187` / marker `64cbc79b18`. The latest deltas remove the uncompiled AICOM HC top-up draft worker/wiring and dead draft top-up payload from both maintained terrains, remove stale supervisor private declarations, and tighten the static smoke guard for forbidden draft tokens. PR #125 and the public wiki now record `_MISSIONS.7z` SHA256 `5739E0479AC9ABC396619D8B63A94FEA2AD052E21D0EEE459726E1448BC2D0FB`, `1,877` entries, `7,133,389` bytes, handoff status `ready_for_runtime_collection`. This proves package identity only; exact Chernarus and Takistan runtime RPT proof is still pending, and GitHub still reports PR #125 conflicting against `master`.
...
| `rayswaynl/a2waspwarfare.wiki` | Cloned locally and synced through wiki commit `624f1f3`, which records the PR #125 package tuple for `64cbc79b18`: `_MISSIONS.7z` SHA256 `5739E0479AC9ABC396619D8B63A94FEA2AD052E21D0EEE459726E1448BC2D0FB`, `1,877` entries, `7,133,389` bytes, handoff `ready_for_runtime_collection`. The wiki still treats runtime/deploy evidence as pending. Wiki commit hashes are not release identities; use the package/git/archive tuple and RPT markers for release proof. | Wiki freshness and release-doc synchronization. |
...
9. Existing release PRs already agree on the main gate: source/static/package checks are not enough.
   ...
   - PR #125 now has package/handoff proof for `64cbc79b18` / `_MISSIONS.7z` SHA256 `5739E0479AC9ABC396619D8B63A94FEA2AD052E21D0EEE459726E1448BC2D0FB`, but that is still package/tooling proof, not final runtime proof. PR #126 and PR #131 artifacts remain companion/tooling proof unless explicitly promoted into the active package lane.
