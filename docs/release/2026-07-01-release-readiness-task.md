...
3. Wiki/player guide stale on AI commander status.
   ...
   - Action: update repo guide and wiki `Commanders-Handbook`/AI commander pages after the active release candidate is chosen.
...
4. Briefing content has inconsistent economy numbers.
   ...
   - Action: confirm the actual constants/code path, then make HTML, SQF diary text, wiki, and release notes agree.
