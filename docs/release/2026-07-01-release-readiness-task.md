...
- PR #125, `[codex] Prepare WASP release command center`, branch `codex/release-command-center-20260630`: broad release command-center candidate with tooling, package provenance, AICOM work, and runtime collection gates. GitHub currently reports the branch at `4893faaa5dc7942f04e9993fb93fb44c8425cc98`; the recorded package checkpoint matches that head, marker `4893faaa5d`, `_MISSIONS.7z` SHA256 `22F5AEE4BAF78FCB417A5C7CB7C76B2E1C67B7968541F95EB47527E0AF2A085E`, `1,885` entries, `7,166,685` bytes, handoff status `ready_for_runtime_collection`, and public wiki commit `9d22444`. Exact Chernarus and Takistan runtime RPT proof is still pending, and GitHub reports PR #125 open, draft, clean, and mergeable against `master`.
...
| `rayswaynl/a2waspwarfare.wiki` | Public remote master is at wiki commit `9d22444`, which records the current PR #125 package tuple for `4893faaa5d`, marker-sweep artifact output, PR #126 fallback-template guard, the runtime-evidence manifest generator/checker with role/terrain stamps and optional package artifact hashing, and clarifies that PR #126 HC-audit markers are required only for packages that include that instrumentation. The wiki still treats runtime/deploy evidence as pending. Wiki commit hashes are not release identities; use the package/git/archive tuple and RPT markers for release proof. | Wiki freshness and release-doc synchronization. |
...
9. Existing release PRs already agree on the main gate: source/static/package checks are not enough.
   ...
   - PR #125 now has package/handoff proof for `4893faaa5d` / `_MISSIONS.7z` SHA256 `22F5AEE4BAF78FCB417A5C7CB7C76B2E1C67B7968541F95EB47527E0AF2A085E`, but that is still package/tooling proof, not final runtime proof. PR #126 and PR #131 artifacts remain companion/tooling proof unless explicitly promoted into the active package lane.
...
11. Public stats and server-side stats are health context, not release proof.
   ...
   - This is encouraging live health evidence only. It does not bind to PR #125 package marker `4893faaa5d`, archive SHA `22F5AEE4BAF78FCB417A5C7CB7C76B2E1C67B7968541F95EB47527E0AF2A085E`, the ten required role RPTs, or the runtime packet manifest.
...
17. PR #125 source and package proof are refreshed to the same head.
   - The current package checkpoint commit is `4893faaa5dc7942f04e9993fb93fb44c8425cc98`.
   - The PR/wiki/package tuple records `_MISSIONS.7z` built from marker `4893faaa5d`, SHA256 `22F5AEE4BAF78FCB417A5C7CB7C76B2E1C67B7968541F95EB47527E0AF2A085E`, `1,885` entries, `7,166,685` bytes, and handoff status `ready_for_runtime_collection`.
   ...
   - Action: collect runtime evidence only against the `4893faaa5d` / `22F5AEE4...` tuple unless the release owner explicitly promotes a newer package.

18. PR #126 now has a tuple guard for this active package checkpoint.
   - `Tools/Ops/Test-WaspReleaseTupleDocs.ps1` checks the PR #126 release ledger and monitor examples for current PR #125 branch head `4893faaa`, expected package git marker `4893faaa5d`, archive SHA `22F5AEE4BAF78FCB417A5C7CB7C76B2E1C67B7968541F95EB47527E0AF2A085E`, package size `7,166,685`, wiki commit `9d22444`, runtime-pending wording, and absence of stale `190475B4...`, `1C58A4A3...`, `3DB01AC...`, `703F71E6...`, `40883616...`, `50AD...`, `F057...`, `D323...`, `76A5EE56...`, `E887E792...`, `8D06CDA3...`, `35B864...`, `D5CA434E...`, `ECC6F9D5...`, `F4F19086...`, `0AC507E1...`, and `E7B12EDA...` active-surface archive hashes.
...
20. PR #125 branch head and package proof realigned after the SCUD, GUER mortar, player support/UAV, GUER result receiver, repair, and GUER support follow-ups.
   - GitHub now reports PR #125 at `4893faaa5dc7942f04e9993fb93fb44c8425cc98`.
   ...
   - Impact: runtime proof should target the refreshed `4893faaa5d` / `22F5AEE4...` package tuple; older `062ab44ff5`, `78ba49d540`, `cf4e93af1a`, and stale package hashes are now stale unless the release owner explicitly chooses them.
...
- Continue requester-bound authority review for any remaining tactical support cases not already covered by the current `4893faaa5d` ICBM, supply, SCUD, GUER mortar, player support/UAV, supply-truck respawn, camp repair, GUER VBIED, and GUER FOB guard set; keep runtime proof pending for server-owned payment, cooldown, funds, active-state, repair, and support behavior, and keep construction/defense PVFs plus `RequestOnUnitKilled` in the open authority backlog.
