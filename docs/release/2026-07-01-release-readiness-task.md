...
- PR #125, `[codex] Prepare WASP release command center`, branch `codex/release-command-center-20260630`: broad release command-center candidate with tooling, package provenance, AICOM work, and runtime collection gates. GitHub currently reports the branch at `177ef1385f22aefb466368ef9c381d64a57801c0`; the recorded package checkpoint matches that head, marker `177ef1385f`, `_MISSIONS.7z` SHA256 `5910819DF9840B06146A5C237691AD159B507162399AF596050822EB86F2E5F2`, `1,885` entries, `7,167,459` bytes, handoff status `ready_for_runtime_collection`, and public wiki commit `750b847`. Exact Chernarus and Takistan runtime RPT proof is still pending, and GitHub reports PR #125 open, draft, clean, and mergeable against `master`.
...
9. Existing release PRs already agree on the main gate: source/static/package checks are not enough.
   ...
   - PR #125 now has package/handoff proof for `177ef1385f` / `_MISSIONS.7z` SHA256 `5910819DF9840B06146A5C237691AD159B507162399AF596050822EB86F2E5F2`, but that is still package/tooling proof, not final runtime proof. PR #126 and PR #131 artifacts remain companion/tooling proof unless explicitly promoted into the active package lane.
...
11. Public stats and server-side stats are health context, not release proof.
   ...
   - This is encouraging live health evidence only. It does not bind to PR #125 package marker `177ef1385f`, archive SHA `5910819DF9840B06146A5C237691AD159B507162399AF596050822EB86F2E5F2`, the ten required role RPTs, or the runtime packet manifest.
...
17. PR #125 source and package proof are refreshed to the same head.
   ...
   - The PR/wiki/package tuple records `_MISSIONS.7z` built from marker `177ef1385f`, SHA256 `5910819DF9840B06146A5C237691AD159B507162399AF596050822EB86F2E5F2`, `1,885` entries, `7,167,459` bytes, and handoff status `ready_for_runtime_collection`.
   ...
   - Action: collect runtime evidence only against the `177ef1385f` / `5910819D...` tuple unless the release owner explicitly promotes a newer package.

18. PR #126 now has a tuple guard for this active package checkpoint.
   - `Tools/Ops/Test-WaspReleaseTupleDocs.ps1` checks the PR #126 release ledger and monitor examples for current PR #125 branch head `177ef138`, expected package git marker `177ef1385f`, archive SHA `5910819DF9840B06146A5C237691AD159B507162399AF596050822EB86F2E5F2`, package size `7,167,459`, wiki commit `750b847`, runtime-pending wording, and absence of stale `190475B4...`, `1C58A4A3...`, `3DB01AC...`, `703F71E6...`, `40883616...`, `50AD...`, `F057...`, `D323...`, `76A5EE56...`, `E887E792...`, `8D06CDA3...`, `35B864...`, `D5CA434E...`, `ECC6F9D5...`, `F4F19086...`, `0AC507E1...`, `22F5AEE4...`, `E7B12EDA...`, `FB52623D...`, `35280646...`, `3E98F3B6...`, `11AEED5C...`, `F60F3C7D...`, `CD11B860...`, and `F5232AE7...` active-surface archive hashes.
...
20. PR #125 branch head and package proof realigned after the SCUD, GUER mortar, player support/UAV, GUER result receiver, repair, GUER support, commander-support and AI focus follow-ups.
   ...
   - Impact: runtime proof should target the refreshed `177ef1385f` / `5910819D...` package tuple; older `062ab44ff5`, `78ba49d540`, `cf4e93af1a`, `4893faaa5d`, `9e628781a8`, and stale package hashes including `22F5AEE4...`, `FB52623D...`, `35280646...`, `3E98F3B6...`, `11AEED5C...`, `F60F3C7D...`, `CD11B860...`, and `F5232AE7...` are now stale unless the release owner explicitly chooses them.
