...
As of 2026-07-02 after the PR #125 Build83/cmdcon35, AICOM latch-reset, release-doc package-identity refresh, attack-wave authority follow-ups, ICBM RequestSpecial authority hardening, supply mission PV guards, SCUD authority binding, GUER mortar authority guard, `6363f4cb5b` package refresh, and follow-up head check:
...
- PR #125, `[codex] Prepare WASP release command center`, branch `codex/release-command-center-20260630`: broad release command-center candidate with tooling, package provenance, AICOM work, and runtime collection gates. GitHub currently reports the branch at `6363f4cb5b23448abc55ceb7e39cda2448233ac5`; the recorded package checkpoint matches that head, marker `6363f4cb5b`, `_MISSIONS.7z` SHA256 `ECC6F9D51DD9BD459677863E585F313921E55BAE905C83431EB7EB7596E7D416`, `1,885` entries, `7,164,669` bytes, handoff status `ready_for_runtime_collection`, and public wiki commit `4f35132`. Exact Chernarus and Takistan runtime RPT proof is still pending, and GitHub reports PR #125 open, draft, clean, and mergeable against `master`.
...
| `rayswaynl/a2waspwarfare.wiki` | Public remote master is at wiki commit `4f35132`, which records the current PR #125 package tuple for `6363f4cb5b`, marker-sweep artifact output, PR #126 fallback-template guard, the runtime-evidence manifest generator/checker with role/terrain stamps and optional package artifact hashing, and clarifies that PR #126 HC-audit markers are required only for packages that include that instrumentation. The wiki still treats runtime/deploy evidence as pending. Wiki commit hashes are not release identities; use the package/git/archive tuple and RPT markers for release proof. | Wiki freshness and release-doc synchronization. |
...
11. Public stats and server-side stats are health context, not release proof.
   ...
   - This is encouraging live health evidence only. It does not bind to PR #125 package marker `6363f4cb5b`, archive SHA `ECC6F9D51DD9BD459677863E585F313921E55BAE905C83431EB7EB7596E7D416`, the ten required role RPTs, or the runtime packet manifest.
...
17. PR #125 source and package proof are refreshed to the same head.
   - The current package checkpoint commit is `6363f4cb5b23448abc55ceb7e39cda2448233ac5`.
   - The PR/wiki/package tuple records `_MISSIONS.7z` built from marker `6363f4cb5b`, SHA256 `ECC6F9D51DD9BD459677863E585F313921E55BAE905C83431EB7EB7596E7D416`, `1,885` entries, `7,164,669` bytes, and handoff status `ready_for_runtime_collection`.
   - Validation recorded on PR #125 includes LoadoutManager RELEASE rebuild, package gates, release handoff generation, wiki parse/diff checks, static smoke, final-check package-worktree hygiene, Chernarus/Takistan OA lint pass, high-only BugHunt clean, the HC AICOM delegation PVF follow-up in both maintained `Client_HandlePVF.sqf` files, FPS report PV payload guards, marker-feed consumer guards, SCUD authority binding, GUER mortar authority guard, and marker-sweep defaults for `B74.2 REQ-MARK` plus `aiStatus=`.
   - Action: collect runtime evidence only against the `6363f4cb5b` / `ECC6F9D5...` tuple unless the release owner explicitly promotes a newer package.

18. PR #126 now has a tuple guard for this active package checkpoint.
   - `Tools/Ops/Test-WaspReleaseTupleDocs.ps1` checks the PR #126 release ledger and monitor examples for current PR #125 branch head `6363f4cb`, expected package git marker `6363f4cb5b`, archive SHA `ECC6F9D51DD9BD459677863E585F313921E55BAE905C83431EB7EB7596E7D416`, package size `7,164,669`, wiki commit `4f35132`, runtime-pending wording, and absence of stale `190475B4...`, `1C58A4A3...`, `3DB01AC...`, `703F71E6...`, `40883616...`, `50AD...`, `F057...`, `D323...`, and `35B864...` active-surface archive hashes.
...
- Continue requester-bound `RequestSpecial` authority review for any remaining tactical support cases not already covered by the current `6363f4cb5b` ICBM, supply, SCUD and GUER mortar guard set.
