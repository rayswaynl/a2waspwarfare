...
| FPS/tick diagnostics | [diag_fps](https://community.bohemia.net/wiki/diag_fps), [diag_tickTime](https://community.bohemia.net/wiki/diag_tickTime) | `Common/Functions/Common_GetSleepFPS.sqf:5-9`, `Server/GUI/serverFpsGUI.sqf`, `Common/Functions/Common_PerformanceAudit.sqf:84,154` | Performance docs and patches should preserve existing diagnostic vocabulary: FPS, tick time, RPT logs and PerformanceAudit records. |
