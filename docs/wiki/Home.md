...
| Player feature guides | [New player quickstart](New-Player-Quickstart-Guide) -> [Commander's Handbook](Commanders-Handbook) -> [Tactical support menu](Tactical-Support-Menu-Player-Guide) -> [Supply missions](Supply-Mission-Player-Guide) -> [Squad/group join](Player-Squad-Group-Join-Protocol) |
