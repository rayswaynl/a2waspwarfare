...
| Learn from upstream history | [Developer history and upstream lessons](Developer-History-And-Upstream-Lessons) -> [Upstream Miksuu commit intel](Upstream-Miksuu-Commit-Intel) -> [HC upstream history](HC-Upstream-History-And-Lessons) -> [Feature status](Feature-Status-Register) -> [AI Assistant Guide](AI-Assistant-Guide) |
