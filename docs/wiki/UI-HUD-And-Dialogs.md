...
- [Service menu affordability guards](Service-Menu-Affordability-Guards) before touching rearm/refuel/repair/heal spending or action-time checks.
...
Related: [Feature status](Feature-Status-Register) | [Gear/loadout/EASA atlas](Gear-Loadout-And-EASA-Atlas) | [Service menu affordability guards](Service-Menu-Affordability-Guards) | [Testing workflow](Testing-Debugging-And-Release-Workflow)
