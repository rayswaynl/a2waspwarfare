...
| `origin/release/2026-06-feature-bundle@a96fdda2` | Same Chernarus and Vanilla handler/collector shape. | Release branch still ships the 24-hour supply-truck delay in both maintained roots. |
