...
| Lane | Status | Output |
| --- | --- | --- |
| `visible-parameter-b742-current-head-followup-2026-06-24` | Published / validated | Refreshed visible mission-parameter runtime-consumer rows through [Mission parameters](Mission-Parameters-Localization-And-Generated-Build-Inputs#parameter-cache-flow), [Dead/stale code](Dead-Code-And-Stale-Code-Register), [Feature status](Feature-Status-Register) and [Source Fix queue](Source-Fix-Propagation-Queue). Current B74.2 is `origin/claude/b74.2-aicom@21b62b04`; checked `d472da6a..21b62b04` is empty for checked parameter/cache/cleanup/AI-consumer paths. Docs/source `HEAD@52b7f7443bbc`, Miksuu, perf and historical `a96fdda2` remain old-shape; current stable/B74.1/B74.2/B69/B74 read `WFBE_C_AI_MAX` in `AI_Commander_Produce.sqf:234` and `WFBE_C_UNITS_CLEAN_TIMEOUT` in `Common_TrashObject.sqf:21` in both maintained roots. No gameplay source changed. |
| `auto-wall-b742-current-head-followup-2026-06-24` | Published / validated | Refreshed global auto-wall toggle rows through [Construction/CoIn systems](Construction-And-CoIn-Systems-Atlas#current-branch-scope), [Server composition spawner reference](Server-Composition-Spawner-Function-Reference#wall-templates), [Feature status](Feature-Status-Register) and [Source Fix queue](Source-Fix-Propagation-Queue). Current B74.2 is `origin/claude/b74.2-aicom@21b62b04`; checked `d472da6a..21b62b04` is empty for checked auto-wall paths. Docs/source `HEAD@de471ea5ba96`, current stable/B74.1/B74.2/B69/B74, Miksuu, perf, live `origin/feat/oa-auto-countermeasures@2015a632` and historical `a96fdda2` still keep one global toggle; branch drift is only default/exclusion-list shape, not side/requester scope. No gameplay source changed. |
| `construction-smallsites-b742-current-head-followup-2026-06-24` | Published / validated | Refreshed Construction SmallSite logic-list rows through [Construction logic list cleanup](Construction-Logic-List-Cleanup#current-branch-matrix), [Construction/CoIn systems](Construction-And-CoIn-Systems-Atlas#current-branch-scope), [Feature status](Feature-Status-Register) and [Source Fix queue](Source-Fix-Propagation-Queue). Current B74.2 is `origin/claude/b74.2-aicom@21b62b04`; checked `d472da6a..21b62b04` is empty for the four maintained-root SmallSite/MediumSite files. Docs/source `HEAD@7a7d8c48021f`, current stable/B74.1/B74.2, B69/B74, Miksuu, perf and historical `a96fdda2` still keep SmallSite add/add at `Construction_SmallSite.sqf:70,99` while MediumSite removes at `Construction_MediumSite.sqf:70,114`. No gameplay source changed. |
...
| --- | --- | --- | --- |
| Codex | Ready / documentation-finisher loop | `documentation-finisher-loop` | Visible-parameter B74.2 current-head follow-up is published; pick the next bounded source-backed docs lane from the queue/status pages before editing. |
