...
| --- | --- | --- | --- |
| Codex | Ready / documentation-finisher loop | `documentation-finisher-loop` | Empty supply-truck B74.2 current-head follow-up is published; pick the next bounded source-backed docs lane from the queue/status pages before editing. |
