...
| --- | --- | --- | --- |
| Codex | Ready | `documentation-finisher-loop` | Factory buy/refund current B74.2 Feature Status refresh is published; pick the next bounded source-backed wiki/machine-context lane after reading coordination surfaces. |
