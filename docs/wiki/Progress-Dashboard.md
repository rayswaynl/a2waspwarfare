...
| --- | --- | --- | --- |
| Codex | Ready | None | PR #74 artillery cooldown HUD route is published/validated. Next Codex pass should claim a new bounded source-backed lane after fresh coordination reads. |
