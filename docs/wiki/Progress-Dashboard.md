...
| --- | --- | --- | --- |
| Codex | Ready / docs finisher loop | `documentation-finisher-loop` | LoadoutManager compact context is published and mirrored; continue by choosing the next bounded source-backed wiki/status refresh. |
