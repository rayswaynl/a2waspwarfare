...
| --- | --- | --- | --- |
| Codex | Active | `documentation-finisher-loop` | Depth leftovers mini scout wave is published; continue the docs finisher loop from the next highest-value source-backed lane. |
