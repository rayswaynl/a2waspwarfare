...
| --- | --- | --- | --- |
| Codex | Active | `documentation-finisher-loop` | Refreshed Bottleneck Queue validation/parity wording so it reflects the current docs handoff ritual; continue source-backed wiki pruning/status upkeep. |
