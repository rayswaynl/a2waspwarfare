...
| `wasp-marker-wait-current-b741-b742-refresh-2026-06-23` | Published / validated | Refreshed WASP marker display-54 wait evidence through [WASP marker wait cleanup](WASP-Marker-Wait-Cleanup#status), [Performance sweep](Performance-Opportunity-Sweep#wasp-marker-dialog), [WASP overlay](WASP-Overlay), [Current source snapshot](Current-Source-Status-Snapshot) and [Source Fix queue](Source-Fix-Propagation-Queue). Docs/source `HEAD@c9df2a8b7264` is unchanged from `46840f048bd4` for checked WASP paths and still has the unslept display-54 loop in both maintained roots. Current stable/B74.1 `origin/master@f8a76de34`, B74.2 `origin/claude/b74.2-aicom@21b62b04`, B69, B74 and `origin/feat/client-fps@709258e7` keep `sleep 0.1` at `global_marking_monitor.sqf:64`; B74.2 only line-drifts source Chernarus launch to `Init_Client.sqf:403` through unrelated client-init work. Current Miksuu, perf and historical `a96fdda2` remain old-shape. No gameplay source changed. |
