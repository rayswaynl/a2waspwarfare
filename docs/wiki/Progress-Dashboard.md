...
| Lane | Status | Output |
| --- | --- | --- |
| `architecture-overview-source-scope-route` | Published / validated | Refreshed [Architecture overview](Architecture-Overview) source-scope wording for current docs checkout `1bef8801`: rechecked runtime/tooling anchors as unchanged from earlier `1aa178f8`, added a compact branch-scope table, and split LoadoutManager root discovery between docs checkout, stable/release and Miksuu/perf without changing gameplay/source. |
