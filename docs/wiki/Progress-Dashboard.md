...
| --- | --- | --- | --- |
| Codex | Ready / documentation-finisher loop | `documentation-finisher-loop` | Construction SmallSite B74.2 current-head follow-up is published; pick the next bounded source-backed docs lane from the queue/status pages before editing. |
