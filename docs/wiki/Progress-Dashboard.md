...
| --- | --- | --- | --- |
| Codex | Active | `documentation-finisher-loop` | Buy-unit price-display correction is published; next best docs lane is broader `_Sidebar.md` / `mkdocs.yml` navigation parity and hub route blocks. |
...
| Sub-agents | Returned / closed | `mini-scout-wave-depth-leftovers-2026-06-04` | Six `gpt-5.4-mini` scouts returned. Useful findings are source-checked into owner pages; duplicate and false leads remain non-canonical. |
