...
| --- | --- | --- | --- |
| Codex | Active | `documentation-finisher-loop` | Navigation parity batch is published; no active scout output remains. Next best docs lane is source-checking any newly returned focused engineering threads for docs/Feature Status deltas, then continuing P0/P1 owner-page cleanup. |
