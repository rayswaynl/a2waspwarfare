...
| --- | --- | --- | --- |
| Codex | Ready / documentation finisher loop | `documentation-finisher-loop` | AI runtime Town AI B74.2 route refresh is published; pick the next bounded source-backed lane after reading the coordination surfaces and avoiding active owners. |
