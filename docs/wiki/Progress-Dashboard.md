...
| --- | --- | --- | --- |
| Codex | Active | `documentation-finisher-loop` | Folding the new Miksuu town-capture active-state fix into canonical upstream/town/status pages without changing gameplay source. |
