...
| `ui-resource-wf-icon-missing-block` | Published / validated | Verified the stale upgrade icon block from the resource scout. Current Chernarus and maintained Vanilla both reference missing `Client\Images\wf_b.paa`, `wf_lvf.paa`, `wf_hvf.paa`, `wf_air.paa`, `wf_par.paa`, `wf_uav.paa`, `wf_sup.paa`, `wf_fia.paa`, `wf_lif.paa`, `wf_fla.paa`, `wf_art.paa`, `wf_mib.paa`, `wf_fas.paa`, `wf_gea.paa`, `wf_amm.paa`, `wf_eas.paa`, `wf_pas.paa` and `wf_shl.paa` from `Rsc/Dialogs.hpp:2644-2831`; `rg --files` found none repo-wide. `Rsc/Ressources.hpp:300,302,304` button skins resolve. [UI resource parity cleanup](UI-Resource-Parity-Cleanup) owns the stale block; [Client UI systems](Client-UI-Systems-Atlas#indicator-exploration-backlog) now routes image/resource cleanup there. No gameplay source changed. |
