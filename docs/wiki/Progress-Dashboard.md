...
| Lane | Status | Output |
| --- | --- | --- |
| `ai-supply-truck-b742-current-head-followup-2026-06-24` | Published / validated | Refreshed autonomous AI supply-truck safe-disable rows through [AI commander autonomy](AI-Commander-Autonomy-Audit#ai-supply-truck-branch-matrix), [Abandoned feature revival](Abandoned-Feature-Revival-Review#ai-commander-supply-trucks), [Feature status](Feature-Status-Register), [Source Fix queue](Source-Fix-Propagation-Queue) and [Dead/stale code](Dead-Code-And-Stale-Code-Register). Current B74.2 is `origin/claude/b74.2-aicom@21b62b04`; checked `d472da6a..21b62b04` line-drifts source-Chernarus `Init_Server.sqf` for GUER stipend startup only among checked supply-truck files and does not restore the worker or `Server/FSM/supplytruck.fsm`. Current stable/B74.1/B74.2/B69/B74 keep safe-disable behavior; docs/source, Miksuu and perf still raw-spawn the commented worker. No gameplay source changed. |
| `resource-income-b742-current-head-followup-2026-06-24` | Published / validated | Refreshed resource-income cap/payout/display rows through [Economy/Towns/Supply](Economy-Towns-And-Supply#resource-income-branch-matrix), [Resource income tick distribution](Resource-Income-Tick-Distribution-Engine), [Feature status](Feature-Status-Register) and [Source Fix queue](Source-Fix-Propagation-Queue). Current B74.2 is `origin/claude/b74.2-aicom@21b62b04`; checked `d472da6a..21b62b04` is empty for income paths and constants. Current stable/B74.1/B74.2 still share the income tick/display shape: Chernarus keeps hybrid-refill, supply multiplier, over-cap AI commander fallback and B74.1 taper, maintained Vanilla keeps non-hybrid/raw-supply/no-taper behavior, and `Client_GetIncome.sqf:24-28` still omits the system-4 server `1.5` display multiplier. No gameplay source changed. |
| `side-supply-b742-current-head-followup-2026-06-24` | Published / validated | Refreshed side-supply clamp, resistance temp-channel and reason-string rows through [Economy authority first cut](Economy-Authority-First-Cut#side-supply-branch-matrix), [Resistance supply scaffold](Resistance-Supply-Scaffold#current-branch-matrix), [Economy/Towns/Supply](Economy-Towns-And-Supply), [Feature status](Feature-Status-Register) and [Source Fix queue](Source-Fix-Propagation-Queue). Current B74.2 is `origin/claude/b74.2-aicom@21b62b04`; checked `d472da6a..21b62b04` is empty for side-supply/resistance/reason paths. Current stable/B74.1/B74.2 Chernarus remains a partial rescue, maintained Vanilla remains old-shape, and DR-44 validation plus reason parsing remain open. Live `origin/claude/faction-tint-sidefix@32acd272f92e` removes the Chernarus resistance handler if revived without rebase. No gameplay source changed. |
...
| --- | --- | --- | --- |
| Codex | Ready / documentation-finisher loop | `documentation-finisher-loop` | AI supply-truck B74.2 current-head follow-up is published; pick the next bounded source-backed docs lane from the queue/status pages before editing. |
