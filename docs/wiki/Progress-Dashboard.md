...
| --- | --- | --- | --- |
| Codex | Active | `documentation-finisher-loop` | Keep closing stale docs/machine-status gaps; current best next candidates are feature-status reconciliation, owner-decision consolidation or release/readiness smoke planning with branch evidence. |
