...
| `supply-mission-economy-pr-current-stable-followup-2026-06-22` | Published / validated | Refreshed [Current PR #1 supply helicopters](Current-Work-Supply-Helicopters-PR1) and [Economy, towns and supply](Economy-Towns-And-Supply) after the supply-scan lane updated the canonical matrix but these pages still carried older stable/release wording. PR #1 is closed/unmerged with no live origin supply/heli feature head, current stable `origin/master@0139a346` is the live supply-heli/cash-run baseline, and docs/source `15563691`, current Miksuu `b8389e748243` and perf `0076040f` remain truck-only. No gameplay source changed. |
