...
| --- | --- | --- | --- |
| Codex | Ready | `documentation-finisher-loop` | Pick the next bounded source-backed documentation lane from Feature Status, Source Fix queue, pruning ledger or hardening backlog; claim before editing. |
