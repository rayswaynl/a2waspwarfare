...
| `commander-reassignment-current-b741-refresh-2026-06-23` | Published / validated | Refreshed [Commander reassignment call shape](Commander-Reassignment-Call-Shape), [Commander vote/reassignment](Commander-Vote-And-Reassignment-Playbook), [Feature status](Feature-Status-Register) and [Server authority migration](Server-Authority-Migration-Map) from stale current-stable `origin/master@0139a346` wording to current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`. Scoped diff `0139a3468609..f8a76de34` touches no maintained-root `Server_VoteForCommander.sqf`, `GUI_VoteMenu.sqf`, `RequestNewCommander.sqf`, `Server_AssignNewCommander.sqf` or `GUI_Commander_VoteMenu.sqf` files, so DR-47 vote comparison and DR-15 helper unpacking remain source-present on current stable/B74.1/B69/B74 maintained roots. Remaining work is still one reassignment notification owner, row-value/team identity, requester authority and old-shape docs/source/modded helper cleanup. No gameplay source changed. |
