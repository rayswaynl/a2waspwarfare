...
| `old-be-wasp-fps-archaeology` | Codex delegated window | Ready-for-review / harvested | Report draft is in the projectless outputs folder; compact source-backed deltas are harvested into old-BE, player-cap, performance and testing pages. |
