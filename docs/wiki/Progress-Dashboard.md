...
| --- | --- | --- | --- |
| Codex | Ready / documentation finisher loop | `documentation-finisher-loop` | Paratrooper marker current stable/B74.2 register/context refresh is published; pick the next bounded source-backed lane after reading the coordination surfaces and avoiding active owners. |
