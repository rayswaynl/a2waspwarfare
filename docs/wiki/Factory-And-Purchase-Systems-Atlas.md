...
| Current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`, current B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f` and B74.2 `origin/claude/b74.2-aicom@d472da6a` | Both maintained roots pass `_currentCost` into `BuildUnit`, refund the real dead/null factory abort, fix selected-detail price display, mirror driver-default profile keys and still leave the level-0 `UNIT_COST_MODIFIER` reset open. Current stable/B74.1/B69/B74 use selected detail `GUI_Menu_BuyUnits.sqf:416`; B74.2 keeps maintained Vanilla at `:416` and shifts source Chernarus to `:422` after pop-tier AI-cap setup. The `0139a3468609..f8a76de34` checked price/key delta touches constants only, while B74.2 changes only source Chernarus GUI AI-cap setup and constants among checked price/key paths. |
