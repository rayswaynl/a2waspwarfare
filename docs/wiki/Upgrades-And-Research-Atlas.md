...
The branch-only Barracks and Trello upgrade/HQ cost rows below were checked later on 2026-06-23 against current stable `origin/master@f8a76de34`; they are separate from the older upgrade-sync branch-scope matrix in this section.
