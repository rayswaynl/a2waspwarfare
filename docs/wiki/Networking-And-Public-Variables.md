...
2026-06-23 `SEND_MESSAGE` addendum: docs/source `HEAD@cd9ba541d583` is unchanged from `3a32be92` / `40c477be` / `16247fc8f` for checked `SEND_MESSAGE` paths. Current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`, B74.2 `origin/claude/b74.2-aicom@d472da6a`, current B69 `origin/claude/b69@8d465fce` and adjacent B74 `origin/claude/b74-aicom-spend@b23f557f` all keep this direct channel unchanged in both maintained roots. Both roots still register `SEND_MESSAGE` at `Client/FSM/updateclient.sqf:12`, compile receiver text at `Client_onEventHandler_SEND_MESSAGE.sqf:27`, and compile/broadcast helper text at `Common_SendMessage.sqf:26,37-38`; checked diffs `3a32be92..HEAD`, `0139a3468609..origin/master`, `origin/master..origin/claude/b74.2-aicom`, B69..B74 and older B69 provenance diffs are empty for those paths.
