...
| Tooling / LoadoutManager | ✅ | n/a | n/a | n/a | n/a | ✅ | [Tools](Tools-And-Build-Workflow), DR-4, **DR-43a corrected 2026-06-04: local ignored/generated Chernarus and Vanilla `version.sqf` files exist but are not tracked by Git, so clean checkouts and generated/terrain target roots still need version-file verification before pack/test claims** |
