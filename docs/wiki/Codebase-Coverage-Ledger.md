...
| Integrations (Extension / Discord / **AntiStack DB** / BattlEye) | 🟡 | 🟡 | 🟡 | 🟡 | 🟡 | n/a | [External integrations](External-Integrations); AntiStack DB done (DR-7..DR-10); **in-repo GLOBALGAMESTATS extension done (DR-29 — output-discarded one-way exporter; dormant deser-RCE landmine + async-void write race + write-only stub)**; Discord/BattlEye ⬜ |
