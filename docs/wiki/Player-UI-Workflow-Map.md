...
| Service/EASA | Rearm, repair, refuel, heal and aircraft loadout dialog. | `Rsc/Dialogs.hpp:2870-2873`, `:3209-3212`; `GUI_Menu_Service.sqf:128-244`; `GUI_Menu_EASA.sqf:47-50`; `EASA_Equip.sqf:8-38` | Live; affordability/authority debt, stale EASA context risk and exact-funds rejection. |
