...
| `Client/Init/Init_Client.sqf:267` on docs/source; `:397` on current stable/B74.1/B69/B74/live-map branches; B74.2 source Chernarus `:403` and maintained Vanilla `:397` | `WASP/global_marking_monitor.sqf` |
