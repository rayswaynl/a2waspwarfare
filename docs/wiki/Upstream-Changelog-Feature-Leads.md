...
| Climbing gear for MHQ / Light Factory vehicles | `v16072024`: climbing gear added to MHQ/LF vehicles. | [Modules atlas](Modules-Atlas), [Client UI systems atlas](Client-UI-Systems-Atlas), [Testing workflow](Testing-Debugging-And-Release-Workflow) | Promoted above as Valhalla low gear / high-climb assist; avoid routing it to buy-gear/EASA unless a separate inventory item is found. |
| Anti-air radar upgrade ladder | `v20072023`: three upgrade levels, speed refresh and type reveal. | [Upgrades and research atlas](Upgrades-And-Research-Atlas), [Support/specials/tactical modules atlas](Support-Specials-And-Tactical-Modules-Atlas), [Performance opportunity sweep](Performance-Opportunity-Sweep) | Promoted above: live marker ladder is source-checked; remaining work is runtime/performance smoke, not archive discovery. |
