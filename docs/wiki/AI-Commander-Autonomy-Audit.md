...
### B74.5 / B74.4 AICOM Follow-Up

2026-06-24 B74.5/B74.6 intake: current `origin/claude/b745@712a7a668` contains `origin/claude/b74.2-aicom@21b62b04` as an ancestor but is a broader branch-only bundle, not a B74.2 replacement or stable release claim. Its included B74.4 AICOM/JIP batch (`4d16fad70`) should be split by owner: primitive roster/vote/JIP now routes through [Client UI systems](Client-UI-Systems-Atlas#current-branch-scope), [Player join/disconnect](Player-Join-Disconnect-And-AntiStack-Lifecycle#branch-intel---b745-primitive-roster-jip) and [Commander vote/reassignment](Commander-Vote-And-Reassignment-Playbook#current-branch-scope). The later B74.6 delta `b996bcb3..712a7a668` is empty for the checked AICOM attack-heli, base-sell and MHQ relocation paths; the remaining AICOM helper evidence is below.

| B74.5 / B74.4 helper | Source evidence included in current `origin/claude/b745@712a7a668` | Scope and smoke before promotion |
| --- | --- | --- |
...
Treat the B74.5 helper matrix as branch-intake routing only. Before merging or publishing as behavior, smoke late join/reconnect, primitive vote-menu rows, AI commander attack-heli caps, AH1Z class availability, redundant-base sale, MHQ relocation and maintained Vanilla/Takistan scope. Keep earlier B74.2 pop-tier/camp/naval/stats evidence routed through the B74.2 row below.
