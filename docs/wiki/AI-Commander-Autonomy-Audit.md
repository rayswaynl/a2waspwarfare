...
2026-06-24 B74.5 intake: `origin/claude/b745@b996bcb3ee9b` contains `origin/claude/b74.2-aicom@21b62b04` as an ancestor but is a broader branch-only bundle, not a B74.2 replacement or stable release claim. Its included B74.4 AICOM/JIP batch (`4d16fad70`) changes checked AICOM/JIP paths in source Chernarus only. New primitive-roster fallback evidence is at `Client/Init/Init_Client.sqf:284,600`, `Server/Functions/Server_OnPlayerConnected.sqf:70-92`, `initJIPCompatible.sqf:227`, `Client/GUI/GUI_VoteMenu.sqf:11-13,75-76,119-123` and `Client/GUI/GUI_Commander_VoteMenu.sqf:11,69`; AICOM AH1Z/attack-heli/base-reaper evidence is at `Common/Init/Init_CommonConstants.sqf:180-190`, `Common/Functions/Common_RunCommanderTeam.sqf:174-178`, `Server/AI/Commander/AI_Commander_Teams.sqf:308-317,335`, `Common/Config/Core/Core_USMC.sqf:154`, `Common/Config/Core_Units/Units_CO_US.sqf:283` and `Units_USMC.sqf:81`; base-sell/MHQ relocation wiring is at `Server/Init/Init_Server.sqf:37,73` and `Server/AI/Commander/AI_Commander.sqf:282-283`.

Treat this as branch-intake routing only. Before merging or publishing as behavior, smoke late join/reconnect, primitive vote-menu rows, AI commander attack-heli caps, AH1Z class availability, redundant-base sale, MHQ relocation and maintained Vanilla/Takistan scope. Keep earlier B74.2 pop-tier/camp/naval/stats evidence routed through the B74.2 row below.
