...
6. Treat PR #74 as an open draft artillery cooldown HUD candidate already routed through the support/tactical, Client UI and Testing pages, and PR #72 as an open draft anti-base-trap static-defense candidate routed through Construction/CoIn, Feature Status and Testing; both are still clean-but-stale-base after B751b. PR #66/#63/#59/#54 and PR #53 remain open Trello/upstream/OA candidates that need their own owner route if not already documented.
