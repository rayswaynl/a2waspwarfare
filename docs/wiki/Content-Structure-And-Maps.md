...
`version.sqf` is required terrain metadata and is generated by LoadoutManager for terrain outputs. The current workspace has ignored generated Chernarus and Vanilla Takistan copies, but Git does not track them; generated Vanilla/modded/stub roots still need explicit verification before direct pack/test work; see [Tools and build workflow](Tools-And-Build-Workflow) and DR-43a.
