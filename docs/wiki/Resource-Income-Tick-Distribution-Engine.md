...
> Source-verified 2026-06-24 against current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` and current B74.2 `origin/claude/b74.2-aicom@21b62b04`. The checked `d472da6a..21b62b04` diff is empty for `updateresources.sqf`, `Client_GetIncome.sqf` and income constants; `origin/master..origin/claude/b74.2-aicom` changes source-Chernarus AICOM/pop-tier constants, not the income tick or display paths. Paths are current source Chernarus unless noted. Arma 2 OA 1.64. Maintained Vanilla and B69/B74 branch differences are routed through [Economy, Towns And Supply](Economy-Towns-And-Supply#resource-income-branch-matrix).
