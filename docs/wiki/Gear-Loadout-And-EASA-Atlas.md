...
[
  ...
  {"fact":"gear_easa_branch_scope_2026_06_22","source":"docs branch b2544207 cargo paths and HEAD@8906ee89 service/EASA paths; origin/master@0139a346; origin/claude/b69@8d465fce; current Miksuu master@b8389e748243; perf/quick-wins@0076040f; historical release a96fdda2; historical EASA QoL a66d4691; B69 finalpieces 80d3267c as provenance; local d9506078 belongs to origin/claude/* branch evidence, not current Miksuu upstream","summary":"Gear profile/template save filtering is branch-split: docs/source and old refs keep undefined _u_upgrade, while current stable fixes it in both maintained roots. The six-field profile import guard and template creation/display policy remain open across checked refs; cargo loops are fixed on current stable and historical release, but current Miksuu, perf Vanilla and docs/EASA old-shape targets still need the loop-bound port. Service/EASA remains partial: current stable and current B69 guard service rearm/refuel only, and EASA exact-funds/client debit remains open everywhere checked except current B69 Chernarus-only exact-funds UI evidence."},
