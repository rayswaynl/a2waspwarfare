...
| EASA/Economy duplicate dialog IDD. | `Rsc/Dialogs.hpp:3209-3212`, `:3287-3290`; Claude DR-17. | Give one dialog a distinct IDD before adding scripts that use `findDisplay 23000`; use [UI IDD collision repair](UI-IDD-Collision-Repair) for the patch shape and smoke checklist. |
