...
| EASA/Economy duplicate dialog IDD. | `Rsc/Dialogs.hpp:3209-3212`, `:3287-3290`; Claude DR-17. Branch check 2026-06-05: release Chernarus moves EASA to `24000`, but current source/stable/upstream and release Vanilla still duplicate `23000`; no current mission source `findDisplay 23000` caller was found. | Give one dialog a distinct IDD before adding scripts that use display-ID lookup; use [UI IDD collision repair](UI-IDD-Collision-Repair) for the patch shape and smoke checklist. |
