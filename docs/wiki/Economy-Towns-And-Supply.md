...
Resource-income evidence was refreshed again on 2026-06-24 in [the branch matrix below](#resource-income-branch-matrix) against docs/source `HEAD@f29b4a9b7900` (source-unchanged from `c8ec223a` / `3a32be92` / `cd9ba541` for checked `updateresources.sqf` and `Client_GetIncome.sqf` paths), current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`, current B74.2 `origin/claude/b74.2-aicom@21b62b04`, previous B74.2 `d472da6a`, current B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f` and historical release commit `a96fdda2`. Checked `d472da6a..21b62b04` is empty for income paths and constants; `origin/master..origin/claude/b74.2-aicom` changes source-Chernarus AICOM/pop-tier constants only among checked income-adjacent files. Supply-mission branch scope is still routed through [Supply mission architecture](Supply-Mission-Architecture#current-branch-matrix); no supply-mission claim is updated by this resource-income refresh.
