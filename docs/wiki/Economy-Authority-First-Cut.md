...
| B74.2 `origin/claude/b74.2-aicom@d472da6a` plus current B69 `origin/claude/b69@8d465fce` and adjacent B74 `origin/claude/b74-aicom-spend@b23f557f` | B74.2 has no checked helper delta over current stable. B69..B74 has no checked side-supply helper delta. Chernarus and maintained Vanilla still keep the `count _this > 3` reason guard (`Common_ChangeSideSupply.sqf:8-14`). | Same AttackWave/supply-completion contrast. B74.2 Chernarus line-drifts the four-argument supply-completion calls to `supplyMissionCompleted.sqf:43,46`, while Vanilla remains `:40`; Chernarus publishes through `Common_ChangeSideSupply.sqf:24-26`, while Vanilla keeps `:28-30`. | Do not treat B74.2, B69 or B74 as a reason-string fix. If porting the side-supply arithmetic, still patch reason parsing in both maintained roots. |
