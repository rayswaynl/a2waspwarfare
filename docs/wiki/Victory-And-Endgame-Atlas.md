...
Source anchors below are relative to `Missions/[55-2hc]warfarev2_073v48co.chernarus/` in the docs checkout unless a section names another ref. Current source-continuity checkpoint: docs/source `HEAD@4c87efd2`; targeted diffs from `d30d23466`, `a0a86da2` and the earlier victory checkpoint `2f2132f8` to `HEAD` over the checked Chernarus and maintained Vanilla endgame/init/logger paths returned no source changes.
