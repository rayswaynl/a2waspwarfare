...
> Source-verified 2026-06-23 against current stable/B74.1 `origin/master@f8a76de34` and B74.2 `origin/claude/b74.2-aicom@21b62b04`; B74.2 keeps the same supply start/scan anchors and only line-drifts source Chernarus completion handling. Paths relative to `Missions/[55-2hc]warfarev2_073v48co.chernarus/` unless noted. Arma 2 OA 1.64.
