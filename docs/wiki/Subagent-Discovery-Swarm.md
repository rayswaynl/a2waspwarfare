...
Harvest rule: Wave Q reports are leads until Codex source-checks and promotes them into owner pages. Curie's RHUD/endgame display-var collision, Linnaeus's side-supply negative-delta/direct-PV helper lesson and Banach's town/camp/supply routing check are now promoted; the next owner-page harvest candidate is Hubble's player-buy path correction.
