...
Harvest rule: Wave Q reports are leads until Codex source-checks and promotes them into owner pages. Curie's RHUD/endgame display-var collision, Linnaeus's side-supply negative-delta/direct-PV helper lesson, Banach's town/camp/supply routing check and Hubble's player-buy path correction are now promoted; no Wave Q lead should be treated as pending without a fresh source contradiction.
