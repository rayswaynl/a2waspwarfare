...
| `discord-extension-antistack-integration-discovery` | Faraday | Report received | [External integrations](External-Integrations), [Networking/PV](Networking-And-Public-Variables), [Feature status](Feature-Status-Register), [`agent-context.json`](agent-context.json). |
...
| `common-pv-network-authority-v2` | Galileo | Report received | [Networking/PV](Networking-And-Public-Variables), [Deep-review findings](Deep-Review-Findings), [Function/module index](Function-And-Module-Index), [`agent-context.json`](agent-context.json). |
...
| `pv-matrix-second-pass-v2` | Archimedes/James | Report received | [Networking/PV](Networking-And-Public-Variables), [Function/module index](Function-And-Module-Index), [`agent-context.json`](agent-context.json). |
