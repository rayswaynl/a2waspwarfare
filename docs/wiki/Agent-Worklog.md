...
- Source scope: docs branch `docs/developer-wiki-index@b2544207`, current stable `origin/master@0139a346`, current Miksuu `master@d9506078` fetched on 2026-06-22, older Miksuu checkpoint `b8389e74`, `origin/perf/quick-wins@0076040f`, historical release commit `a96fdda2`, historical EASA QoL commit `a66d4691`, and current origin head inventory showing no live `release/*` or `feat/buymenu-easa-qol` heads.
