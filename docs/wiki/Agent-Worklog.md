...
## 2026-06-23T00:14:14+02:00 - Codex - Side-supply current B74 refresh

- Claimed `side-supply-current-b74-refresh-2026-06-23` after side-supply clamp/reason/resistance rows named current B69 but did not include adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`.
- Source scope: docs/source `HEAD@a908284c5ec7` is source-unchanged from `4db90f1c`, `7047da5d9` and `f52ccee8` for checked side-supply files. Current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu is `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`.
- Findings: docs/source, current stable, current Miksuu and historical `a96fdda2` keep the old `_currentSupply - _amount` negative floor at `Common_ChangeSideSupply.sqf:25` and `Server_ChangeSideSupply.sqf:12,36` in both maintained roots, plus the `count _this > 3` reason guard at `Common_ChangeSideSupply.sqf:8-14`. Perf fixes only Chernarus arithmetic. B69 and B74 have no checked side-supply path delta; both fix only Chernarus server arithmetic at `Server_ChangeSideSupply.sqf:12,36,60` and add Chernarus `wfbe_supply_temp_resistance` at `:25-45`, while maintained Vanilla remains old-shape.
- Branch note: `git diff --name-status origin/claude/b69..origin/claude/b74-aicom-spend` is empty for checked side-supply paths. `origin/master..origin/claude/b74-aicom-spend` changes only the Chernarus `Common_ChangeSideSupply.sqf` and `Server_ChangeSideSupply.sqf` among checked side-supply files. Current origin exposes no live `release/*`, supply or economy rescue head.
- Result: refreshed [Economy authority first cut](Economy-Authority-First-Cut), [Resistance supply scaffold](Resistance-Supply-Scaffold), Feature Status, Source Fix queue, dashboard, pruning ledger and side-supply machine rows. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T00:32:42+02:00 - Codex - HQ score current B74 refresh

- Claimed `hq-score-current-b74-refresh-2026-06-23` after HQ-kill score rows named current B69 but did not include adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`.
- Source scope: docs/source `HEAD@9b7eb4bcde02` is source-unchanged from `97e4cdd0` and `4d4610f1` for checked HQ-score files. Current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu is `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`.
- Findings: docs/source, current stable, current Miksuu, perf and historical `a96fdda2` all keep generic HQ building score plus a second HQ bounty score in both maintained roots. Current stable uses `Server_OnHQKilled.sqf:23,52,54,80,83,86`. B69 and B74 have no `Server_OnHQKilled.sqf` delta; both use `:23,64,66,106,109,112` and retain base-fall smoke/sting code at `:57/:103`, which is spectacle code rather than DR-50 closure. `WFBE_C_BUILDINGS_SCORE_COEF` stays `3` everywhere checked; B74 only drifts the Chernarus coefficient line to `Init_CommonConstants.sqf:734`.
- Branch note: `git diff --name-status origin/claude/b69..origin/claude/b74-aicom-spend` is empty for checked `Server_OnHQKilled.sqf` paths and changes only Chernarus `Init_CommonConstants.sqf` among checked HQ score files. Current origin exposes no live `release/*`, HQ, score, bounty or base rescue head; broad `commander` matches are Codex AI-commander context/log branches.
- Result: refreshed [Commander/HQ lifecycle](Commander-HQ-Lifecycle-Atlas#hq-kill-score-and-bounty-branch-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and HQ-score machine rows. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T00:46:04+02:00 - Codex - MASH marker current B74 refresh

- Claimed `mash-marker-current-b74-refresh-2026-06-23` after the MASH marker/deploy rows still named current B69 but did not include adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`.
- Source scope: docs/source `HEAD@443055cf` is unchanged from `2b5139219faa` and `db3015f18ea3` for checked Chernarus/Vanilla MASH deploy, marker relay, init and respawn-availability paths. Current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu is `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`.
- Findings: docs/source, Miksuu and perf keep local MASH deploy plus orphaned marker relay in both maintained roots: `Client_GetRespawnAvailable.sqf:49`, `Skill_Apply.sqf:47`, `Skill_Officer.sqf:8,26,29`, `MASHMarker.sqf:1,9,11`, `receiverMASHmarker.sqf:1` and commented receiver compile `Init_Client.sqf:132` (`:134` on Miksuu). Current stable/B69/B74/historical release remove the maintained-root deploy/module path, expose only `Skill_Apply.sqf:43` MASH-deploy-removed wording plus residues, and have no maintained-root `Client/Module/MASH`, `Server/Module/MASH` or `Skill_Officer.sqf` entries. The checked B69..B74 MASH delta is empty; no live `release/*`, MASH, respawn or marker head was exposed.
- Result: refreshed [Respawn and death lifecycle](Respawn-And-Death-Lifecycle-Atlas#mash-split-live-respawn-dead-marker-relay), Feature Status, Abandoned feature revival, Public Variable Channel Index, Dead/stale code register, dashboard/pruning ledger and machine rows so current stable/B69/B74 removal-shaped targets are separated from docs/Miksuu/perf old-shape local MASH. No gameplay source changed.

## 2026-06-23T01:03:04+02:00 - Codex - Empty supply-truck current B74 refresh

- Claimed `empty-supply-truck-current-b74-refresh-2026-06-23` after the empty supply-truck cleanup rows named current B69 but did not include adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`.
- Source scope: docs/source `HEAD@7e7aebec203a` is unchanged from `b4e10b5f` for checked Chernarus/Vanilla empty-vehicle collector and handler paths. Current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu is `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`.
- Findings: docs/source, current stable, B69, B74, Miksuu, perf and historical `a96fdda2` all drain `WF_Logic` `emptyVehicles` through `emptyvehiclescollector.sqf:9,12,15-17,19` and set supply-truck `_delay = 86400` in both maintained roots. Docs/Miksuu/perf/historical handler shape is `Server_HandleEmptyVehicle.sqf:21-23,29-30,33`; current stable/B69/B74 line drift is `:29-31,37-38,41`.
- Branch note: `git diff --name-status origin/claude/b69..origin/claude/b74-aicom-spend`, `0094647d..origin/claude/b74-aicom-spend` and `80d3267c..origin/claude/b74-aicom-spend` are empty for checked maintained collector/handler paths. Current origin exposes no live `release/*`, cleanup or supply rescue head, so `a96fdda2` remains historical source evidence rather than current release proof.
- Result: refreshed [Marker cleanup/restoration](Marker-Cleanup-Restoration-Systems-Atlas#empty-supply-truck-branch-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and empty supply-truck machine rows with adjacent B74 evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T01:17:42+02:00 - Codex - Commander reassignment current B74 refresh

- Claimed `commander-reassignment-current-b74-refresh-2026-06-23` after commander reassignment rows named current stable/current B69 helper-unpacking proof but did not include adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`.
- Source scope: docs/source `HEAD@60c35c0503de` is unchanged from `337ed16633e7` and `b44aaaf8` for checked Chernarus/Vanilla `GUI_Commander_VoteMenu.sqf`, `RequestNewCommander.sqf`, `Server_AssignNewCommander.sqf`, `Common_GetSideLogic.sqf` and `Init_PublicVariables.sqf` paths. Current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu is `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`; historical AI-commander evidence is `c20ce153`.
- Findings: docs/source still uses `_side = _this` at `Server_AssignNewCommander.sqf:3` in both maintained roots. Current stable, B69, B74, Miksuu, perf, historical `a96fdda2` and historical `c20ce153` all unpack `_side = _this select 0` / `_commander = _this select 1` at `Server_AssignNewCommander.sqf:4-5` in both maintained roots. All checked maintained roots still keep duplicate `new-commander-assigned` senders at `RequestNewCommander.sqf:14` and helper `:9/:10`, and B74 still resolves reassignment UI by visible `lnbText` at `GUI_Commander_VoteMenu.sqf:33` despite row values at `:63`.
- Branch note: `git diff --name-status origin/claude/b69..origin/claude/b74-aicom-spend`, `0a1ccb4d..origin/claude/b74-aicom-spend` and `b8530477..origin/claude/b74-aicom-spend` are empty for checked maintained reassignment paths. B74 full modded Napf/Eden/Lingor forks still use `_side = _this` at `Modded_Missions/*/Server/Functions/Server_AssignNewCommander.sqf:3`. Current origin exposes no live `release/*`, `feat/*commander*`, `feat/*vote*`, `feat/*reassign*`, `feature/*commander*`, `feature/*vote*` or `feature/*reassign*` heads.
- Result: refreshed [Commander reassignment call shape](Commander-Reassignment-Call-Shape#current-branch-matrix), [Commander vote/reassignment](Commander-Vote-And-Reassignment-Playbook), Feature Status, Source Fix queue, dashboard, pruning ledger and commander machine rows with adjacent B74 evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T01:33:50+02:00 - Codex - Commander reassignment row-value line correction

- Claimed `commander-reassignment-row-value-line-correction-2026-06-23` after the latest commander reassignment worklog and feature-status JSONL row still carried an obsolete `:53` anchor for B74 `GUI_Commander_VoteMenu.sqf` row values.
...
## 2026-06-23T02:00:06+02:00 - Codex - Construction SmallSite current B74 refresh

- Claimed `construction-smallsite-current-b74-refresh-2026-06-23` after the SmallSite logic-list owner/status/queue rows named current B69 evidence but did not include adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`.
- Source scope: docs/source `HEAD@7562c803af80` source-unchanged from `6b8eba5e1a8f` and `3406ffa0` for checked construction paths; current stable `origin/master@0139a3468609`; current B69 `origin/claude/b69@8d465fcede7f`; adjacent B74 `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu `b8389e748243`; perf `origin/perf/quick-wins@0076040f8a5e`; historical release `a96fdda28087`.
- Findings: every checked maintained root keeps SmallSite add/add at `Construction_SmallSite.sqf:70,99` and MediumSite add/remove at `Construction_MediumSite.sqf:70,114` in both source Chernarus and maintained Vanilla.
- Branch note: checked deltas `origin/claude/b69..origin/claude/b74-aicom-spend`, `0a1ccb4d..origin/claude/b74-aicom-spend`, `b8530477..origin/claude/b74-aicom-spend` and `3406ffa0..HEAD` are empty for the checked Chernarus/Vanilla SmallSite/MediumSite paths.
...
## 2026-06-23T02:33:09+02:00 - Codex - Upgrade-sync current B74 refresh

- Claimed `upgrade-sync-current-b74-refresh-2026-06-23` after the RequestSpecial `upgrade-sync` owner/status/queue rows named current B69 evidence but did not include adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`.
- Source scope: docs/source `HEAD@b27717f532a3` is unchanged from `bc21f5207650` and `ff8dd884` for checked Chernarus/Vanilla `Server_HandleSpecial.sqf`, `GUI_UpgradeMenu.sqf` and `Server_ProcessUpgrade.sqf` paths. Current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu is `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`; historical upgrade-queue evidence is `b061c905b7be`.
- Findings: docs/source keeps the caller at `GUI_UpgradeMenu.sqf:171`, mixed parser at `Server_HandleSpecial.sqf:3,67-73` and sync lifecycle at `Server_ProcessUpgrade.sqf:26,29,35` in both maintained roots. Current stable, B69 and B74 keep the same mixed `_args` / `_this` parser at `Server_HandleSpecial.sqf:3,67-73`, caller `GUI_UpgradeMenu.sqf:292` and sync lifecycle `Server_ProcessUpgrade.sqf:32,35,41` in both maintained roots. Miksuu/perf keep caller `:241`; historical `a96fdda2` keeps caller `:254`; historical upgrade-queue `b061c905` keeps caller `:268`.
- Branch note: checked deltas `origin/claude/b69..origin/claude/b74-aicom-spend` and `0a1ccb4d..origin/claude/b74-aicom-spend` are empty for checked handler/caller/process-upgrade paths. `origin/master..origin/claude/b74-aicom-spend` touches `Server_HandleSpecial.sqf` only in unrelated `aicom-team-heading`, `connected-hc` and GUER VBIED sections. Current origin exposes no live `release/*`, upgrade, special or queue rescue head.
- Result: refreshed [Support specials](Support-Specials-And-Tactical-Modules-Atlas#upgrade-sync-branch-matrix), [Upgrades and research](Upgrades-And-Research-Atlas#current-branch-scope), Feature Status, Source Fix queue, dashboard, pruning ledger and upgrade-sync machine rows with adjacent B74 evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T02:53:37+02:00 - Codex - Attack-wave authority current B74 refresh

- Claimed `attack-wave-authority-current-b74-refresh-2026-06-23` after attack-wave owner/status/queue rows still named current B69 evidence while already noting adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`.
- Source scope: docs/source `HEAD@6d263dc21093` is unchanged from `1c1ea55970dc` and `f3e157f2` for checked Chernarus/Vanilla attack-wave request/detail/client-price paths. Current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu is `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release, AI-commander and upstream AttackWave evidence are `a96fdda28087`, `c20ce153` and `994150da`.
- Findings: docs/source still gates the action client-side at `updateclient.sqf:240`, sends `ATTACK_WAVE_INIT` from `Common_AttackWaveActivate.sqf:6,8`, trusts `_supply` / `_side` in `Server_AttackWave.sqf:5-6,15,23,27,36,38`, trusts detail payloads in `AttackWave.sqf:19,23-25,40`, and applies the modifier in buy-price consumers `Client_UIFillListBuyUnits.sqf:60` and `GUI_Menu_BuyUnits.sqf:90,261`.
- Branch note: current stable, B69 and B74 keep the same request/detail trust in both maintained roots; their buy-price consumers are `Client_UIFillListBuyUnits.sqf:90` and `GUI_Menu_BuyUnits.sqf:99,416`. Checked B69..B74 and older-B69-to-B74 path deltas only touch constants: B74 Chernarus constants drift to `Init_CommonConstants.sqf:528,572-574`, maintained Vanilla stays `:349,393-395`.
- Rescue scan: current origin exposes no live `release/*`, attack-wave or support rescue head. Miksuu, perf, historical release, historical AI-commander and historical upstream AttackWave all keep the same inherited trust shape.
- Result: refreshed [Attack-wave authority](Attack-Wave-Authority-Playbook#branch--root-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and attack-wave machine rows with adjacent B74 evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T03:02:49+02:00 - Codex - Auto-wall current B74 refresh

- Claimed `auto-wall-current-b74-refresh-2026-06-23` after the auto-wall global-toggle owner/status/queue rows still cited older B69 scope and did not include adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`.
- Planned source scope: `coin_interface.sqf`, `RequestAutoWallConstructinChange.sqf`, `Init_Common.sqf`, `Construction_SmallSite.sqf` and `Construction_MediumSite.sqf` in source Chernarus plus maintained Vanilla, checked across docs/source, current stable `origin/master@0139a346`, current B69 `origin/claude/b69@8d465fce`, adjacent B74, current Miksuu `b8389e748243`, perf `origin/perf/quick-wins@0076040f` and historical release `a96fdda2`.
- No gameplay source edits planned; this is a docs/wiki mirror refresh lane.
- Source scope: docs/source `HEAD@f3896116` is unchanged from `89aadf8c` for checked auto-wall paths. Current stable is `origin/master@0139a346`; current B69 is `origin/claude/b69@8d465fce`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557f`; current Miksuu was verified by direct `git ls-remote` as `b8389e748243`; perf is `origin/perf/quick-wins@0076040f`; historical release evidence is `a96fdda2`.
- Findings: every checked maintained root still routes CoIn `User14` / `coin_interface.sqf:180,207-217` through `RequestAutoWallConstructinChange` registered at `Init_PublicVariables.sqf:21`, and the handler writes one mission-global `isAutoWallConstructingEnabled` at `RequestAutoWallConstructinChange.sqf:3-7`. Docs/source, current Miksuu and perf initialize it `false` at `Init_Common.sqf:201` and consume it without structure exclusions at SmallSite `:110` / MediumSite `:125`. Current stable initializes it true at `Init_Common.sqf:213`; B69/B74 initialize it true at `:214`.
- Branch note: stable/B69/B74 keep the same global toggle scope but add SmallSite `AARadar`/`CBRadar` exclusions at `Construction_SmallSite.sqf:123` and MediumSite `AARadar`/`Bank`/`Reserve`/`ArtilleryRadar` exclusions at `Construction_MediumSite.sqf:160` in maintained Vanilla; B69/B74 Chernarus MediumSite line drift is `:163` because of unrelated bank-pending lines. Historical `a96fdda2` only adds the `AARadar` guard at SmallSite/MediumSite `:110/:125`.
- Rescue scan: `git diff --name-status 89aadf8c..HEAD`, `origin/claude/b69..origin/claude/b74-aicom-spend` and `35547c47..origin/claude/b74-aicom-spend` are empty for checked auto-wall paths. `origin/master..B74` touches checked files only for unrelated AICOM/GuerVbied compile and bank pending-reservation lines. Current origin exposes no live `release/*`, auto-wall, wall, construction or CoIn rescue head.
- Result: refreshed [Construction and CoIn systems](Construction-And-CoIn-Systems-Atlas#current-branch-scope), [Server composition spawner reference](Server-Composition-Spawner-Function-Reference#wall-templates), Feature Status, Source Fix queue, dashboard, pruning ledger and auto-wall machine rows with adjacent B74 evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T03:22:08+02:00 - Codex - Camp flag current B74 refresh

- Claimed `camp-flag-current-b74-refresh-2026-06-23` after the camp flag texture / repair-side flag status row still named current B69 plus naval-HVT branch evidence but did not include adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`.
- Planned source scope: `Server/FSM/server_town_camp.sqf` capture-side flag update plus `Server/Functions/Server_HandleSpecial.sqf` repair-camp handling in source Chernarus plus maintained Vanilla, checked across docs/source, current stable `origin/master@0139a346`, current B69 `origin/claude/b69@8d465fce`, adjacent B74, current Miksuu `b8389e748243`, perf `origin/perf/quick-wins@0076040f`, historical release `a96fdda2` and live `origin/feat/naval-hvt-objectives@2e1c5931`.
- No gameplay source edits planned; this is a docs/wiki mirror refresh lane.
- Source scope: docs/source `HEAD@de911438cfff` is unchanged from `28a7d9c5` for checked Chernarus/Vanilla camp capture, `repair-camp` and `CampCaptured` client-handler paths. Current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu is `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`; live naval-HVT evidence is `origin/feat/naval-hvt-objectives@2e1c59317186`.
- Findings: docs/source still writes `_newSID` at `server_town_camp.sqf:132` then sets the world flag from old `_side` at `:135`; `repair-camp` changes side/broadcasts at `Server_HandleSpecial.sqf:165,168` without flag refresh; and `CampCaptured.sqf:22,47` only recolors markers. Current stable/B69/B74/historical/naval-HVT fix independent capture in both maintained roots at `server_town_camp.sqf:83-86`; B69/B74 repair remains open at Chernarus `Server_HandleSpecial.sqf:491,494` and Vanilla `:468,471`.
- Branch note: checked deltas `origin/claude/b69..origin/claude/b74-aicom-spend`, `0a1ccb4d..origin/claude/b74-aicom-spend` and `28a7d9c5..HEAD` are empty for checked camp flag, `repair-camp` and `CampCaptured` client-handler paths. Current Miksuu still uses old owner at `server_town_camp.sqf:88-91`; perf fixes Chernarus only at `:135`; current origin exposes no live `release/*`, `*camp*` or `*town*` rescue head.
- Result: refreshed [Towns, camps and capture](Towns-Camps-And-Capture-Atlas#current-branch-scope), Feature Status, Source Fix queue, dashboard, pruning ledger and camp-flag machine rows with adjacent B74 evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T03:41:05+02:00 - Codex - Gear template profile current B74 refresh

- Claimed `gear-template-profile-current-b74-refresh-2026-06-23` after the gear profile/template owner/status/queue rows named current stable evidence but did not include adjacent B69/B74 `origin/claude/b69@8d465fce` / `origin/claude/b74-aicom-spend@b23f557f`.
- Planned source scope: `Client_UI_Gear_SaveTemplateProfile.sqf`, `Client_UI_Gear_AddTemplate.sqf`, `Client_UI_Gear_FillTemplates.sqf` and `Init_ProfileGear.sqf` in source Chernarus plus maintained Vanilla, checked across docs/source, current stable `origin/master@0139a346`, current B69, adjacent B74, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f`, historical release `a96fdda2` and historical EASA QoL `a66d46912e2a`.
- Initial findings: docs/source `HEAD@c7f361f4` is unchanged from `72b5f0de98f9` / `43c3ba05` for checked template paths and still carries undefined `_u_upgrade` at `Client_UI_Gear_SaveTemplateProfile.sqf:33,52,75` plus `Init_ProfileGear.sqf:17,25` six-field import guard/index-6 read. Current stable/B69/B74 fix the save-filter comparisons at `:34,:57,:82` in both maintained roots, but still keep the import-bound issue and AddTemplate `:136` Barracks-or-Gear versus FillTemplates `:17` Gear-only policy split.
- No gameplay source edits planned; this is a docs/wiki mirror refresh lane.
- Source scope: current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu is `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`; historical EASA QoL evidence is `a66d46912e2a`.
- Branch note: checked deltas `72b5f0de98f9..HEAD`, `43c3ba05..HEAD`, `origin/claude/b69..origin/claude/b74-aicom-spend`, `origin/master..origin/claude/b74-aicom-spend` and `0a1ccb4d..origin/claude/b74-aicom-spend` are empty for the checked template paths. Current origin exposes no live `release/*`, gear or template rescue head.
- Result: refreshed [Gear template profile filter](Gear-Template-Profile-Filter), [Gear/loadout/EASA atlas](Gear-Loadout-And-EASA-Atlas), Feature Status, Source Fix queue, dashboard, pruning ledger and gear-template machine rows with adjacent B74 evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T04:01:06+02:00 - Codex - Vehicle cargo loop current B74 refresh

- Claimed `vehicle-cargo-loop-current-b74-refresh-2026-06-23` after the cargo-loop owner/status/queue rows captured current stable and Miksuu scope but did not include adjacent B69/B74 `origin/claude/b69@8d465fce` / `origin/claude/b74-aicom-spend@b23f557f`.
- Planned source scope: `Common_EquipVehicle.sqf` and `Common_EquipBackpack.sqf` in source Chernarus plus maintained Vanilla, checked across docs/source, current stable `origin/master@0139a346`, current B69, adjacent B74, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f`, historical release `a96fdda2` and historical EASA QoL `a66d46912e2a`.
- Initial findings: docs/source `HEAD@bd0ec67d` is unchanged from `b2544207` for checked cargo helper paths and still carries inclusive loops at `Common_EquipVehicle.sqf:27,33,39` plus `Common_EquipBackpack.sqf:35,41` in both maintained roots. Current stable/B69/B74 and historical `a96fdda2` fix all five loops to `(count(_items) - 1)` in both maintained roots; current Miksuu and historical EASA QoL keep the inclusive loops; perf fixes Chernarus only while maintained Vanilla remains old-shape.
- No gameplay source edits planned; this is a docs/wiki mirror refresh lane.
- Source scope: current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu was rechecked with `git ls-remote` as `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`; historical EASA QoL evidence is `a66d46912e2a`.
- Branch note: checked deltas `b2544207..HEAD`, `origin/claude/b69..origin/claude/b74-aicom-spend`, `origin/master..origin/claude/b74-aicom-spend` and `0a1ccb4d..origin/claude/b74-aicom-spend` are empty for checked cargo helper paths. Current origin exposes no live `release/*`, cargo, equip, gear, EASA or QoL rescue head.
- Result: refreshed [Vehicle cargo equip loop bounds](Vehicle-Cargo-Equip-Loop-Bounds), [Gear/loadout/EASA atlas](Gear-Loadout-And-EASA-Atlas), Feature Status, Source Fix queue, dashboard, pruning ledger and cargo-loop machine rows with adjacent B74 evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T04:17:05+02:00 - Codex - Buy-menu price/key current B74 refresh

- Claimed `buy-menu-price-key-current-b74-refresh-2026-06-23` after the buy-menu price/key owner/status/queue rows still used 2026-06-21 current-stable wording and did not include adjacent B69/B74 evidence.
- Planned source scope: `GUI_Menu_BuyUnits.sqf`, `Client_UIFillListBuyUnits.sqf` and `Init_CommonConstants.sqf` in source Chernarus plus maintained Vanilla, checked across docs/source `HEAD`, current stable `origin/master@0139a346`, current B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f`, historical release `a96fdda2` and historical EASA QoL `a66d46912e2a`.
- Initial findings: docs/source `HEAD@4120137f` is unchanged from `8d611092` / `ebd86fad0` for checked buy-menu controller/list-filler paths and still has selected-detail price drift at `GUI_Menu_BuyUnits.sqf:261`, no level-0 list-filler reset for `UNIT_COST_MODIFIER`, and uppercase/lowercase driver-default profile key split in both maintained roots. Current stable/B69/B74 and historical `a96fdda2` fix selected-detail display and mirror both driver keys in both maintained roots, but still only write unit-cost discounts at `Client_UIFillListBuyUnits.sqf:11,14`; B69..B74 changes only Chernarus constants among checked paths.
- No gameplay source edits planned; this is a docs/wiki mirror refresh lane.
- Source scope: direct current Miksuu `master` was rechecked as `b8389e748243`; current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`; historical EASA QoL evidence is `a66d46912e2a`.
- Branch note: checked deltas `8d611092..HEAD` and `ebd86fad0..HEAD` are empty for Chernarus/Vanilla buy-menu controller/list-filler paths. Checked `origin/claude/b69..origin/claude/b74-aicom-spend`, `origin/master..origin/claude/b74-aicom-spend` and `0a1ccb4d..origin/claude/b74-aicom-spend` are empty for controller/list-filler paths and touch only `Init_CommonConstants.sqf` line drift. Current origin exposes no live `release/*`, buy, EASA, QoL or factory rescue head.
- Result: refreshed [Factory and purchase systems atlas](Factory-And-Purchase-Systems-Atlas#buy-menu-price-and-driver-key-branch-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and buy-menu price/key machine rows with adjacent B74 evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T04:30:26+02:00 - Codex - Stale upgrade dialog current B74 refresh

- Claimed `stale-upgrade-dialog-current-b74-refresh-2026-06-23` after the stale old upgrade dialog row still cited the 2026-06-14 branch check and one dead-code row incorrectly implied current `origin/master` still carried `RscMenu_Upgrade`.
- Planned source scope: `Rsc/Dialogs.hpp`, `Client/GUI/GUI_Menu.sqf`, `Client/GUI/GUI_UpgradeMenu.sqf` and missing `Client/GUI/GUI_Menu_Upgrade.sqf` in source Chernarus plus maintained Vanilla, checked across docs/source `HEAD`, current stable `origin/master@0139a346`, current B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f`, historical release `a96fdda2` and historical upgrade-queue `b061c905`.
- Initial findings: docs/source `HEAD@0fdd5602` is unchanged from `d4cfef80` for checked upgrade dialog/controller paths and still carries `RscMenu_Upgrade` at `Rsc/Dialogs.hpp:2425` with `onLoad` pointing at missing `Client\GUI\GUI_Menu_Upgrade.sqf` at `:2428` in both maintained roots. Current stable, B69, B74, historical `a96fdda2` and historical `b061c905` keep only the live `WFBE_UpgradeMenu` `onLoad` at `Rsc/Dialogs.hpp:4-7` in both maintained roots; current Miksuu and perf keep the stale class at `:2435,:2438`.
- No gameplay source edits planned; this is a docs/wiki mirror refresh lane.
- Branch note: checked `d4cfef80..HEAD`, `origin/master..origin/claude/b74-aicom-spend` and `origin/claude/b69..origin/claude/b74-aicom-spend` deltas are empty for the checked upgrade dialog/controller paths. Direct current Miksuu `master` was rechecked with `git ls-remote` as `b8389e748243`.
- Result: refreshed [UI resource parity cleanup](UI-Resource-Parity-Cleanup), [Client UI systems atlas](Client-UI-Systems-Atlas), Feature Status, Dead/stale code, dashboard, pruning ledger and stale-upgrade machine rows with current stable/B69/B74 evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T04:45:49+02:00 - Codex - Economy dialog controls current B74 refresh

- Claimed `economy-dialog-controls-current-b74-refresh-2026-06-23` after Economy stale-control rows still mixed 2026-06-14 stable/release wording and one dead-code row incorrectly implied current stable still carried `23004/23005/23006` writes.
- Planned source scope: `Client/GUI/GUI_Menu_Economy.sqf` and `Rsc/Dialogs.hpp` in source Chernarus plus maintained Vanilla, checked across docs/source `HEAD@21f0d53b`, current stable `origin/master@0139a346`, current B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f` and historical release `a96fdda2`.
- Initial findings: docs/source still writes disabled-state controls `23004`, `23005` and `23006` from `GUI_Menu_Economy.sqf:7-8` in both maintained roots while `RscMenu_Economy` declares `23002`, `23003` and `23008` without `23020`. Current stable, B69, B74 and historical `a96fdda2` use `DisplayCtrl 23020` at `GUI_Menu_Economy.sqf:25` and declare `idc = 23020` in both maintained roots.
- Branch note: current Miksuu `master` was rechecked by direct `git ls-remote` as `b8389e748243`; it and `origin/perf/quick-wins@0076040f` keep the stale writes in both maintained roots. Checked `d2a3f995..HEAD`, `b5219d47..HEAD`, `origin/claude/b69..origin/claude/b74-aicom-spend` and `0a1ccb4d..origin/claude/b74-aicom-spend` deltas are empty for checked Economy controller/resource paths; `origin/master..origin/claude/b74-aicom-spend` changes only Chernarus dashboard label text among checked paths.
- No gameplay source edits planned; this is a docs/wiki mirror refresh lane.
...
## 2026-06-23T05:19:46+02:00 - Codex - ClickableText soundPush current B74 refresh

- Claimed `clickabletext-soundpush-current-b74-refresh-2026-06-23` after finding the human Client UI / Feature Status / Source Fix queue rows already treat current stable as source-present for valid `RscClickableText.soundPush[]`, while older machine rows and Dead/stale wording still describe current stable as malformed.
- Planned source scope: `Rsc/Ressources.hpp` base `RscClickableText` value and `Rsc/Dialogs.hpp` derived `RscClickableText` controls in source Chernarus plus maintained Vanilla, checked across docs/source `HEAD`, current stable `origin/master@0139a346`, current B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f`, historical release `a96fdda2` and UI theme branches.
- No gameplay source edits planned; this is a docs/wiki mirror refresh lane.
- Source scope: docs/source `HEAD@0bb0f89f` is unchanged from `b5219d47` for checked resource/dialog paths and still keeps malformed `RscClickableText.soundPush[] = {, 0.2, 1};` at `Rsc/Ressources.hpp:556` in both maintained roots with 17 derived `RscClickableText` controls. Current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu was rechecked by direct `git ls-remote` as `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`; UI theme evidence is `origin/feat/wf-menu-ops-console@0767c0b5` and `origin/feat/wf-menu-ux-phase1@87d86257`.
- Findings: current stable, B69 and B74 keep valid `soundPush[] = {"", 0.2, 1};` at `Rsc/Ressources.hpp:556` in both maintained roots and derive 14 controls from `RscClickableText`. Stable blame points to `1a5e0b40` for Chernarus and `9b49883c` for maintained Vanilla. Checked `origin/master..origin/claude/b74-aicom-spend` and `origin/claude/b69..origin/claude/b74-aicom-spend` resource/dialog deltas are empty.
- Branch note: current Miksuu, perf and the two UI theme branches keep the malformed value with 17 derived controls in both maintained roots; historical `a96fdda2` keeps the malformed value with 14 derived controls. Current origin exposes no live `release/*` or click/sound/resource rescue head on 2026-06-23 beyond the two UI theme branches.
- Result: refreshed [Client UI systems atlas](Client-UI-Systems-Atlas#clickable-text-soundpush-branch-matrix), Feature Status, Source Fix queue, Dead/stale code, dashboard, pruning ledger and clickable-text machine rows with current stable/B69/B74 source-present evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T05:36:16+02:00 - Codex - RHUD/endgame title-handle current B74 refresh

- Claimed `rhud-endgame-title-handle-current-b74-refresh-2026-06-23` after Source Fix Propagation Queue still carried 2026-06-14 stable `cf2a6d6a` wording for the `currentCutDisplay` split while the UI owner pages and hardening row already had current stable/B69/B74 evidence.
- Source scope: docs/source `HEAD@92b52e73` is unchanged from `edbd341e` and `b5219d47` for checked Chernarus/Vanilla `Rsc/Titles.hpp`, `Client_UpdateRHUD.sqf`, `updateavailableactions.fsm`, `GUI_EndOfGameStats.sqf`, `GUI_SetCurrentCutDisplay.sqf` and `GUI_ClearCurrentCutDisplay.sqf` paths. Current stable is `origin/master@0139a3468609`; current B69 is `origin/claude/b69@8d465fcede7f`; adjacent B74 is `origin/claude/b74-aicom-spend@b23f557fc912`; current Miksuu was rechecked by direct `git ls-remote` as `b8389e748243`; perf is `origin/perf/quick-wins@0076040f8a5e`; historical release evidence is `a96fdda28087`.
- Findings: every checked maintained root still has `OptionsAvailable` and `EndOfGameStats` using the same `GUI_SetCurrentCutDisplay.sqf` / `GUI_ClearCurrentCutDisplay.sqf` helper pair and therefore the same `uiNamespace["currentCutDisplay"]` key. Docs/Miksuu/perf use `Rsc/Titles.hpp:170-171,539-540`, `Client_UpdateRHUD.sqf:89,92,190`, `updateavailableactions.fsm:225,228,230` and `GUI_EndOfGameStats.sqf:13,34-44,86-93`; stable/B69/B74 use `Rsc/Titles.hpp:174-175,587-588` and `Client_UpdateRHUD.sqf:89,92,266`.
- Branch note: B69/B74 Chernarus only drift the endgame stat anchors to `GUI_EndOfGameStats.sqf:15,36-46,88-95` because of unrelated GUER-label work. Checked `origin/claude/b69..origin/claude/b74-aicom-spend` title-handle deltas are empty, while checked `origin/master..B74` adds only unrelated Chernarus GUER-label and vehicle-tint title content. Current origin exposes no live `release/*` head.
- Result: refreshed [UI IDD collision repair](UI-IDD-Collision-Repair#title-display-handle-branch-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows with current stable/B69/B74 title-handle evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T05:51:09+02:00 - Codex - Victory/endgame current B74 refresh

- Claimed `victory-endgame-current-b74-refresh-2026-06-23` after Victory/endgame rows still used the 2026-06-21 current-stable wording and did not distinguish B69/B74 Chernarus partial fixes from maintained Vanilla drift.
- Planned source scope: `Server/FSM/server_victory_threeway.sqf`, `Client/Client_EndGame.sqf`, `Client/GUI/GUI_EndOfGameStats.sqf` and `Common/Init/Init_CommonConstants.sqf` in source Chernarus plus maintained Vanilla, checked across docs/source `HEAD`, current stable `origin/master@0139a346`, current B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f`, historical `a96fdda2` and `origin/claude/b57-soak-proposals@b8a1505f`.
- Initial findings: docs/source `HEAD@4c87efd2` keeps the old server loop in both maintained roots (`server_victory_threeway.sqf:11,23-24,31,41`) and old client inversion/label shape (`Client_EndGame.sqf:5-13`; `GUI_EndOfGameStats.sqf:5-8`). Current stable adds HQ nil/null skip and WASPSTAT/logging drift but still gates `_victory == 0` and uses the mixed guard at `server_victory_threeway.sqf:11,21-22,29,37,41-49` in both roots.
- B69/B74 findings: Chernarus removes the `_victory == 0` gate at `server_victory_threeway.sqf:16`, adds same-tick short-circuit at `:26` and guards the combined condition at `:45`; maintained Vanilla remains stable-shaped at `:11,:29,:49`. B69/B74 remove client side inversion at `Client_EndGame.sqf:6-11` in both roots, but add the GUER label only in Chernarus `GUI_EndOfGameStats.sqf:8-10`.
- No gameplay source edits planned; this is a docs/wiki mirror refresh lane.
- Branch note: checked `origin/claude/b69..origin/claude/b74-aicom-spend` victory-path deltas only touch Chernarus `Init_CommonConstants.sqf`; direct current Miksuu `master` was rechecked as `b8389e7482438edd00f420c5bb795ac0a642971f`.
- Result: refreshed [Victory/endgame atlas](Victory-And-Endgame-Atlas#current-branch-scope), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows with current stable/B69/B74 evidence. B69/B74 Chernarus is now documented as a partial rescue, not maintained-root closure. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T06:07:05+02:00 - Codex - LoadoutManager root discovery current B74 refresh

- Claimed `loadoutmanager-root-current-b74-refresh-2026-06-23` after tooling/root-discovery wording mixed branch-specific marker-root rules and the Source Fix queue still used the earlier current-stable framing without B69/B74 branch-tip evidence.
- Planned source scope: `Tools/LoadoutManager/FileManagement/FileManager.cs` across docs/source `HEAD@ffdfaa24`, current stable `origin/master@0139a346`, current B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f` and historical `a96fdda2`.
- Initial findings: docs/source accepts either an ancestor named `a2waspwarfare` or a repo-shaped root with `Missions`, `Missions_Vanilla` and `Tools/LoadoutManager/LoadoutManager.csproj` (`FileManager.cs:153,158,166,176,186-188`). Current stable/B69/B74/a96fdda2 accept either the named ancestor or markers `Missions/[55-2hc]warfarev2_073v48co.chernarus`, `Tools/LoadoutManager` and `AGENTS.md` (`FileManager.cs:145,150,158,165,170-176`). Current Miksuu/perf still require an ancestor named `a2waspwarfare` (`FileManager.cs:145,150`).
- No gameplay source edits planned; this is a docs/wiki mirror refresh lane.
...
## 2026-06-23T09:50:56+02:00 - Codex - HQ score current B74.1 refresh

- Claimed `hq-score-current-b741-refresh-2026-06-23` after `origin/master` advanced from `0139a346` to `f8a76de34`, the same commit as `origin/claude/b74.1-aicom`.
- Source scope: `Server/Functions/Server_OnHQKilled.sqf` and `Common/Init/Init_CommonConstants.sqf` in source Chernarus plus maintained Vanilla, checked across docs/source `HEAD@c2d513ecb` (source-unchanged from `9b7eb4bc`), current stable/B74.1 `origin/master@f8a76de34`, current B69 `origin/claude/b69@8d465fce`, B74 `origin/claude/b74-aicom-spend@b23f557f`, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f` and historical release evidence `a96fdda2`.
- Findings: current stable/B74.1 still awards generic `_points` at `Server_OnHQKilled.sqf:64/:66`, then awards `_score = 900` again at `:109/:112` under the non-teamkill guard in both maintained roots. `WFBE_C_BUILDINGS_SCORE_COEF` remains `3`; line drift is Chernarus `Init_CommonConstants.sqf:753` and maintained Vanilla `:555`.
- Branch note: a pre-push fetch advanced current stable/B74.1 again to `f8a76de34`; checked HQ-score handler lines are unchanged from the earlier B74.1 fetch, and only Chernarus `Init_CommonConstants.sqf` changed among checked HQ-score files. B69/B74/B74.1 base-fall smoke/sting around `Server_OnHQKilled.sqf:57/:103` is spectacle/notification code, not a DR-50 scoring fix. Direct current Miksuu `master` was rechecked as `b8389e748243`; current origin exposes no live `release/*`, `feat/*hq*`, `feat/*score*`, `feat/*bounty*` or `feat/*base*` rescue head beyond the B74 branch heads.
- Result: refreshed [Commander/HQ lifecycle](Commander-HQ-Lifecycle-Atlas#hq-kill-score-and-bounty-branch-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and HQ-score machine rows with current stable/B74.1 evidence. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T09:58:00+02:00 - Codex - Reaktiv current B74 refresh

- Claimed `reaktiv-current-b74-refresh-2026-06-23` after the Reaktiv dormant-module matrix still named 2026-06-14 stable `cf2a6d6a` while current stable had advanced to `origin/master@f8a76de34` and B69/B74 needed explicit coverage.
- Source scope: docs/source `HEAD@c2d513ecb672`, current stable `origin/master@f8a76de34`, current B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, direct current Miksuu `master@b8389e748243`, `origin/perf/quick-wins@0076040f` and historical `a96fdda2`.
- Findings: docs/source, direct Miksuu and perf still carry maintained-root `Common/Module/Reaktiv/Reaktiv_Init.sqf:5` plus `Reaktiv_OnHandleDamage.sqf:7` without a maintained-root `Init_Common` caller; current stable/B69/B74/historical `a96fdda2` have no maintained-root `Common/Module/Reaktiv` hits. Current stable/B69/B74 initialize ICBM/IRS/CIPHER only at Chernarus `Init_Common.sqf:337-341` and maintained Vanilla `:330-334`.
...
## 2026-06-23T10:20:15+02:00 - Codex - HQ score Miksuu branch intel

- Claimed `hq-score-miksuu-branch-intel-2026-06-23` after a fresh Miksuu fetch exposed score/HQ/bounty branch names that could look like DR-50 rescue branches by name alone.
- Planned source scope: maintained-root `Server/Functions/Server_OnHQKilled.sqf` plus score/coefficient context in current stable `origin/master@f8a76de34`, current B74/B74.1, current B69, direct current Miksuu `master@b8389e748243`, Miksuu score/HQ branch candidates and historical release evidence where useful.
- No gameplay source edits planned; this is a docs/wiki mirror branch-intel lane.
- Findings: current Miksuu `master@b8389e748243` still keeps the double-award handler in both maintained roots. `miksuu/ScoreForKillingFactories@f17445c15190`, `miksuu/Fix0ScoreBountyBug@415615c9662a`, `miksuu/FixNukeMoneyGain@2ad3a7d38837` and `miksuu/TakistanNukeSoundFileMissing@f3eae47a24ad` share old handler blob `12d33a8f87ee` with no `_points`, one `_score = 900`, a non-teamkill guard and old Chernarus plus old Takistan layout only.
- Branch note: `miksuu/AntiHQTeamkillDisabledInDebugMode@5bafe566951a` and adjacent current-layout branch blobs prove branch-only one-award ancestry, not current master behavior. `miksuu/BountyModifierTo4@cc127ef40b4d` has no `_score = 900` and no `_points` in `Server_OnHQKilled.sqf`, so it is a bounty-tune/non-score branch rather than a DR-50 fix. `f17445c15` and `b31539b46` are ancestors of current Miksuu, while `96809ac35` is the key folder-structure history point for the current generic `_points` award shape.
- Result: refreshed [Commander/HQ lifecycle](Commander-HQ-Lifecycle-Atlas#hq-kill-score-and-bounty-branch-matrix), Feature Status, Source Fix queue, [Upstream Miksuu commit intel](Upstream-Miksuu-Commit-Intel), [Developer history](Developer-History-And-Upstream-Lessons), dashboard, pruning ledger and HQ-score machine rows so branch names are treated as search leads, not fixes. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T10:31:16+02:00 - Codex - Source Fix queue current B74.1 scope refresh

- Claimed `source-fix-queue-current-b741-scope-2026-06-23` after the Source Fix Propagation Queue still named current stable `origin/master@0139a346` in its propagated-fix branch matrix while current stable now resolves to `origin/master@f8a76de34`, the same commit as `origin/claude/b74.1-aicom`.
- Planned source scope: existing propagated-fix queue paths only: paratrooper PV registration, client `Skill_Init`/apply, server FPS publisher, supply scan, supply player-object list and commander-built ARTY discovery across source Chernarus plus maintained Vanilla, with B69/B74, current Miksuu, perf and exposed feature heads rechecked where useful.
- Initial branch note: scoped `0139a346..f8a76de34` path diff touches only maintained-root `Client/Init/Init_Client.sqf` among those queue paths; no gameplay source edits planned.
- Result: refreshed Source Fix Propagation Queue, Current Source Status Snapshot, Testing workflow, Progress Dashboard, pruning ledger and release-readiness source-only rows. Current stable/B74.1 uses the B69/B74 `Skill_Init`/apply shape at `Client/Init/Init_Client.sqf:805,828`; paratrooper registration remains `Init_PublicVariables.sqf:38`; FPS remains one guarded `serverFpsGUI.sqf:4` publisher with `SERVER_FPS_GUI` at `:9-10`; supply scan remains `supplyMissionStarted.sqf:7,55,61,83`; player-list reset remains inside the loop at `playerObjectsList.sqf:18`; commander ARTY remains marker-based at `Construction_StationaryDefense.sqf:166-168` plus `Common_GetTeamArtillery.sqf:41-78`.
- Branch note: B74.1 tip commit `f8a76de34` changes only Chernarus `Common/Init/Init_CommonConstants.sqf`; `0139a3468609..f8a76de34` across the scoped queue paths touches only maintained-root `Client/Init/Init_Client.sqf`. Current origin exposed no live `release/*` or artillery/propagation rescue head for this lane; historical `a96fdda2` / `7ff18c49` remains historical release-line evidence. No gameplay source changed.
- Validation: JSON/JSONL parse passed in wiki checkout and docs/wiki mirror; `docs/validate-wiki.ps1` passed with known legacy JSONL envelope warnings only; dashboard Latest Batch has five rows; touched-file parity passed across 11 files; conflict-marker scan found no newly added markers; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T10:55:00+02:00 - Codex - Upstream AN-2 / map-icon branch intel

- Claimed `upstream-an2-mapicons-branch-intel-2026-06-23` after a fresh fetch exposed two new small upstream-mining branches: `origin/claude/upstream-an2-climb-boost` and `origin/claude/upstream-blinking-mapicons`.
- Planned source scope: compare both branch tips against current stable `origin/master@f8a76de34` and branch merge-base `be2bbd084`, then inspect source Chernarus plus maintained Vanilla touched files for Valhalla low gear / high-climb and combat map-icon blinking.
- Initial branch shape: `upstream-an2-climb-boost@63e6b4142` touches four payload files versus merge-base (`Func_Client_LowGear.sqf` and `Init_Unit.sqf` in both maintained roots); `upstream-blinking-mapicons@6e31f7fd5` touches two `Client_BookkeepBlinkingIcons.sqf` copies. Neither tip is contained by another fetched remote branch, and diffing directly against current stable also shows B74.1 `Init_CommonConstants.sqf` drift from the older branch base.
- Findings: `origin/claude/upstream-an2-climb-boost@63e6b4142` adds `An2_TK_EP1` low-gear actions at `Init_Unit.sqf:87-90` plus an `Air` assist target `_min = 100` at `Func_Client_LowGear.sqf:68-75` in source Chernarus and maintained Vanilla. Current stable `origin/master@f8a76de34` lacks that Air target and keeps low-gear actions limited to Tank/Car.
- Findings: `origin/claude/upstream-blinking-mapicons@6e31f7fd5` adds mounted gunner/commander soldier-marker blinking at `Client_BookkeepBlinkingIcons.sqf:96-110` in both maintained roots. Current stable `origin/master@f8a76de34` only pushes active vehicle blink markers at `Client_BookkeepBlinkingIcons.sqf:82-94`.
- Result: refreshed [Valhalla vehicle climbing assist](Valhalla-Vehicle-Climbing-Assist#branch-intel---an-2-fast-lift-candidate), [Client UI systems](Client-UI-Systems-Atlas#map-and-marker-ui), Feature Status, Testing workflow branch-only smoke pack, release-readiness promotion gates, dashboard, pruning ledger and machine rows. Both branches are documented as branch-only candidates; porting must preserve current-stable/B74.1 `WFBE_C_STATS_ENABLED = true` drift and needs AN-2/map-marker smoke before promotion. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T11:30:00+02:00 - Claude - Upstream-mining loop ledger + 6 draft PRs

- Ran a self-paced upstream-mining loop against the upstream parent `Miksuu/a2waspwarfare` (we are ~557 ahead): fetched 490 branches -> 93 carry unique commits vs our `master` -> workflow triage -> adversarial source verification (18 deep-verified pass 1, 30 re-verified pass 2) -> ranked PR shortlist.
- Headline: our fork has already absorbed nearly all high-value upstream work; remaining surface is thin. Most unique-commit branches are debug/test scratch, stale merge tombstones, version-snapshot bundles already on master, reverts, or A3-port experiments. Net result = 6 draft PRs + 3 flagged findings.
- New page: [Upstream mining ledger](Upstream-Mining-Ledger) (Claude-owned) documents the funnel, the PR table, the flagged findings and the reusable triage/verify artifacts.
- Draft PRs (all DRAFT / human-merge-gated, engine smoke pending): [#54](https://github.com/rayswaynl/a2waspwarfare/pull/54) AT-soldier buy-menu names + NLAW tier (`claude/upstream-at-naming-order`); [#55](https://github.com/rayswaynl/a2waspwarfare/pull/55) blink mounted player soldier marker (`claude/upstream-blinking-mapicons`); [#56](https://github.com/rayswaynl/a2waspwarfare/pull/56) AN-2 high-climb boost capped below cruise (`claude/upstream-an2-climb-boost`); [#57](https://github.com/rayswaynl/a2waspwarfare/pull/57) show next MHQ repair price, clean reimpl of upstream broken version (`claude/upstream-hq-repair-price`); [#58](https://github.com/rayswaynl/a2waspwarfare/pull/58) town-defense group-count diagnostics + RptTownDefenseAnalyzer, syncing 3-behind (`claude/upstream-town-defense-diag-sync`); [#59](https://github.com/rayswaynl/a2waspwarfare/pull/59) 4th Barracks level + infantry tier rebalance, needs balance sign-off (`claude/upstream-barracks-4th-level`).
- Flagged findings (no PR): (a) `AdditionalHQBuying` would WORSEN a known HIGH-severity client-authority exploit (removes cash-rebuy lock + client-local price escalation -> repeatable own-side town-supply drain); cross-refs DR-55 / Server-Authority-Migration-Map / WASP-Overlay; server-side redesign only. (b) `AirRework_GunDamageAdjustedToPlanes` `_p=99` INVERTS intent (planes near gun-immune) and 4/6 ammo classnames are not OA rounds; template only. (c) `Tournament_SideSpeakerWIP`/`TournamentFeaturesImplementation` caster/spectator system genuinely absent but unfinished WIP that leaks both-team intel to all clients; needs-design.
- Reusable artifacts under the `a2ww-upstream-mining` lane: `triage_table.tsv`, `verified_table.tsv`, `actionable_detail.txt`. No gameplay source changed in this docs pass; the code lives on the 6 draft branches.
- Nav request left for Codex in [Coordination board](Coordination-Board) message channel (sidebar/Home/agent-context.json are Codex lane).

## 2026-06-23T10:55:02+02:00 - Codex - Wiki mirror and validator availability correction

- Claimed `wiki-mirror-validator-availability-2026-06-23` after the current local gameplay checkout `C:\Users\Steff\a2waspwarfare` on `feat/supply-helicopter` returned `False` for both `docs\wiki` and `docs\validate-wiki.ps1`, while core wiki workflow pages still sounded as if the mirror and validator were always present.
- Source scope: standalone GitHub wiki checkout at `C:\Users\Steff\Documents\Codex\2026-06-23\write-a-long-term-goal-that-2\work\a2waspwarfare.wiki`; local gameplay checkout was inspected only for branch/mirror/tool availability. No gameplay source edits planned or made.
- Result: clarified [Home](Home), [LLM agent entry pack](LLM-Agent-Entry-Pack), [Progress dashboard](Progress-Dashboard) and [Wiki mirror reconciliation plan](Wiki-Mirror-Reconciliation-Plan) so future agents use a standalone wiki checkout when the active gameplay branch lacks `docs/wiki`, do not claim repo-mirror parity until a mirror-bearing checkout is inspected, and run fallback validation when `docs\validate-wiki.ps1` is unavailable.
- Validation: final validation is recorded in the matching `complete` event. The repo validator was unavailable in the active gameplay checkout for this batch.

## 2026-06-23T11:05:00+02:00 - Codex - LoadoutManager skip-zip local branch caveat

- Claimed `loadoutmanager-skip-zip-local-branch-caveat-2026-06-23` after the source-risk scout found the current local gameplay checkout `C:\Users\Steff\a2waspwarfare` on `feat/supply-helicopter` at `HEAD@558fba343` does not implement the wiki's `A2WASP_SKIP_ZIP` shortcut.
- Source evidence: `rg -n "A2WASP_SKIP_ZIP" Tools\LoadoutManager` returned no matches; `SqfFileGenerator.cs:135` calls `ZipManager.DoZipOperations()` unconditionally; `ZipManager.cs:38` calls `Create7zFromDirectory(...)`; `ZipManager.cs:73-76` requires env var `7za` and throws if it is missing; `FileManager.cs:145-152` remains ancestor-name-only root discovery.
- Result: updated [Tools and build workflow](Tools-And-Build-Workflow), [Source fix propagation queue](Source-Fix-Propagation-Queue) and [Testing/debugging/release workflow](Testing-Debugging-And-Release-Workflow) so `A2WASP_SKIP_ZIP` and marker-root discovery are branch-specific claims, not universal commands. The 2026-06-02 skip-zip run remains documented as evidence for the checkout used then.
- Validation: final validation is recorded in the matching `complete` event. No gameplay source changed.

## 2026-06-23T11:12:00+02:00 - Codex - Footer support-page navigation prune

- Claimed `footer-support-page-nav-prune-2026-06-23` from the navigation auditor subagent's finding. `_Footer.md` exposed [Deep review](Deep-Review-Findings) and [Claude loop](Claude-Loop-Goal) as global footer links even though [Navigation inventory](Navigation-Inventory-And-Page-Status) classifies them as archive/evidence-ledger and agent-instruction/support-only surfaces.
- Evidence: [Wiki pruning ledger](Wiki-Pruning-And-Relevance-Ledger) keeps Deep Review as valuable evidence but too large for daily navigation, while [Home](Home) and `_Sidebar.md` already route docs/platform maintainers through [Knowledge platform roadmap](Knowledge-Platform-Roadmap).
- Result: `_Footer.md` now keeps the docs-maintainer footer path focused on [Coverage ledger](Codebase-Coverage-Ledger), [Navigation inventory](Navigation-Inventory-And-Page-Status), [Pruning ledger](Wiki-Pruning-And-Relevance-Ledger), [Knowledge roadmap](Knowledge-Platform-Roadmap), [Agent context](Agent-Context), [Collab protocol](Agent-Collaboration-Protocol) and [Worklog](Agent-Worklog). No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T11:18:00+02:00 - Codex - Consistency scout handoff

- Consistency reviewer returned a broader local-checkout sync recommendation after the three small batches above. Keep it as a separate follow-up lane, not part of the published footer/tooling edits.
- Handoff items: re-check current-stable branch wording because the local repo still has `origin/master@0139a3468609` and `f8a76de34` was unavailable locally; a `git fetch origin --prune` attempt failed with a network reset during this run. Re-check supply-heli machine claims against the dirty `feat/supply-helicopter@558fba343` worktree before changing `agent-context.json`, `agent-machine-index.json` or old `agent-knowledge.jsonl` rows. Normalize `Modded_Missions/*` wording so machine context does not imply actively generated support where the public front door says stale/non-authoritative. Consider adding `agent-machine-index.json` to more front-door source tables in a small navigation batch.
- Do not edit gameplay source for that follow-up unless Steff explicitly asks for code. Treat the failed fetch as a validation limitation, not proof that previous remote/current-stable rows are wrong.

## 2026-06-23T11:20:00+02:00 - Codex - Upstream HQ repair price branch intel

- Claimed `upstream-hq-repair-price-branch-intel-2026-06-23` after a fresh fetch exposed `origin/claude/upstream-hq-repair-price@440be3da0bda`, a small MHQ repair price/action-label branch on merge-base `be2bbd084`.
- Planned source scope: compare the branch against current stable `origin/master@f8a76de34` and merge-base `be2bbd084`, then inspect source Chernarus plus maintained Vanilla `Action_RepairMHQ.sqf`, `Init_Unit.sqf` and `stringtable.xml` beside existing PR #3 repair-price revert / MHQ repair authority warnings.
- Initial branch shape: payload versus merge-base is six files / +76 / -26 with `git diff --check` clean. Direct diff against current stable additionally shows B74.1 `Init_CommonConstants.sqf` drift from the older branch base.
- Findings: current stable `origin/master@f8a76de34` keeps the plain repair action at `Init_Unit.sqf:67`, simple repair hint at `Action_RepairMHQ.sqf:42`, client-side price/count/debit/request flow at `Action_RepairMHQ.sqf:13-40`, `RequestMHQRepair.sqf:1` and `Server_MHQRepair.sqf:7-79` in both maintained roots. Prices are `25000 / 40000 / 50000` at Chernarus `Init_CommonConstants.sqf:465-467` and maintained Vanilla `:287-289`.
- Findings: branch `440be3da0bda` formats the repair-truck action label with a spawn-time price at `Init_Unit.sqf:71-78`, formats the post-repair hint with a live next price or `-` at `Action_RepairMHQ.sqf:43-55`, and adds `%1` placeholders in both maintained-root `stringtable.xml` repair keys (`:940-945`, plus Chernarus `:4592-4597` / Vanilla `:4591-4596`). It has no server/PVF payload.
- Review caveat: the inherited `Action_RepairMHQ.sqf:22` check exits when the current price equals `WFBE_C_BASE_HQ_REPAIR_PRICE_3RD`, so the branch can advertise the third price as "next" after the second repair while the next attempt may hit `STR_WF_INFO_MHQ_Repairs_Used`; smoke/owner decision needed before promotion.
- Result: refreshed [Commander/HQ lifecycle](Commander-HQ-Lifecycle-Atlas#branch-intel---upstream-hq-repair-price-candidate), Feature Status, Testing workflow branch-only smoke pack, release-readiness promotion gates, dashboard, pruning ledger and machine rows. The branch is documented as a UI/economy candidate only; server-side MHQ repair authority remains separate. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T12:10:00+02:00 - Claude - Upstream-mining Pass 3: Miksuu's Warfare Trello board + 6 grouped draft PRs

- Ran a second, independent mining pass — this one mines the **Miksuu's Warfare Trello board** (the community idea/bug backlog), not upstream git branches like passes 1-2. Source: <https://trello.com/b/Si4okJLd/miksuus-warfare> exported via `curl -L https://trello.com/b/Si4okJLd.json` (104 lists / 712 open cards; most lists are shipped version changelogs or `Low Priority (Won't)`).
- Funnel: 712 open cards -> 118 Tier-1 forward cards (Must/Should/Next/Needs-triage/Suggested/Draft/perf/cleaning) -> 22 deep-verified against `origin/master` source -> 8 ready (6 grouped draft PRs) + 8 needs-design + 6 skip.
- 6 grouped draft PRs (all DRAFT / human-merge-gated, engine smoke pending): [#60](https://github.com/rayswaynl/a2waspwarfare/pull/60) vehicle ammo % in service menu (card #99); [#61](https://github.com/rayswaynl/a2waspwarfare/pull/61) toggle automatic IR smoke off/on (#38); [#62](https://github.com/rayswaynl/a2waspwarfare/pull/62) flashing warning when FAB-250/Mk82 selected above bomb altitude limit, a "Must" (#106); [#63](https://github.com/rayswaynl/a2waspwarfare/pull/63) anti-spam guards for building (#71) + vehicle (#74) repair, two exploit-fixes; [#64](https://github.com/rayswaynl/a2waspwarfare/pull/64) block engineer salvage when a friendly salvage truck is in range (#15); [#65](https://github.com/rayswaynl/a2waspwarfare/pull/65) AAR upgrade tiered detection height (#65) + new-contact warning (#66).
- 8 needs-design (no PR): #105 paratroop kill reward (root cause never pinned upstream), #26 first-blood bonus (reward = vote, SFX = art), #27 OPFOR Hind re-tier, #29 town-depot supply trucks @10x, #41 radiation damages factories, #111 free supply truck at spawn, #113 all-arty-to-gunner key, #91 IR-smoke "cooldown ready" cue (false premise: no player-facing cooldown exists to bind to).
- ~34 deferred small codeable wins held for a later batch (e.g. #87 airlift teleporting onto HQ, #96 rearm-all-AI-at-cannon, #85 max-cities visual bug, #84 arty reload-ready sound, #76 dead WF-menu HUD button, an audio-cue cluster, #98 Linebacker/Tunguska markers). Tier-2 not yet triaged: the `Could` (149) + `Backlog` (71) lists and the voting list.
- Cross-pass total this loop: **12 draft PRs (#54-#65)**. Updated only [Upstream mining ledger](Upstream-Mining-Ledger) (appended a new `## Pass 3 - Trello board` section; earlier passes untouched). Nav files (`_Sidebar.md`/`_Footer.md`/`Home.md`) are Codex lane and were not touched. No gameplay source changed in this docs pass; the code lives on the 6 draft branches behind #60-#65.

## 2026-06-23T11:10:07+02:00 - Codex - Upstream Barracks 4th-level branch intel

- Claimed `upstream-barracks-4th-level-branch-intel-2026-06-23` after a fresh fetch exposed `origin/claude/upstream-barracks-4th-level@e83de9c4`.
- Planned source scope: compare the branch against merge-base `be2bbd084` and current stable `origin/master@f8a76de34`, then inspect maintained-root Core infantry config, Core_Upgrades Barracks metadata and `Common_CreateUnit.sqf` in source Chernarus plus maintained Vanilla.
- Initial branch shape: the branch is one commit on `be2bbd084` and the merge-base payload touches 64 files across both maintained roots. No gameplay source edits planned; this is a docs/wiki mirror branch-intel lane.
- Findings: `be2bbd084..e83de9c4` is 64 maintained-root files / +700 / -688 and `git diff --check` clean. In source Chernarus plus maintained Vanilla, Barracks metadata expands from three to four levels in `Core_Upgrades/Upgrades_CO_US.sqf:33,61,89,125`, and the AI order table gains `[WFBE_UP_GEAR,4]` at `:185`.
- Findings: representative infantry required-level rows shift in both maintained roots: `Core_US.sqf:21,24,27,33,48,81` and `Core_RU.sqf:18,21,24,30,45,60`. `Common_CreateUnit.sqf:101` adds a `US_Soldier_AT_EP1` MAAWS HEAT replacement after spawn.
- Branch note: current stable `origin/master@f8a76de34` keeps the older three-level Barracks metadata and lacks the HEAT swap. Direct current-stable diffs also include B74.1 `Init_CommonConstants.sqf` player-stats drift from the older branch base, so any port must preserve `WFBE_C_STATS_ENABLED = true`.
- Result: refreshed [Upgrades and research](Upgrades-And-Research-Atlas#current-branch-scope), [Factory and purchase systems](Factory-And-Purchase-Systems-Atlas#current-branch-scope), Feature Status, Testing workflow branch-only smoke pack, release-readiness gates, dashboard, pruning ledger and machine rows. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T10:56:24+02:00 - Codex - Navigation inventory live-count refresh

- Claimed `navigation-inventory-live-count-refresh-2026-06-23` after startup checks found the active `C:\Users\Steff\a2wasp-wiki` checkout dirty and behind the live wiki, while `C:\Users\Steff\a2waspwarfare-docs\docs\wiki` was also dirty and much older; the batch was later rebased over live wiki `origin/master@d2bad96`.
- Source scope: fresh clean wiki checkout at `C:\Users\Steff\Documents\Codex\2026-06-23\here-s-a-paste-ready-goal-2\work\a2wasp-wiki-live`, plus local mirror git status checks. No gameplay source edits planned or made.
- Findings: rebased live wiki has 275 Markdown files / 273 content pages; `_Sidebar.md` now has 242 local link refs / 242 unique targets after dedupe, with 240 content pages linked and 33 content pages outside sidebar. `_Footer.md` has 58 unique targets after the footer prune; Home has 183 unique local targets. Broad local Markdown link pass found 0 missing wiki/file targets.
- Cleanup: added missing `Continue Reading` blocks to [AI commander B69 improvement roadmap](AI-Commander-B69-Improvement-Roadmap) and [AI commander B69 implementation sketches](AI-Commander-B69-Implementation-Sketches), bringing live content pages back to 0 missing blocks. Removed duplicate content/reference sidebar refs for [Player vehicle/travel actions](Player-Vehicle-And-Travel-Actions-Reference) and [QoL trio player hints](QoL-Trio-Player-Hints-Reference), keeping the UI/player workflow refs.
- Result: refreshed [Navigation inventory](Navigation-Inventory-And-Page-Status), [Progress dashboard](Progress-Dashboard), [Wiki pruning ledger](Wiki-Pruning-And-Relevance-Ledger), `llms.txt`, `agent-context.json`, `agent-status.json`, `agent-collaboration.json` and event/knowledge streams with live counts and mirror-divergence status. Mirror sync remains preservation-first follow-up; do not overwrite dirty local mirrors.
- Validation: JSON/JSONL parse passed, Markdown links resolved, broad local link scan found 0 broken local links, missing `Continue Reading` count is 0, and `git diff --check` reported LF/CRLF warnings only. Strict repo `ValidateWiki.ps1 -WikiPath <live checkout>` then failed in the machine-reference phase on pre-existing `agent-hardening-backlog.jsonl` anchor/blank `wikiRefs`; this batch did not touch that backlog file.

## 2026-06-23T11:32:00+02:00 - Codex - Upstream mining ledger navigation wire

- Claimed `upstream-mining-ledger-navigation-wire-2026-06-23` after Claude left an open Codex-owned navigation request in [Coordination board](Coordination-Board): link the new [Upstream mining ledger](Upstream-Mining-Ledger) from `_Sidebar`, `Home` and `agent-context.json`.
- Evidence scope: `docs/wiki/Upstream-Mining-Ledger.md` exists and records the 2026-06-23 upstream-mining loop; search currently finds no `Home.md`, `_Sidebar.md` or `agent-context.json` route to `Upstream-Mining-Ledger`.
- Planned edits are documentation/navigation only: wire the page into upstream/community routes, close the board handoff, mirror touched files into the GitHub wiki checkout, validate JSON/JSONL and run the wiki validator. No gameplay source edits planned.
- Result: linked [Upstream mining ledger](Upstream-Mining-Ledger) from [Home](Home), `_Sidebar.md`, `llms.txt`, `mkdocs.yml` and `agent-context.json`, then marked the Coordination Board request done. The page remains a batch-level audit trail; branch-specific behavior still routes through owner pages and Feature Status.
- Validation: final validation is recorded in the matching `complete` event. No gameplay source changed.

## 2026-06-23T11:50:48+02:00 - Codex - Hardening backlog wikiRefs validator cleanup

- Claimed `hardening-backlog-wikirefs-validator-cleanup-2026-06-23` as a docs-only follow-up to make the strict wiki validator pass after the navigation batch exposed legacy `agent-hardening-backlog.jsonl` machine-reference failures.
- Scope: normalized only machine/documentation references in `agent-hardening-backlog.jsonl`, plus guardrail wording in [Arma 2 OA compatibility audit](Arma-2-OA-Compatibility-Audit) and [Arma 2 OA external reference guide](Arma-2-OA-External-Reference-Guide). No gameplay source edits planned or made.
- Result: stripped section anchors from backlog `wikiRefs`, removed the nonexistent `Agent-Hardening-Backlog` page ref, added missing `wikiRefs` from existing `canonicalDocs`, `wiki` or `evidence` fields, and gave intentional modern/A3-only compatibility terms same-line guardrail wording for the validator.
- Validation: `ValidateWiki.ps1 -WikiPath C:\Users\Steff\Documents\Codex\2026-06-23\here-s-a-paste-ready-goal-2\work\a2wasp-wiki-live -SkipGitDiffCheck` now passes JSON/JSONL parsing, page-list parity, Markdown links, machine references, exact machine references, retired route scan, stale patched wording scan and Arma 2 OA compatibility guardrail scan. `git diff --check` reports LF/CRLF warnings only.

## 2026-06-23T12:40:00+02:00 - Claude - Upstream-mining Pass 4: deep backlog + 10 grouped draft PRs

- Drained the backlog Passes 1-3 parked. Completed Ray's a/b/c asks: deep-verified the ~34 deferred small codeable wins from Pass 3, re-examined the needs-design cards (Warfare a + c), and triaged the ~220-card Tier-2 long tail (the `Could` (149) + `Backlog` (71) lists). The verified, genuinely-ready wins were built into 10 more grouped draft PRs.
- 10 new draft PRs (all DRAFT / human-merge-gated, OA 1.64 engine smoke pending): [#66](https://github.com/rayswaynl/a2waspwarfare/pull/66) bypass anti-TK satchel & building scripts in debug mode (cards #2,#3); [#67](https://github.com/rayswaynl/a2waspwarfare/pull/67) audio cues paradrop-drop + IR-smoke-ready (#90,#91); [#68](https://github.com/rayswaynl/a2waspwarfare/pull/68) base-integrity bugfixes airlift drop-on-HQ + nuke vs in-progress construction (#87,#97); [#69](https://github.com/rayswaynl/a2waspwarfare/pull/69) fix gear/ammo display for special AT soldier units in buy menu; [#70](https://github.com/rayswaynl/a2waspwarfare/pull/70) EASA aircraft loadout role categories AA/AG/multirole, completed half-wired code (#59); [#71](https://github.com/rayswaynl/a2waspwarfare/pull/71) higher bounty for killing players on a killstreak (server-authoritative, tunable coefs); [#72](https://github.com/rayswaynl/a2waspwarfare/pull/72) restrict building static defenses near base when enemies near, anti tank-trap (#104, tunable consts); [#73](https://github.com/rayswaynl/a2waspwarfare/pull/73) one-click crew-all-artillery button (#113); [#74](https://github.com/rayswaynl/a2waspwarfare/pull/74) show player artillery cooldown on the RHUD (#219); [#75](https://github.com/rayswaynl/a2waspwarfare/pull/75) clearer info text upgrade result value + new-HQ cost in transfer menu (#107,#204).
- Known caveat (PR #68): flagged a PRE-EXISTING Takistan bug -- `Zeta_Hook.sqf` calls `Zeta_Unhook` without the `[_vehicle]` args array that the Chernarus B66 fix added; the airlift fix depends on that arg, so on Takistan it needs the args folding-in or a separate fix.
- ~37 needs-design items (no PR -- owner/vote/art decisions), catalogued in the mining artifacts; notable: #105 paratroop kill reward fix, #26 first-blood bonus, #27 OPFOR Hind re-tier, #29 town-depot supply trucks @10x, #41 radiation damages factories, #63 captured-town vehicle reward, #64 redeployment barracks-on-wheels truck, #215 sell-vehicles feature, #120 anti-illegal-loadout sanitiser, #35 static-count-by-barracks-level.
- Deferred/skip backlog: remaining lower-value Tier-2 cards + the big `Could`/`Backlog` long tail are recorded but not actioned. Small flagged bug: `Core_MVD.sqf` `[Done]` log mislabels itself "Core_RU".
- Cross-pass total: 22 draft PRs open (#54-#75), all DRAFT / human-merge-gated. The initial 3-source sweep (upstream branches + Trello Tier-1 + Tier-2) is complete; the loop is now delta-only. Updated only [Upstream mining ledger](Upstream-Mining-Ledger) (appended a new `## Pass 4 - deep backlog` section; earlier passes untouched). Nav files (`_Sidebar.md`/`_Footer.md`/`Home.md`) are Codex lane and were not touched. No gameplay source changed in this docs pass; the code lives on the 10 draft branches behind #66-#75.

## 2026-06-23T12:10:03+02:00 - Codex - Trello base integrity branch intel

- Claimed `trello-base-integrity-branch-intel-2026-06-23` after `origin/claude/trello-base-integrity-fixes@66d80160` appeared on current stable merge-base `origin/master@f8a76de34`.
- Planned source scope: compare the branch against `f8a76de34`, inspect source Chernarus plus maintained Vanilla ZetaCargo and Nuke damage files, and preserve the split between current-stable behavior and branch-only candidates. No gameplay source edits planned.
- Initial branch shape: two commits (`0ae5edb2d` Trello #87 ZetaCargo, `66d80160c` Trello #97 Nuke), six maintained-root files, +70/-10, and `git diff --check f8a76de34..origin/claude/trello-base-integrity-fixes` is clean.
- Early finding: source Chernarus current stable already passes `[_vehicle]` to `Zeta_Unhook.sqf` at `Zeta_Hook.sqf:34-35`, but maintained Vanilla current stable still adds the detach action without arguments at `Zeta_Hook.sqf:34`; the Trello branch does not fix that Vanilla argument gap.
- Early finding: #87 adds friendly-HQ lift exclusion at branch `Zeta_Hook.sqf:17-19` and ground/drop-away-from-HQ placement at `Zeta_Unhook.sqf:12-29`; #97 adds deletion of in-progress `LocationLogicStart` build logics with `WFBE_B_Type` at branch `Client/Module/Nuke/damage.sqf:33-42`.
- Result: refreshed [Zeta Cargo sling-load](Zeta-Cargo-Sling-Load-Reference#branch-intel---trello-base-integrity-candidate), [Support specials](Support-Specials-And-Tactical-Modules-Atlas), [ICBM authority](ICBM-Authority-Playbook#branch-intel---trello-97-in-progress-construction), [Construction and CoIn systems](Construction-And-CoIn-Systems-Atlas#current-branch-scope), Feature Status, Testing workflow branch-only smoke pack, release-readiness gates, dashboard, pruning ledger and machine rows. No gameplay source changed.
- Validation: JSON/JSONL parse passed in wiki and docs/wiki; `docs/validate-wiki.ps1` passed with known legacy JSONL envelope warnings only; touched-file wiki/docs parity passed across 15 files; Latest Batch has five rows; conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T12:12:42+02:00 - Codex - Trello artillery UI branch intel

- Claimed `trello-artillery-ui-branch-intel-2026-06-23` after a fresh fetch exposed small Trello branch candidates `origin/claude/trello-arty-cooldown-hud@471fc0580fd6` and `origin/claude/trello-arty-to-gunner@2dc3e7403399`.
- Planned source scope: compare both branches against current stable `origin/master@f8a76de34` and their merge bases, then inspect source Chernarus plus maintained Vanilla HUD/title/tactical-dialog/stringtable paths before any owner-page edits.
- Planned result: route exact branch-only evidence through the existing support-specials, client-UI, Feature Status, testing workflow and release-readiness gates. No gameplay source edits planned.
- Findings: both branches merge-base directly on current stable `origin/master@f8a76de34`; no older-base drift was found. `origin/claude/trello-arty-cooldown-hud@471fc0580fd6` is four maintained-root files / +134 / -8 and adds RHUD artillery cooldown controls at `Client_UpdateRHUD.sqf:27,259-288,452` plus `Rsc/Titles.hpp:177,478-490`. `origin/claude/trello-arty-to-gunner@2dc3e7403399` is six maintained-root files / +217 / -8 and adds Tactical `MenuAction == 50`, button idc `17040` and strings at `GUI_Menu_Tactical.sqf:571-626`, `Rsc/Dialogs.hpp:2364-2371` and `stringtable.xml:3192-3213`. Both branch payloads pass `git diff --check`; current stable lacks the new RHUD row, crew action and crew-artillery string keys.
...
- Validation: `docs\validate-wiki.ps1 -WikiPath <wiki checkout>` passed with known legacy JSONL envelope warnings only; JSON/JSONL parse passed in docs/wiki and wiki checkout; touched-file SHA parity passed across 13 files; Progress Dashboard Latest Batch has five rows; line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T12:45:43+02:00 - Codex - Trello upgrade/HQ cost info branch intel

- Claimed `trello-upgrade-hqcost-info-branch-intel-2026-06-23` after a fresh fetch confirmed `origin/claude/trello-upgrade-hqcost-info@34fd202c8865` / draft PR #75 is not yet routed beyond the upstream-mining ledger/worklog note.
- Initial branch shape: merge-base with current stable `origin/master` is `f8a76de349da`; payload versus current stable is six maintained-root files / +96 and `git diff --check` is clean.
- Planned source scope: inspect source Chernarus plus maintained Vanilla `Client/Functions/Client_FNC_Special.sqf`, `Client/GUI/GUI_TransferMenu.sqf` and `stringtable.xml`, compare current-stable absence/presence, then route exact branch-only evidence through existing UI/economy/commander owner pages, Feature Status, Testing workflow and release-readiness gates. No gameplay source edits planned.
- Findings: branch `Client_FNC_Special.sqf:204,212-223` in both maintained roots keeps the generic upgrade-complete chat and adds scalar value lines only for `WFBE_UP_ARTYTIMEOUT` and `WFBE_UP_RESPAWNRANGE`; branch `GUI_TransferMenu.sqf:124-129` appends a New HQ cost line from `WFBE_C_STRUCTURES_HQ_COST_DEPLOY`; branch `stringtable.xml:459-473,1055-1061` adds the required keys.
- Current-stable comparison: `origin/master@f8a76de34` already has the upgrade IDs, artillery interval arrays, respawn range arrays and HQ deploy-cost constant/parameter in source Chernarus plus maintained Vanilla, but has only the generic upgrade-complete message and transfer footer lines. No branch value-message or New HQ cost string keys exist on current stable.
- Result: refreshed [Client UI systems](Client-UI-Systems-Atlas#current-branch-scope), [Upgrades and research](Upgrades-And-Research-Atlas#current-branch-scope), [Commander/HQ lifecycle](Commander-HQ-Lifecycle-Atlas#current-branch-scope), Feature Status, Testing workflow branch-only smoke pack, release-readiness gates, dashboard, pruning ledger and machine rows. No gameplay source changed.
- Validation: `docs\validate-wiki.ps1 -WikiPath <wiki checkout>` passed with known legacy JSONL envelope warnings only; JSON/JSONL parse passed in docs/wiki and wiki checkout; touched-file SHA parity passed across 14 files; line-start conflict-marker scan passed. Final `git diff --check` is recorded in the matching complete event.

## 2026-06-23T13:30:00+02:00 - Claude - Upstream-mining Pass 5: deferred Tier-2 tail (closeout)

- Finished the 42 deferred Tier-2 candidates -- the ones triaged codeable+missing but capped out of Pass 4's deep-verify. Deep-verified all 42 against `origin/master` source -> 7 ready -> 4 grouped draft PRs.
- 4 new draft PRs (all DRAFT / human-merge-gated, OA 1.64 engine smoke pending): [#76](https://github.com/rayswaynl/a2waspwarfare/pull/76) auto-deploy bipod when going prone with a bipod MG (card #210); [#77](https://github.com/rayswaynl/a2waspwarfare/pull/77) show upgrade icons in the upgrade menu (card #164); [#78](https://github.com/rayswaynl/a2waspwarfare/pull/78) map radius circles HQ build area + ambulance redeploy range (cards #80,#76); [#79](https://github.com/rayswaynl/a2waspwarfare/pull/79) artillery UX -- per-type range in menu, gun count in the "artillery called" message, and fix arty marker leaking when the caller disconnects mid-barrage (cards #115,#116,#171).
- 22 needs-design items (no PR -- owner/vote/art decisions), catalogued in the mining artifacts; notable: #216 Federal Reserve passive-income endgame building, #143 ICBM impact countdown for both teams, #178 automatic minefield markers, #174 more-frequent house-wreck cleanup (perf), #165 LoadoutManager data-driven missile-list refactor.
- Coverage confirmation -- the surface is now exhausted: Miksuu GitHub Issues = 0 (the community uses Trello, not Issues); only 1 fork of the repo (ours), so no hidden contributor forks; the only un-swept Trello surface is low-yield -- `Low Priority (Won't)` (53 cards) + 202 archived cards, both below the worth-doing bar.
- FINAL cross-pass total: 26 draft PRs open (#54-#79), all DRAFT / human-merge-gated. The full mineable surface (490 upstream branches + Trello Tier-1 + Tier-2 incl. the deferred tail) is now EXHAUSTED; the loop is delta-only from here. Updated only [Upstream mining ledger](Upstream-Mining-Ledger) (appended a new `## Pass 5 - deferred Tier-2 tail (closeout)` section before Continue Reading; earlier passes untouched). Nav files (`_Sidebar.md`/`_Footer.md`/`Home.md`) are Codex lane and were not touched. No gameplay source changed in this docs pass; the code lives on the 4 draft branches behind #76-#79.

## 2026-06-23T12:47:45+02:00 - Codex - Trello audio cues branch intel

- Claimed `trello-audio-cues-branch-intel-2026-06-23` after current fetch showed `origin/claude/trello-audio-cues@a0e4fb458` on current stable merge-base `origin/master@f8a76de34`.
- Planned source scope: compare the branch against `f8a76de34`, inspect source Chernarus plus maintained Vanilla paratrooper marker and IR smoke missile-handler files, then route branch-only evidence through support/modules/audio, Feature Status, smoke and release-readiness docs. No gameplay source edits planned.
- Branch shape: one commit `a0e4fb458`, four maintained-root files / +74 / -2, and `git diff --check f8a76de34..origin/claude/trello-audio-cues` is clean.
- Findings: Trello #90 adds a friendly-client paratrooper cue at branch `HandleParatrooperMarkerCreation.sqf:42-61`: it preserves the side gate at `:17-18`, throttles `commanderNotification` through `WFBE_C_LastParatroopSound`, creates local `paraDZ_<time>` marker text `Paradrop`, and deletes the local marker after 30 seconds.
- Findings: Trello #91 adds an IR-smoke ready cue at branch `IRS_OnIncomingMissile.sqf:51-61`: it sleeps `WFBE_IRS_FLARE_DELAY`, then plays `ARTY_cooldown_over` only if the vehicle is alive, the player is still crew, flares remain and `wfbe_irs_disabled` is false/default.
- Sound/resource note: source Chernarus plus maintained Vanilla already define `ARTY_cooldown_over` at `Sounds/description.ext:18-20` and `commanderNotification` at `:84-86`, so the branch adds no new media. The new local marker text is hardcoded English `Paradrop`.
- Result: refreshed [Support specials](Support-Specials-And-Tactical-Modules-Atlas#trello-audio-cue-branch-intel), [Modules / IRS](Modules-Atlas#irs--ir-smoke-missile-countermeasure-commonmoduleirs), [Assets/config/localization](Assets-Config-Localization-And-Parameters-Atlas#current-branch-scope), Feature Status, Testing workflow branch-only smoke pack, release-readiness gates, dashboard, pruning ledger and machine rows. The branch is documented as player feedback only, not support authority, reward logic or IR-smoke toggle closure. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T13:17:30+02:00 - Codex - Trello auto-bipod branch intel

- Claimed `trello-auto-bipod-branch-intel-2026-06-23` after current fetch showed `origin/claude/trello-auto-bipod@5af02b8438e1`, draft PR #76 / Trello #210, on current stable merge-base `origin/master@f8a76de34`.
- Initial branch shape: one commit (`5af02b843`), four maintained-root files / +46 / -2, and `git diff --check origin/master..origin/claude/trello-auto-bipod` is clean.
- Planned source scope: inspect source Chernarus plus maintained Vanilla `Common/Functions/Common_Bipod.sqf` and `Client/Functions/Client_OnKilled.sqf`, compare current-stable absence/presence, then route exact branch-only evidence through the deployable bipod owner page, Feature Status, branch-only smoke/release gates and machine records. No gameplay source edits planned.
- Findings: branch `Common_Bipod.sqf:74-82` in both maintained roots adds `Bipod_AddAutoDeploy`, cleans up any previous local `Bipod_AutoEH`, attaches `AnimChanged`, and calls the existing `15 call Bipod_ON` path when the prone animation is `amovppnemstpsraswrfldnon`; `Client_OnKilled.sqf:90` reattaches the helper after death/respawn if it has loaded.
...
## 2026-06-23T13:06:09+02:00 - Codex - Trello map radius circles branch intel

- Claimed `trello-map-radius-circles-branch-intel-2026-06-23` after a fresh fetch exposed `origin/claude/trello-map-radius-circles@77dd71ba3` / draft PR #78.
- Initial branch shape: merge-base with current stable `origin/master` is `f8a76de349da`; payload is six maintained-root files / +192 / -4 across source Chernarus plus maintained Vanilla Takistan `Client_AmbulanceRedeployCircles.sqf`, `Init_BaseStructure.sqf` and `Init_Client.sqf`. `git diff --check f8a76de34..77dd71ba303f` is clean. No gameplay source edits planned.
- Planned source scope: compare branch against current stable, inspect HQ build-area and ambulance/redeploy map circle creation/removal in both maintained roots, then route exact branch-only evidence through existing UI, Commander/HQ, construction, respawn/medic pages, Feature Status, Testing workflow and release-readiness gates.
- Result: routed the branch as **branch-only local map-marker/map-indicator work, not current stable behavior**.
- HQ evidence: branch `Init_BaseStructure.sqf` creates a local `HQBuildRange*` border ellipse using `WFBE_C_BASE_AREA_RANGE + WFBE_C_BASE_HQ_BUILD_RANGE` at Chernarus `:54-68` / Vanilla `:35-49`, then deletes it with the CC marker at Chernarus `:151-158` / Vanilla `:132-139`. Current stable only has `CCrange*` and the underlying placement constants/validation paths.
- Mobile-respawn evidence: branch `Init_Client.sqf:1227` launches `Client_AmbulanceRedeployCircles.sqf`; the watcher gates on `WFBE_C_RESPAWN_MOBILE`, combines own-side ambulance plus redeploy-truck class lists, sizes yellow local ellipses from `WFBE_C_RESPAWN_RANGES` / `WFBE_UP_RESPAWNRANGE` and updates/deletes them every five seconds (`Client_AmbulanceRedeployCircles.sqf:1-69`). Current stable has no `Client_AmbulanceRedeployCircles`, `HQBuildRange` or `AmbRange_` hits.
- Important caveat preserved: the watcher copies radius/class visibility, not full respawn-menu eligibility. Current stable `Client_GetRespawnAvailable.sqf:33-45,54-81` still owns ambulance free-cargo and redeploy-truck Medic-only, parked/engine-off, free-cargo and 500m enemy-town gates, so promotion needs mismatch smoke.
- Current-stable comparison: `origin/master@f8a76de34` already has the base-radius constants and validation path (`Common_GetClosestEntity2.sqf:14`, `Construction_HQSite.sqf:49`, `basearea.sqf:3-13`) and mobile-respawn constants/lists (`Client_GetRespawnAvailable.sqf:33-57`, Chernarus `Init_CommonConstants.sqf:674,678`, Vanilla `:476,:480`), but has no maintained-root `Client_AmbulanceRedeployCircles`, `AmbRange_` or `HQBuildRange` symbols.
- Result: refreshed [Client UI systems](Client-UI-Systems-Atlas#current-branch-scope), [Commander/HQ lifecycle](Commander-HQ-Lifecycle-Atlas#current-branch-scope), [Construction and CoIn systems](Construction-And-CoIn-Systems-Atlas#current-branch-scope), [Respawn and death lifecycle](Respawn-And-Death-Lifecycle-Atlas#branch-intel---mobile-respawn-map-circles), [Medic redeployment truck](Medic-Redeployment-Truck-Forward-Spawn#branch-intel---map-radius-circle-candidate), Feature Status, Testing workflow branch-only smoke pack, release-readiness gates, dashboard, pruning ledger and machine rows. No gameplay source changed.
- Validation: final validation is recorded in the matching `complete` event.

## 2026-06-23T13:57:20+02:00 - Codex - Trello artillery UX branch intel

- Claimed `trello-artillery-ux-branch-intel-2026-06-23` after current coordination reads showed PR #75-#78 routed and a fresh branch check found `origin/claude/trello-artillery-ux@c4459d4312ef` / draft PR #79 still only present in upstream-mining ledger notes.
- Initial branch shape: merge-base with current stable `origin/master` is `f8a76de349da`; payload versus current stable is eight maintained-root files / +100 / -20 across source Chernarus plus maintained Vanilla `Client_RequestFireMission.sqf`, `GUI_Menu_Tactical.sqf`, `Server_HandleSpecial.sqf` and `stringtable.xml`. `git diff --check origin/master..origin/claude/trello-artillery-ux` is clean.
- Planned source scope: inspect per-type artillery range display in Tactical menu, gun-count fire-message behavior and marker cleanup when the caller disconnects or leaves during a barrage, then route exact branch-only evidence through Support specials, Client UI, Feature Status, Testing workflow, release-readiness gates and machine records. No gameplay source edits planned.
- Findings: branch `GUI_Menu_Tactical.sqf:42-57` in both maintained roots appends effective min/max range text to artillery rows using the existing display-name, range-min/max and `WFBE_C_ARTILLERY` data. Current stable only adds raw display names at `GUI_Menu_Tactical.sqf:42`.
- Findings: branch `Client_RequestFireMission.sqf:31-38,58-60` keeps global `WF_createMarker` creation, replaces caller-local marker deletion with `RequestSpecial ["ArtyMarkerCleanup", ...]`, and passes `_gunCount` as `%3` to the localized team warning. Current stable deletes these markers through caller-local `Client_Delete_Marker.sqf:24` and formats the warning with only player/ammo at `Client_RequestFireMission.sqf:53`.
...
## 2026-06-23T14:34:58+02:00 - Codex - Attack-wave authority current B74.1 refresh

- Claimed `attack-wave-authority-current-b741-refresh-2026-06-23` after coordination reads showed direct attack-wave authority rows still citing previous current stable `origin/master@0139a346` while current stable/B74.1 is `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`.
- Planned source scope: inspect `ATTACK_WAVE_INIT`, `ATTACK_WAVE_DETAILS`, unit-cost modifiers, attack-wave server handlers and BattlEye filter coverage across source Chernarus plus maintained Vanilla Takistan for docs/source, current stable/B74.1, B69, B74, current Miksuu, perf/quick-wins and relevant historical refs.
- Planned docs output: refresh the attack-wave authority playbook, Feature Status row, Source Fix queue row, PV channel/server authority routes and machine rows with exact refs/line anchors, then mirror touched files into `docs/wiki`. No gameplay source edits planned.
- Findings: current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` still keeps `Common_AttackWaveActivate.sqf:6,8`, `Server_AttackWave.sqf:5-6,15,23,27,36,38` and `AttackWave.sqf:19,23-25,40` trust in both maintained roots; scoped deltas from previous current stable and adjacent B74 touch only constants.
- Findings: current stable/B74.1 buy-price anchors are `Client_UIFillListBuyUnits.sqf:90` and `GUI_Menu_BuyUnits.sqf:99,244-245,416`; constants are Chernarus `Init_CommonConstants.sqf:547,591-593` and maintained Vanilla `:349,393-395`; repo-root `BattlEyeFilter/publicvariable.txt:2` still only filters `kickAFK`.
- Result: refreshed DR-41 attack-wave direct-PV evidence for current stable/B74.1 in the playbook, Feature Status, Source Fix queue, Public Variable index, Server authority map, `agent-feature-status.jsonl`, `agent-hardening-backlog.jsonl` and `agent-knowledge.jsonl`; mirrored touched files into `docs/wiki`. No gameplay source changed.
- Validation: `docs\validate-wiki.ps1 -WikiPath <wiki checkout>` passed with known legacy JSONL envelope warnings only; JSON/JSONL parse passed in both wiki checkout and `docs/wiki`; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T14:40:05+02:00 - Codex - Commander reassignment current B74.1 refresh

- Claimed `commander-reassignment-current-b741-refresh-2026-06-23` to remove stale current-stable `origin/master@0139a346` wording from the commander vote/reassignment route after the local repo fetched current stable `origin/master@f8a76de34`, equal to `origin/claude/b74.1-aicom@f8a76de34`.
- Source scope: checked source Chernarus plus maintained Vanilla `Server_VoteForCommander.sqf`, `GUI_VoteMenu.sqf`, `RequestNewCommander.sqf`, `Server_AssignNewCommander.sqf` and `GUI_Commander_VoteMenu.sqf`; scoped diff `0139a3468609..origin/master` returned no maintained-root path changes.
- Findings: current stable/B74.1 still has DR-47 vote comparison source-present at `Server_VoteForCommander.sqf:18,26-27,43` and DR-15 helper unpacking source-present at `Server_AssignNewCommander.sqf:4-5`; `RequestNewCommander.sqf:14` and helper `:10` still both send `new-commander-assigned`, and `GUI_Commander_VoteMenu.sqf:33-46` still resolves by visible leader-name text despite stored row values at `:9,:13,:53,:63`.
- Boundary: docs/source `HEAD@60c35c05` still carries the old helper `_side = _this`, and current stable/B74.1 full modded Napf/Eden/Lingor helper copies still carry the old shape at `Modded_Missions/*/Server/Functions/Server_AssignNewCommander.sqf:3`; no gameplay source changed.
- Result: refreshed [Commander reassignment call shape](Commander-Reassignment-Call-Shape), [Commander vote/reassignment](Commander-Vote-And-Reassignment-Playbook), [Feature status](Feature-Status-Register), [Server authority migration](Server-Authority-Migration-Map), release-readiness and machine records with current-B74.1 branch truth. Future code work should not reopen helper unpacking on current stable/B74.1/B69/B74 maintained roots; it should choose one notification owner, use row-value/team identity, and keep requester authority separate.

## 2026-06-23T15:12:00+02:00 - Codex - AI supply-truck current B74.1 refresh

- Claimed `ai-supply-truck-current-b741-refresh-2026-06-23` after the AI supply-truck rows still cited current stable `origin/master@0139a346` and old safe-disable anchors.
- Source scope: checked source Chernarus plus maintained Vanilla `Server/Init/Init_Server.sqf`, `Server/AI/AI_UpdateSupplyTruck.sqf` and absent `Server/FSM/supplytruck.fsm` across docs/source `HEAD@6d4b514c12fc`, current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`, B74.2 `origin/claude/b74.2-aicom@d472da6a`, B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, Miksuu `b8389e748243`, perf `0076040f`, historical `a96fdda2` and historical `c20ce153`.
- Findings: docs/source and Miksuu still raw-spawn the commented worker at `Init_Server.sqf:36,382-383` in both maintained roots; perf also raw-spawns, with Chernarus line drift at `:36,377-378` and Vanilla at `:36,382-383`.
- Findings: current stable/B74.1 safe-disables instead: Chernarus comments the compile at `Init_Server.sqf:44` and initializes/log-disables at `:624-625`; maintained Vanilla uses `:44,618-619`. B74.2 keeps the same caller shape. B69/B74 also keep safe-disable caller shapes, and no checked ref restores `Server\FSM\supplytruck.fsm`.
- Adjacent cleanup: refreshed the same page's current-stable AICOM supervisor anchors after B74.1 line drift (`WFBE_SE_FNC_AI_Commander` compile/spawn and `AI_Commander.sqf` latch/upgrade-worker refs) so the supply-truck matrix no longer sits under stale current-stable supervisor wording.
- Result: refreshed [AI commander autonomy audit](AI-Commander-Autonomy-Audit#ai-supply-truck-branch-matrix), [Abandoned feature revival review](Abandoned-Feature-Revival-Review#ai-commander-supply-trucks), Feature Status, Source Fix queue, Dead/stale code register, dashboard, pruning ledger and machine rows. No gameplay source changed.

## 2026-06-23T14:53:33+02:00 - Codex - B74.2 AI commander branch intel

- Claimed `b742-aicom-branch-intel-2026-06-23` after current fetch showed `origin/claude/b74.2-aicom@d472da6ae` advanced over current stable `origin/master@f8a76de34`.
- Initial branch shape: four commits (`a73922b37`, `291e07f91`, `76ee7ce88`, `d472da6ae`) over current stable, touching 26 source Chernarus files / +324 / -24 across AI commander, town/camp/server loops, construction sites, UI/markers, squad configs and `Init_NavalHVT.sqf`; no `Missions_Vanilla` payload is present.
- Planned source scope: inspect the branch payload against current stable, verify current-stable absence/presence and route exact branch-only evidence through AI commander, Client UI/markers, Towns/camps, Construction, Support/Naval and promotion-gate pages. No gameplay source edits planned.
- Findings: no PR route was found for `claude/b74.2-aicom`; merge-base/current stable is `origin/master@f8a76de34`. The branch adds `WFBE_PopTier` publishing and tiered AICOM/player/town/defender/patrol caps, marker-feed replay via `WFBE_ReqAicomFeed`, camp anti-stall with `WFBE_C_AICOM_CAMP_STALL_PASSES = 3`, camp range 11.5, carrier HVT airfield/respawn hooks, source Chernarus stats fast-follow writers, small AA squad trims and `WFBE_C_VEHICLE_TINTS = 0`.
- Routed the evidence through [AI commander autonomy](AI-Commander-Autonomy-Audit#b69-roadmap-and-sketch-route), [AI capture plan](AI-Commander-Capture-And-Fun-Improvement-Plan), [Client UI systems](Client-UI-Systems-Atlas#current-branch-scope), [Towns/camps](Towns-Camps-And-Capture-Atlas#current-branch-scope), [Player stats branch audit](Player-Stats-Branch-Audit#current-status), [Feature status](Feature-Status-Register), [Testing workflow](Testing-Debugging-And-Release-Workflow#branch-only-feature-smoke-pack), the pruning ledger and release-readiness/machine rows.
- Handoff: keep B74.2 branch-only until smoke covers AICOM pop-tier publishing/consumers, team founding/side-AI caps, RHUD/Buy Units cap display, AICOM feed replay/JIP, camp anti-stall, tiered active towns/defenders/patrols, carrier air-shop/respawn, stat writers, tint defaults and the maintained Vanilla/Takistan scope decision.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs\validate-wiki.ps1 -WikiPath <wiki checkout>` passed with known legacy JSONL envelope warnings only; `git diff --check` passed in both worktrees with LF/CRLF warnings only; strict line-start conflict-marker scan passed; touched-file wiki/docs parity passed before appending the completion event.

## 2026-06-23T15:34:00+02:00 - Codex - Upgrade-sync current B74.1/B74.2 refresh

- Claimed `upgrade-sync-current-b741-b742-refresh-2026-06-23` after the `RequestSpecial` `upgrade-sync` rows still cited stale current-stable `origin/master@0139a346` / current-B74 wording.
- Source scope: checked maintained-root `Client/GUI/GUI_UpgradeMenu.sqf`, `Server/Functions/Server_HandleSpecial.sqf` and `Server/Functions/Server_ProcessUpgrade.sqf` across docs/source `HEAD@a7f383b6`, current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`, visible B74.2 `origin/claude/b74.2-aicom@d472da6a`, B69, B74, Miksuu `b8389e748243`, perf `0076040f` and historical `a96fdda2`.
- Findings: docs/source keeps the mixed parser at `Server_HandleSpecial.sqf:3,67-73`, caller `GUI_UpgradeMenu.sqf:171` and sync lifecycle `Server_ProcessUpgrade.sqf:26,29,35`; no `wfbe_upgrading_end_time` hits are present.
- Findings: current stable/B74.1 and B74.2 still mix `_args` and `_this`. Source Chernarus uses `Server_HandleSpecial.sqf:3,77,79-83`; maintained Vanilla uses `:3,67,69-73`; both call from `GUI_UpgradeMenu.sqf:292`. `Server_ProcessUpgrade.sqf:32,35,41` keeps the sync lifecycle while `:27,:55` now publishes/clears server upgrade end time.
- Diff result: `origin/master..origin/claude/b74.2-aicom` and `origin/claude/b69..origin/claude/b74-aicom-spend` are empty for the checked handler/caller/process files. B74.1 end-time work is adjacent timer/UI state, not parser cleanup. Miksuu/perf still call from `GUI_UpgradeMenu.sqf:241`; historical release `a96fdda2` calls from `:254`.
- Result: refreshed [Support specials](Support-Specials-And-Tactical-Modules-Atlas#upgrade-sync-branch-matrix), [Upgrades and research](Upgrades-And-Research-Atlas#current-branch-scope), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows. No gameplay source changed.

## 2026-06-23T15:44:55+02:00 - Codex - Visible parameter current B74.1/B74.2 refresh

- Claimed `visible-parameter-current-b741-b742-refresh-2026-06-23` after the visible mission-parameter rows still cited previous current stable `origin/master@0139a346` for `WFBE_C_AI_MAX` and `WFBE_C_UNITS_CLEAN_TIMEOUT`.
- Source scope: check source Chernarus plus maintained Vanilla parameter definitions/readers for docs/source `HEAD@0da6ba431`, current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`, B74.2 `origin/claude/b74.2-aicom@d472da6a`, B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, Miksuu `b8389e748243`, perf `0076040f` and historical `a96fdda2`.
- Planned output: refresh [Mission parameters](Mission-Parameters-Localization-And-Generated-Build-Inputs), Feature Status, Source Fix queue, Dead/stale code register, dashboard, pruning ledger and machine rows with exact branch scope. No gameplay source edits planned.
- Findings: docs/source `HEAD@0da6ba431`, current Miksuu and perf still expose/default `WFBE_C_AI_MAX` but have no maintained-root `AI_Commander_Produce.sqf` reader, and `WFBE_C_UNITS_CLEAN_TIMEOUT` remains comment-only at `Common_TrashObject.sqf:20`. Historical `a96fdda2` has the same old-shape evidence.
- Findings: current stable/B74.1, B69, B74 and B74.2 read `WFBE_C_AI_MAX` in `AI_Commander_Produce.sqf:234` and `WFBE_C_UNITS_CLEAN_TIMEOUT` in `Common_TrashObject.sqf:21` in both maintained roots. B74.2 changes only source Chernarus `Init_CommonConstants.sqf` / `AI_Commander_Produce.sqf` among checked parameter paths and leaves maintained Vanilla stable-shaped.
- Result: refreshed the Mission Parameters owner page, Feature Status, Source Fix queue, Dead/stale code register, dashboard, pruning ledger and machine rows. No gameplay source changed.
- Validation: JSON/JSONL parsing, `docs/validate-wiki.ps1`, touched-file wiki/docs parity and `git diff --check` passed with known legacy JSONL envelope and LF/CRLF warnings only.

## 2026-06-23T15:35:59+02:00 - Codex - Victory/endgame current B74.1 refresh

- Claimed `victory-endgame-current-b741-refresh-2026-06-23` after the visible victory/endgame register rows still named previous current stable `origin/master@0139a346` while current stable/B74.1 is `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`.
- Initial source scope: compare docs/source checkout, current stable/B74.1, B74.2, B69, adjacent B74, current Miksuu, perf/quick-wins and historical release refs for `server_victory_threeway.sqf`, `Client_EndGame.sqf`, `GUI_EndOfGameStats.sqf` and victory constants. No gameplay source edits planned.
- Initial finding: scoped diff `0139a3468609..origin/master` touches current-stable Chernarus `server_victory_threeway.sqf`, `Client_EndGame.sqf`, `GUI_EndOfGameStats.sqf` and both maintained-root `Client_EndGame.sqf` files, while B74.2 has no additional checked victory-path delta over current stable. The docs pass will route the partial current-stable rescue without calling the explicit winner/loser issue release-complete.
- Findings: current stable/B74.1 Chernarus removes the `_victory == 0` trap (`server_victory_threeway.sqf:11-16`), short-circuits later sides (`:23-26`) and guards the full condition (`:39-45`), but still writes `WF_Winner`, WASPSTAT and `LogGameEnd` from condition side `_x` (`:53,:57-65`). Current stable/B74.1 maintained Vanilla remains gated/mixed at `server_victory_threeway.sqf:11,:29` and logs `[_x]` at `:49`.
- Findings: current stable/B74.1 removes `Client_EndGame.sqf` side inversion in both maintained roots (`:5-11`), but the GUER stats label is Chernarus-only (`GUI_EndOfGameStats.sqf:8-9`); Vanilla remains West/East-only at `:5-8`. Current stable/B74.1 constants are Chernarus `Init_CommonConstants.sqf:856-857` and Vanilla `:728-729`. B74.2 adds no checked victory-path delta over B74.1.
- Result: refreshed [Victory/endgame atlas](Victory-And-Endgame-Atlas#current-branch-scope), Feature Status, Source Fix queue, testing smoke row, release-readiness pointer, hardening/feature/knowledge machine rows and coordination files. Future code work should compute explicit winner/loser sides, align the chosen client payload contract, propagate maintained Vanilla server/GUER-label behavior and smoke HQ elimination, all-towns, same-tick mutual elimination and AntiStack tails. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in wiki checkout and `docs/wiki`; `docs\validate-wiki.ps1 -WikiPath <wiki checkout>` passed with known legacy JSONL envelope warnings only; `git diff --check` passed in both worktrees with LF/CRLF warnings only; strict line-start conflict-marker scan passed; touched-file wiki/docs parity passed before the completion event.

## 2026-06-23T16:04:10+02:00 - Codex - Fast-travel fee current B74.1/B74.2 refresh

- Claimed `fast-travel-fee-current-b741-b742-refresh-2026-06-23` after the Tactical fast-travel fee rows still cited current stable `origin/master@0139a346` after current stable advanced to B74.1 and B74.2 became visible.
- Source scope: checked maintained-root `Client/GUI/GUI_Menu_Tactical.sqf` and `Common/Init/Init_CommonConstants.sqf` across docs/source Tactical GUI `e82c67547`, constants `1154f5d43`, current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`, B74.2 `origin/claude/b74.2-aicom@d472da6a`, B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, current Miksuu `b8389e748243`, perf `0076040f` and historical `a96fdda2`.
- Findings: docs/source still keeps the old `//--- TODO: Travel fee...` at `GUI_Menu_Tactical.sqf:147`, fee-mode funds/price-marker/debit shape at `:186,196-197,216,404-405`, and constants at `Init_CommonConstants.sqf:218,227-230` in both maintained roots.
- Findings: current stable/B74.1 keeps the same paid-mode local Tactical behavior without the stale TODO: both maintained roots hide unaffordable destinations and draw price markers at `GUI_Menu_Tactical.sqf:185,195-196,215`, then debit locally at `:403-404`; constants sit at source Chernarus `Init_CommonConstants.sqf:612,621-624` and maintained Vanilla `:414,423-426`.
- Branch scope: B74.2 has no checked Tactical GUI delta and only drifts source Chernarus constants to `Init_CommonConstants.sqf:625,634-637`; B69 and B74 keep the same Tactical behavior and only drift source Chernarus constants among checked fast-travel paths. Current origin exposes no live `release/*` or fast-travel feature heads.
- Result: refreshed [Client UI systems](Client-UI-Systems-Atlas#tactical-fast-travel-fee-branch-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T16:10:01+02:00 - Codex - Generated version.sqf / LoadoutManager current B74.1 refresh

- Claimed `version-sqf-loadoutmanager-current-b741-refresh-2026-06-23` after coordination reads showed generated `version.sqf` and LoadoutManager release-gate rows still naming previous current stable `origin/master@0139a346` while current stable/B74.1 is `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`.
- Planned source scope: check `Tools/LoadoutManager/FileManagement/FileManager.cs`, `Tools/LoadoutManager/Data/Terrains/BaseTerrain.cs`, `Tools/LoadoutManager/SqfFileGenerators/SqfFileGenerator.cs`, `Tools/LoadoutManager/ZipManager.cs` and maintained-root `version.sqf` / `version.sqf.template` presence across docs/source, current stable/B74.1, B74.2, B69, B74, current Miksuu, perf and historical release refs where available.
- Planned output: refresh [Mission config/version include graph](Mission-Config-Version-Include-Graph), [Source Fix queue](Source-Fix-Propagation-Queue), [Tools/build workflow](Tools-And-Build-Workflow), `agent-release-readiness.json` and matching coordination/machine rows. No gameplay source edits planned.
- Findings: docs/source `HEAD@7b1187d32`, current stable/B74.1 `origin/master@f8a76de34`, B74.2 `origin/claude/b74.2-aicom@d472da6a`, B69 `8d465fce`, B74 `b23f557f`, current Miksuu `b8389e748243`, perf `0076040f` and historical `a96fdda2` do not track live source Chernarus or maintained Vanilla `version.sqf`. Fresh docs/source checkout checks returned `Test-Path` false for both generated files and no ignored-present `git status --ignored` rows.
- Findings: current stable/B74.1/B74.2/B69/B74 track only `Missions/[55-2hc]warfarev2_073v48co.chernarus/version.sqf.template`; it is a reference template and does not satisfy the live generated input gate. Docs/source/Miksuu/perf/`a96fdda2` do not track the template in checked maintained roots.
- Findings: docs/source `HEAD@7b1187d32` accepts named-root or `Missions` + `Missions_Vanilla` + `Tools/LoadoutManager/LoadoutManager.csproj` root markers and implements `A2WASP_SKIP_ZIP` in `ZipManager.cs:11,96`. Current stable/B74.1/B74.2/B69/B74 and historical `a96fdda2` use named-root or Chernarus mission + `Tools/LoadoutManager` + `AGENTS.md` markers but have no checked skip-zip support; current Miksuu/perf remain named-root-only and also lack checked skip-zip support.
- Result: refreshed Mission config/version, Tools/build workflow, Source Fix queue, Feature Status, release-readiness, context/machine rows, pruning ledger, dashboard, status/collaboration and knowledge/event records with branch-scoped generated-input and LoadoutManager evidence. No gameplay source changed.
- Validation: JSON/JSONL parse passed in wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath .\docs\wiki` passed with known legacy JSONL envelope warnings only; touched-file wiki/docs parity passed across 14 files; Latest Batch has five rows; line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T16:40:00+02:00 - Codex - Vote/help UI current B74.1/B74.2 refresh

- Claimed `vote-help-ui-current-b741-b742-refresh-2026-06-23` after the vote/help/main-menu UI cleanup rows still cited previous current stable `origin/master@0139a346` while current stable/B74.1 is `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` and B74.2 is visible at `origin/claude/b74.2-aicom@d472da6a`.
- Source scope: checked maintained-root `Client/Init/Init_Client.sqf`, `Client/GUI/GUI_VoteMenu.sqf`, `Client/GUI/GUI_Commander_VoteMenu.sqf`, `Client/GUI/GUI_Menu_Help.sqf`, `Client/GUI/GUI_Menu.sqf` and `Rsc/Dialogs.hpp` across docs/source `HEAD@322ef95e`, current stable/B74.1, B74.2, B69, B74, current Miksuu, perf and historical `a96fdda2`.
- Findings: docs/source remains unchanged from `087152f5` / `68bd4dc5` for checked vote/help/router paths and keeps `WFBE_Client_Teams_Count` at `Init_Client.sqf:273`, inclusive vote loops at `GUI_VoteMenu.sqf:29,49,61` and `GUI_Commander_VoteMenu.sqf:58`, row-color writes at `GUI_VoteMenu.sqf:80,82`, help load/unload mismatch at `Rsc/Dialogs.hpp:3446-3447`, and handler-only `MenuAction == 17/18` at `GUI_Menu.sqf:202,206`.
- Findings: current stable/B74.1 uses `Init_Client.sqf:403,534` for team count/refresh and otherwise keeps the same vote/help/router debt: `GUI_VoteMenu.sqf:29,49,61,80,82`, `GUI_Commander_VoteMenu.sqf:58`, `GUI_Menu.sqf:241,270,274` and `Rsc/Dialogs.hpp:1244,1252,3172-3173` in both maintained roots. B74.2 has no checked path delta over current stable, and B69..B74 is also empty for checked paths.
- Branch scan: no live `release/*`, vote or help rescue head was exposed on current origin; current Miksuu/perf keep the docs-style FPS-HUD action-19 shape, while historical `a96fdda2` matches the stable GPS action-19 shape with line drift.
- Result: refreshed [Client UI systems](Client-UI-Systems-Atlas#vote-help-and-main-menu-branch-matrix), Feature Status, Source Fix queue, Dead/stale code register, dashboard, pruning ledger and machine rows. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T16:45:00+02:00 - Codex - Empty supply-truck current B74.1/B74.2 refresh

- Claimed `empty-supply-truck-current-b741-b742-refresh-2026-06-23` after empty supply-truck cleanup rows still cited previous current stable `origin/master@0139a346` while current stable/B74.1 is `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` and B74.2 is visible at `origin/claude/b74.2-aicom@d472da6a`.
- Source scope: checked maintained-root `Server/FSM/emptyvehiclescollector.sqf` and `Server/Functions/Server_HandleEmptyVehicle.sqf` across docs/source `HEAD@499c2543`, current stable/B74.1, B74.2, B69, B74, current Miksuu `b8389e748243`, perf `0076040f` and historical `a96fdda2`.
- Findings: docs/source remains unchanged from `b4e10b5f` for checked empty-vehicle collector/handler paths and keeps `emptyvehiclescollector.sqf:9,15,17,19` plus `Server_HandleEmptyVehicle.sqf:22-23,30` in both maintained roots.
- Findings: current stable/B74.1 and B74.2 keep the B74-shaped handler line drift in both maintained roots: `emptyvehiclescollector.sqf:9,15,17,19` and `Server_HandleEmptyVehicle.sqf:30-31,38`; both still set supply-truck `_delay = 86400`.
- Branch scope: checked path deltas `0139a3468609..origin/master`, `origin/master..origin/claude/b74.2-aicom` and `origin/claude/b69..origin/claude/b74-aicom-spend` are empty. Current origin exposes no live `release/*` or cleanup/supply rescue heads; historical `a96fdda2` is source evidence only.
- Result: refreshed [Marker cleanup/restoration](Marker-Cleanup-Restoration-Systems-Atlas#empty-supply-truck-branch-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T17:05:00+02:00 - Codex - Side-supply current B74.1/B74.2 refresh

- Claimed `side-supply-current-b741-b742-refresh-2026-06-23` after the side-supply clamp/reason/resistance rows still used stale current-stable `origin/master@0139a346` / current-B74 wording.
- Source scope: checked maintained-root `Common_ChangeSideSupply.sqf`, `Server_ChangeSideSupply.sqf`, `Common_GetSideSupply.sqf`, `Init_Common.sqf`, `mission.sqm` plus reason callers across docs/source `HEAD@973d817817d9`, current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`, B74.2 `origin/claude/b74.2-aicom@d472da6a`, B69, B74, Miksuu/perf/historical refs where relevant.
- Findings: docs/source is unchanged from `a908284c` / `4db90f1c` for checked side-supply/resistance paths and still has old floors plus west/east-only handlers. Current stable/B74.1 Chernarus removes dead common-side clamp arithmetic, floors server west/resistance/east negatives to `0` and adds `wfbe_supply_temp_resistance`; maintained Vanilla remains old-shape.
- Findings: B74.2 adds no checked side-supply/resistance delta over current stable. B74.2 Chernarus only line-drifts four-argument supply-completion reason callers; the helper still drops three-argument `AttackWave.sqf:40` reasons because `Common_ChangeSideSupply.sqf:8-14` reads `_reason` only when `count _this > 3`.
- Result: refreshed [Economy authority](Economy-Authority-First-Cut), [Resistance supply scaffold](Resistance-Supply-Scaffold), Feature Status, Source Fix queue, Public Variable index, Server authority map and machine rows. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T16:43:00+02:00 - Codex - Salvage payout current B74.1/B74.2 refresh

- Claimed `salvage-payout-current-b741-b742-refresh-2026-06-23` after coordination reads showed the salvage payout/casing rows still naming current stable `origin/master@0139a346` after current stable advanced to B74.1 `origin/master@f8a76de34` and B74.2 `origin/claude/b74.2-aicom@d472da6a` became visible.
- Planned source scope: source Chernarus plus maintained Vanilla manual engineer salvage, salvage-truck update, client compile/caller paths and branch-only `origin/claude/salvage-w10-manfilter` evidence across docs/source, current stable/B74.1, B74.2, B69, B74, Miksuu, perf and historical `a96fdda2`.
- Planned output: refresh [Construction and CoIn systems](Construction-And-CoIn-Systems-Atlas#salvage-branch-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows with exact branch evidence. No gameplay source edits planned.
- Findings: docs branch `docs/developer-wiki-index@795cdbbf0` still keeps lowercase `ChangePlayerfunds` in `Skill_Salvage.sqf:38` and `updatesalvage.sqf:50`, compiles uppercase `ChangePlayerFunds` at `Init_Client.sqf:53,91`, launches salvage trucks at `Client_BuildUnit.sqf:267`, and keeps the `updatesalvage.sqf:10` OR loop plus local delete/reward shape in both maintained roots.
- Findings: current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` keeps the same issue with line drift: `Skill_Salvage.sqf:38`, `updatesalvage.sqf:51`, `Init_Client.sqf:97,135`, source Chernarus `Client_BuildUnit.sqf:388` and maintained Vanilla `:343`. B74.2 `origin/claude/b74.2-aicom@d472da6a` has no checked manual/truck salvage delta over current stable.
- Branch routing: `origin/claude/salvage-w10-manfilter@2e0242b3` remains W10-only branch evidence (`AI_Commander_Wildcard.sqf:794` Man exclusion) and still keeps manual/truck payout debt. Newly fetched `origin/claude/trello-salvage-truck-interlock@9e75c736e` is one clean current-stable-based Trello #15 UX/interlock branch: it blocks manual engineer salvage near a friendly salvage truck at `Skill_Apply.sqf:35` / `Skill_Salvage.sqf:5,11-12`, but leaves `updatesalvage.sqf`, `Client_BuildUnit.sqf` and lowercase payout calls open.
- Result: refreshed Construction/CoIn salvage matrix, Feature Status, Source Fix queue, Testing workflow branch-only smoke row, release-readiness gate, pruning ledger, dashboard and salvage machine rows. Future code work should fix `ChangePlayerFunds` casing first in source Chernarus plus maintained Vanilla, smoke manual/truck payout, then treat loop exit and server-owned delete/reward authority as separate work. No gameplay source changed.
- Validation: JSON/JSONL parse passed in the wiki checkout and `docs/wiki`; touched-file SHA parity passed; Progress Dashboard Latest Batch has five rows; strict line-start conflict-marker scan passed; `docs\validate-wiki.ps1 -WikiPath .\docs\wiki` passed with known legacy JSONL envelope warnings only; `git diff --check` passed in both worktrees with LF/CRLF warnings only.
## 2026-06-23T17:12:00+02:00 - Codex - Factory refund current B74.1/B74.2 refresh

- Claimed `factory-refund-current-b741-b742-refresh-2026-06-23` after the destroyed-factory purchase refund rows still cited previous current stable `origin/master@0139a346` while current stable/B74.1 is `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` and B74.2 is visible at `origin/claude/b74.2-aicom@d472da6a`.
- Source scope: checked maintained-root `Client/GUI/GUI_Menu_BuyUnits.sqf` and `Client/Functions/Client_BuildUnit.sqf` across docs/source `HEAD@cacd46f09163`, current stable/B74.1, B74.2, B69, adjacent B74, current Miksuu `b8389e748243`, perf `0076040f`, historical `a96fdda2` and intermediate `7ff18c49`.
- Initial findings: docs/source remains unchanged from `4120137f` / `8d611092` for checked buy/build paths and still spawns `BuildUnit` without `_currentCost` while debiting locally. Current stable/B74.1, B69, B74 and B74.2 pass `_currentCost` into `BuildUnit` and refund the real dead/null factory abort in both maintained roots.
- Branch scope: `0139a3468609..origin/master` touches only source Chernarus `Client_BuildUnit.sqf` among checked paths, and the diff is GUER VBIED action persistence, not refund behavior. B74.2 changes source Chernarus buy-menu AI-cap setup and shifts the spawn/debit lines, but the refund branch remains unchanged.
- Result: refreshed [Factory and purchase systems](Factory-And-Purchase-Systems-Atlas#destroyed-factory-refund-branch-matrix), Feature Status, Source Fix queue, Progress Dashboard, pruning ledger, status/collaboration and factory refund machine rows. Old-shape docs/Miksuu/perf/QoL roots stay patch-ready; current stable/B74.1/B69/B74/B74.2 and historical `a96fdda2` carry the dead/null refund. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T17:21:17+02:00 - Codex - Buy-menu price/key current B74.1/B74.2 refresh

- Claimed `buy-menu-price-key-current-b741-b742-refresh-2026-06-23` after Feature Status and Source Fix queue still routed buy-menu price/key alignment through stale current-stable `origin/master@0139a346` wording after current stable advanced to B74.1 `origin/master@f8a76de34` and B74.2 `origin/claude/b74.2-aicom@d472da6a` became visible.
- Planned source scope: maintained-root `Client/GUI/GUI_Menu_BuyUnits.sqf`, `Client/Functions/Client_UIFillListBuyUnits.sqf` and `Common/Init/Init_CommonConstants.sqf` across docs/source, current stable/B74.1, B74.2, B69, B74, Miksuu, perf and historical `a96fdda2`.
- Planned output: refresh [Factory and purchase systems](Factory-And-Purchase-Systems-Atlas#buy-menu-price-and-driver-key-branch-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows with exact branch evidence. No gameplay source edits planned.
- Findings: docs/source checked buy-menu price/key paths remain source-unchanged from `4120137f` / `8d611092` / `ebd86fad0` and still have selected-detail price drift at `GUI_Menu_BuyUnits.sqf:261`, no level-0 `UNIT_COST_MODIFIER` reset (`Client_UIFillListBuyUnits.sqf:11,14` only) and uppercase/lowercase driver-default key split in both maintained roots.
- Findings: current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`, current B69 `origin/claude/b69@8d465fce`, adjacent B74 `origin/claude/b74-aicom-spend@b23f557f`, B74.2 `origin/claude/b74.2-aicom@d472da6a` and historical `a96fdda2` fix selected-detail display and driver-key mirroring in both maintained roots, but no checked ref resets `UNIT_COST_MODIFIER` to `1` for level 0. B74.2 only line-drifts source Chernarus to purchase `GUI_Menu_BuyUnits.sqf:105`, selected detail `:422` and constants `Init_CommonConstants.sqf:610`; maintained Vanilla stays stable-shaped.
- Branch routing: live `origin/claude/trello-buymenu-gear-display@db1291beba` is one clean current-stable-based commit touching only maintained-root `GUI_Menu_BuyUnits.sqf` (+70/-2). It mirrors existing `Common_CreateUnit.sqf:78-95` special AT loadout replacements into infantry gear/ammo preview arrays at `GUI_Menu_BuyUnits.sqf:552-565`; it is not price/key or reset closure.
- Result: refreshed Factory/Purchase buy-menu matrix, Feature Status, Source Fix queue, pruning ledger and buy-menu machine rows. Future code work should preserve selected-detail/key fixes on stable-shaped refs, add a level-0 modifier reset or local price helper, then smoke list/detail/charge, exact funds, unit-cost levels `0/1/2`, crew toggles, max-out and reset. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T17:31:00+02:00 - Codex - SEND_MESSAGE current B74.1/B74.2 refresh

- Claimed `send-message-current-b741-b742-refresh-2026-06-23` after the direct `SEND_MESSAGE` compile rows still contained stale current-stable `origin/master@0139a346` wording while current stable/B74.1 is `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` and B74.2 is visible at `origin/claude/b74.2-aicom@d472da6a`.
- Source scope: checked maintained-root `Client/FSM/updateclient.sqf`, `Client/Functions/Client_onEventHandler_SEND_MESSAGE.sqf` and `Common/Functions/Common_SendMessage.sqf` across docs/source `HEAD@cd9ba541d583`, current stable/B74.1, B74.2, B69, adjacent B74, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f` and historical `a96fdda2`.
- Initial findings: docs/source is unchanged from `3a32be92` / `40c477be` / `16247fc8f` for checked `SEND_MESSAGE` paths. Current stable/B74.1 and B74.2 still register the direct receiver at `updateclient.sqf:12`, compile receiver text at `Client_onEventHandler_SEND_MESSAGE.sqf:27`, and compile/broadcast helper text at `Common_SendMessage.sqf:26,37-38` in both maintained roots. No gameplay source edits planned.
- Branch scope: checked diffs `3a32be92..HEAD`, `40c477be..HEAD`, `16247fc8f..HEAD`, `0139a3468609..origin/master`, `origin/master..origin/claude/b74.2-aicom`, `0a1ccb4d..origin/claude/b69`, `b8530477..origin/claude/b69` and `origin/claude/b69..origin/claude/b74-aicom-spend` are empty for the maintained-root `SEND_MESSAGE` paths. Current origin exposes no live `release/*`, message, send, network, public, PVF or security rescue head.
- Result: refreshed [Public variable channel index](Public-Variable-Channel-Index#send_message-direct-compile-branch-matrix), [Networking](Networking-And-Public-Variables), Feature Status, Source Fix queue, dashboard, pruning ledger, status/collaboration and `SEND_MESSAGE` machine rows. Future code work should replace receiver/helper `call compile` with structured localization key/args handling, propagate maintained Vanilla and smoke localized messages plus forged payload-as-data behavior. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T17:46:00+02:00 - Codex - Resource income current B74.1/B74.2 refresh

- Claimed `resource-income-current-b741-b742-refresh-2026-06-23` after the resource-income Feature Status, Source Fix queue and economy owner pages still cited stale current stable `origin/master@0139a346` after current stable advanced to B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` and B74.2 became visible at `origin/claude/b74.2-aicom@d472da6a`.
- Source scope: checked maintained-root `Server/FSM/updateresources.sqf` and `Client/Functions/Client_GetIncome.sqf` across docs/source `HEAD`, current stable/B74.1, B74.2, B69, adjacent B74, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f` and historical `a96fdda2`.
- Initial findings: docs/source is unchanged from `c8ec223a` for checked income files and still keeps old guard/display drift. Current stable/B74.1 and B74.2 match for checked income files; Chernarus carries the B74 hybrid-refill/fallback shape plus B74.1 AICOM taper, while maintained Vanilla keeps the non-hybrid fallback shape. Income-system `4` client display drift remains open. No gameplay source edits planned.
- Findings: current stable/B74.1/B74.2 Chernarus gates side supply/team paychecks at `updateresources.sqf:69,87,101`, applies system-4 `1.5` at `:80-81`, uses `WFBE_C_ECONOMY_SUPPLY_INCOME_MULT` and `WFBE_C_AI_COMMANDER_HYBRID_REFILL`, keeps over-cap fallback at `:126-132` and applies the B74.1 AICOM taper at `:57-67,:106,:130`.
- Findings: current stable/B74.1/B74.2 maintained Vanilla gates side supply/team paychecks at `updateresources.sqf:58,76,90`, applies system-4 `1.5` at `:69-70`, and keeps raw side supply plus non-hybrid AICOM under-cap/over-cap fallback at `:94-103,:115-121`.
- Branch scope: docs/source `HEAD@52d6b3aa3001` is source-unchanged from `c8ec223a` / `3a32be92` / `cd9ba541`; Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f` and historical `a96fdda2` match the old maintained-root payout/display shape. `origin/master..origin/claude/b74.2-aicom` and `origin/claude/b69..origin/claude/b74-aicom-spend` are empty for checked income files, while `origin/claude/b74-aicom-spend..origin/master` only adds the Chernarus B74.1 AICOM taper among checked paths.
- Result: refreshed [Economy, towns and supply](Economy-Towns-And-Supply#resource-income-branch-matrix), [Resource income tick distribution engine](Resource-Income-Tick-Distribution-Engine), [Economy authority](Economy-Authority-First-Cut), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T17:53:39+02:00 - Codex - Service/EASA current B74.1/B74.2 branch refresh

- Claimed `service-easa-current-b741-b742-branch-refresh-2026-06-23` after Service menu affordability, Gear/EASA and Feature Status rows still used stale current-stable `origin/master@0139a346` wording and did not route live `origin/claude/trello-service-ammo-count` / `origin/claude/trello-easa-weapon-categories` heads.
- Planned source scope: maintained-root `Client/GUI/GUI_Menu_Service.sqf`, `Client/GUI/GUI_Menu_EASA.sqf` and service support scripts across docs/source, current stable/B74.1, B74.2, B69, B74, Miksuu, perf, historical `a96fdda2` / `a66d4691` and the two live Trello branches.
- Planned output: refresh [Service menu affordability guards](Service-Menu-Affordability-Guards), [Gear/loadout/EASA atlas](Gear-Loadout-And-EASA-Atlas), Feature Status, Source Fix queue, pruning ledger and machine rows with exact branch evidence. No gameplay source edits planned.
- Findings: docs/source `HEAD@b798fd66` remains source-unchanged from `e9dd7f37`, `8906ee89`, `9b3fc38e` and `8b71e2a1` for checked service/EASA menu paths. It still uses old action branches (`GUI_Menu_Service.sqf:198,208-209,219,229-230`) and strict EASA purchase (`GUI_Menu_EASA.sqf:47-49`) in both maintained roots.
- Findings: current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`, B74.2 `origin/claude/b74.2-aicom@d472da6a`, B69 `8d465fce`, B74 `b23f557f` and historical `a96fdda2` partially guard service rearm/refuel in both maintained roots, but repair/heal still only check positive price at debit time (`GUI_Menu_Service.sqf:496-497,519-520`) and no branch closes action-time context/server authority. Stable-shaped refs fix exact-funds EASA only in source Chernarus (`GUI_Menu_EASA.sqf:118`); maintained Vanilla remains strict `>`.
- Branch routing: `origin/claude/trello-service-ammo-count@9159f935874e` merge-bases on `f8a76de34`, changes two maintained-root service files (+6/-4) and adds ammo-percent UI at `GUI_Menu_Service.sqf:333,474,477`; affordability anchors remain stable-shaped. `origin/claude/trello-easa-weapon-categories@0881911849da` also merge-bases on `f8a76de34`, changes four maintained-root EASA module files (+116/-2), compiles `WFBE_EASA_FNC_LoadoutCat` at `EASA_Init.sqf:2` and adds `EASA_LoadoutCat.sqf:1-57` for `[MR]`/`[AA]`/`[AG]` tags. Both branch diffs passed `git diff --check`; neither is affordability, stale-context or authority closure.
- Result: refreshed Service menu affordability, Gear/EASA atlas, Feature Status, Source Fix queue, Progress Dashboard, pruning ledger and service/EASA machine rows. Future code work should patch action-time service guards and maintained Vanilla exact-funds deliberately, then smoke exact-price, under-price, repair/heal funds, stale/unsupported vehicle, service ammo UI and EASA category tags before promotion wording. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; touched-file wiki/docs parity passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only. Progress Dashboard Latest Batch has five rows.

## 2026-06-23T18:15:00+02:00 - Codex - AI upgrade debit current B74.1/B74.2 refresh

- Claimed `ai-upgrade-debit-current-b741-b742-refresh-2026-06-23` after the AI commander upgrade debit/cost matrix still cited previous current stable `origin/master@0139a346` after current stable advanced to B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` and B74.2 became visible at `origin/claude/b74.2-aicom@d472da6a`.
- Source scope: checked maintained-root `Server/Functions/Server_AI_Com_Upgrade.sqf` plus player upgrade cost tuple anchors in `Client/GUI/GUI_UpgradeMenu.sqf` across docs/source `HEAD@031a253fe`, current stable/B74.1, B74.2, B69, adjacent B74, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f`, historical `a96fdda2`, `b061c905`, `c20ce153` and live side branches that touch the worker.
- Findings: docs/source is unchanged from `ade4d356` for checked worker files and keeps old raw AI-order lookup plus swapped debit at `Server_AI_Com_Upgrade.sqf:27,47,50`; Miksuu and perf match that old-shape validation/debit behavior at `:34,36,47,50`.
- Findings: current stable/B74.1, B74.2, B69 and adjacent B74 resolve both maintained roots with current-level lookup at `Server_AI_Com_Upgrade.sqf:75`, affordability gates at `:89,:92,:97`, AI funds debit at `:125`, opt-in funds-fallback surcharge at `:131-132` and side-supply debit at `:136`. Checked B74.2 and B69..B74 worker deltas are empty.
- Branch scope: historical `a96fdda2` and `b061c905` fix debit order only, historical `c20ce153` fixes Chernarus only, `origin/review/aicom-deploy`, `origin/notes/aicom-match-fixes` and `origin/fix/aicom-review-batch-2026-06-15` carry resolved but line-drifted workers, `origin/codex/ai-commander-context` / `origin/codex/ai-commander-logs` fix Chernarus only, and `origin/codex/quad-ai-commander` remains old-shape. Current origin exposes no live `release/*`, `feat/upgrade-queue-stacking` or `feat/ai-commander` head.
- Result: refreshed [AI commander autonomy audit](AI-Commander-Autonomy-Audit#ai-upgrade-debit-branch-matrix), [Upgrades and research](Upgrades-And-Research-Atlas#ai-commander-flow), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed in both worktrees; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T18:21:30+02:00 - Codex - Patrols v2 current B74.1/B74.2 refresh

- Claimed `patrols-v2-current-b741-b742-refresh-2026-06-23` after coordination reads showed Patrols v2 rows still naming stale current stable `origin/master@0139a346` while current stable/B74.1 is `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` and B74.2 is visible at `origin/claude/b74.2-aicom@d472da6a`.
- Planned source scope: maintained-root Patrols v2 constants, common compiles, server worker/side-patrol dispatcher, marker FSM, special-handler side-slot calls and UI cap surfaces across docs/source, current stable/B74.1, B74.2, B69, B74, Miksuu, perf and historical refs where useful.
- Planned output: refresh [Towns/camps/capture](Towns-Camps-And-Capture-Atlas#patrols-v2-side-upgrade-path), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows with exact branch evidence. No gameplay source edits planned.
- Findings: docs/source `HEAD@665df909`, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f` and historical `a96fdda2` have no maintained-root Patrols v2 startup hits for `Server\FSM\server_side_patrols`, `WFBE_UP_PATROLS` or `WFBE_ACTIVE_PATROLS`.
- Findings: current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` keeps Patrols v2 in both maintained roots: retired town-AI launch comments, active `server_side_patrols` driver, `Common_RunSidePatrol` RequestSpecial start/end, friendly marker feed, `server_patrols.sqf:31` `&&`, and side-slot release through `Server_HandleSpecial`.
- Branch scope: B69 `8d465fce` and adjacent B74 `b23f557f` keep the same Patrols v2 route; checked B69..B74 Patrols-path delta is limited to source Chernarus `Init_CommonConstants.sqf`. B74.2 `d472da6a` adds source-Chernarus pop-tier cap reads in `server_side_patrols.sqf:32,38`, `server_town_ai.sqf:61,64-65`, `Server_GetTownGroupsDefender.sqf:89,91` and Buy Units/RHUD, and has no `Missions_Vanilla` Patrols payload.
- Result: refreshed [Towns/camps/capture](Towns-Camps-And-Capture-Atlas#patrols-v2-side-upgrade-path), Feature Status, Source Fix queue, Progress Dashboard, pruning ledger, status/collaboration and Patrols machine rows. Future smoke should cover levels 1/2/3, level-4 convoy/camp sweep, HC `delegate-sidepatrol`, friendly marker audience, death/slot release and B74.2 pop-tier AI-cap display. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T18:37:39+02:00 - Codex - Town AI despawn current B74.1/B74.2 refresh

- Claimed `town-ai-despawn-current-b741-b742-refresh-2026-06-23` after the Town AI vehicle despawn safety row still named previous current stable `origin/master@0139a346`, while current stable/B74.1 is `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` and B74.2 is visible at `origin/claude/b74.2-aicom@d472da6a`.
- Source scope: checked maintained-root `Server/FSM/server_town_ai.sqf` across docs/source `HEAD@2a4020586`, current stable/B74.1, B74.2, B69, adjacent B74, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f`, historical `a96fdda2`, `origin/feat/aicom-fleet-improvements@cc5090bed4ad` and live `origin/claude/upstream-town-defense-diag-sync@cde1f1fc`.
- Findings: docs/source checked paths are unchanged from `3a9ba92e` and still delete inactive tracked vehicles at `server_town_ai.sqf:214` with only `!(isPlayer leader group _x)` in both maintained roots. Miksuu, perf, historical release and AI fleet keep the same old-shape risk with line drift at `:195`, `:219`, `:200` and `:207`.
- Findings: current stable/B74.1, B69 and adjacent B74 now carry the crew-count guard only in source Chernarus at `server_town_ai.sqf:325`; B74.2 line-drifts that Chernarus guard to `:337`. Maintained Vanilla remains leader-only at `:319` on all four refs, so this is Chernarus-only candidate evidence, not DR-45 closure.
- Branch scope: `origin/claude/upstream-town-defense-diag-sync@cde1f1fc` merge-bases at `be2bbd084`, changes delegated cleanup/diagnostics files and leaves DR-45 branch state matching current stable. Current origin exposes no live `release/*` head; branch scan found only the unsafe AI fleet branch and the delegated-cleanup diagnostics branch for town/despawn/cleanup patterns.
- Result: refreshed [Town AI vehicle despawn safety](Town-AI-Vehicle-Despawn-Safety#current-branch-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed in both worktrees; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T19:00:24+02:00 - Codex - Commander vote/reassignment current B74.1/B74.2 queue refresh

- Claimed `commander-vote-reassignment-current-b741-b742-queue-refresh-2026-06-23` after Source Fix queue, Feature Status and machine rows still carried stale `origin/master@0139a346` commander vote/reassignment wording while current stable/B74.1 is `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` and B74.2 is visible at `origin/claude/b74.2-aicom@d472da6a`.
- Source scope: checked maintained-root `Server_VoteForCommander.sqf`, `GUI_VoteMenu.sqf`, `RequestNewCommander.sqf`, `Server_AssignNewCommander.sqf` and `GUI_Commander_VoteMenu.sqf` across docs/source, current stable/B74.1, B74.2, B69, adjacent B74, current Miksuu `b8389e748243`, `origin/perf/quick-wins@0076040f`, historical `a96fdda2` and historical AI-commander `c20ce153`.
- Findings: current stable/B74.1, B74.2, B69 and adjacent B74 maintained roots keep the fixed vote comparison at `Server_VoteForCommander.sqf:43` and fixed helper unpacking at `Server_AssignNewCommander.sqf:4-5`; checked `0139a3468609..origin/master`, `origin/master..origin/claude/b74.2-aicom` and `origin/claude/b69..origin/claude/b74-aicom-spend` vote/reassignment path deltas are empty.
- Findings: docs/source remains old-shape for the vote comparison and helper unpacking; GUI preview, visible-name reassignment targeting, duplicate `new-commander-assigned` senders, requester authority and current stable/B74-shaped modded full forks remain open. No gameplay source changed.
- Result: refreshed Commander vote/reassignment, Commander reassignment call shape, Feature Status, Source Fix queue, Progress Dashboard, pruning ledger, status/collaboration and commander machine rows; mirrored touched files into docs/wiki.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.

## 2026-06-23T19:13:24+02:00 - Codex - RHUD/endgame title handle current B74.1/B74.2 refresh

- Claimed `rhud-endgame-title-handle-current-b741-b742-refresh-2026-06-23` after UI title-handle rows still routed the shared `currentCutDisplay` risk through current-B74 `origin/master@0139a346` wording while current stable/B74.1 is `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34` and B74.2 is visible at `origin/claude/b74.2-aicom@d472da6a`.
- Planned source scope: maintained-root `Rsc/Titles.hpp`, `Client/Client_UpdateRHUD.sqf`, `Client/FSM/updateavailableactions.fsm`, `Client/GUI/GUI_EndOfGameStats.sqf`, `Client/GUI/GUI_SetCurrentCutDisplay.sqf` and `Client/GUI/GUI_ClearCurrentCutDisplay.sqf` across docs/source, current stable/B74.1, B74.2, B69, B74, current Miksuu, perf and historical refs.
- Planned output: refresh [UI IDD collision repair](UI-IDD-Collision-Repair#title-display-handle-branch-matrix), Feature Status, Source Fix queue, dashboard, pruning ledger and machine rows with exact branch evidence. No gameplay source edits planned.
- Findings: docs/source `HEAD@ebfdca965` is source-unchanged from `92b52e73`, `edbd341e` and `b5219d47` for checked title-handle paths. It still uses `Rsc/Titles.hpp:170-171,539-540`, `Client_UpdateRHUD.sqf:89-92,190`, `updateavailableactions.fsm:225-230`, `GUI_EndOfGameStats.sqf:13,34-44,86-93` and the one-line shared helper scripts in both maintained roots.
- Findings: current stable/B74.1 `origin/master@f8a76de34` / `origin/claude/b74.1-aicom@f8a76de34`, B74.2 `d472da6a`, B69 `8d465fce` and B74 `b23f557f` keep the same shared `currentCutDisplay` ownership in both maintained roots. Current stable/B74-shaped title refs are `Rsc/Titles.hpp:174-175,587-588`; RHUD/action-icon reads remain at `Client_UpdateRHUD.sqf:89-92` and `updateavailableactions.fsm:225-230`; source-Chernarus endgame stats are `GUI_EndOfGameStats.sqf:15,36-46,88-95` while maintained Vanilla remains `:13,34-44,86-93`.
- Branch scope: `0139a3468609..origin/master` only changes source-Chernarus GUER-label / vehicle-tint title content among checked title-handle files; `origin/master..origin/claude/b74.2-aicom` only changes source-Chernarus RHUD AI-cap display text; `origin/claude/b69..origin/claude/b74-aicom-spend` is empty for checked title-handle paths. Current origin exposes no live `release/*`, title, RHUD, endgame, display or handle rescue head.
- Result: refreshed UI IDD Collision Repair, Client UI systems, Feature Status, Source Fix queue, Progress Dashboard, pruning ledger, hardening backlog and knowledge/event rows. Future UI runtime work should split display keys or gate RHUD/action-icon recreation after endgame, keep this separate from EASA/Economy dialog IDD cleanup, propagate maintained roots and smoke RHUD/FPS, action icons and endgame stat bars together. No gameplay source changed.
- Validation: JSON/JSONL parsing passed in the wiki checkout and `docs/wiki`; `docs/validate-wiki.ps1 -WikiPath docs/wiki` passed with known legacy JSONL envelope warnings only; Progress Dashboard Latest Batch has five rows; touched-file wiki/docs parity passed; strict line-start conflict-marker scan passed; `git diff --check` passed in both worktrees with LF/CRLF warnings only.
