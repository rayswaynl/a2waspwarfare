...
- Validation passed: `docs/validate-wiki.ps1`, JSON/JSONL parsing, `git diff --check` in both worktrees and SHA256 mirror parity for 15 files. Pushed as docs `eac4a8f6` / wiki `fa9d2a5`. Documentation only; no gameplay source files were edited.
