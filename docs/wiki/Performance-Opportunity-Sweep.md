...
6. WASP marker dialog wait cleanup is target-specific: docs/source, current Miksuu and perf still need the throttle/refactor; stable/B74.1/B74.2/B69/B74/client-fps need marker-dialog smoke before verified wording.
