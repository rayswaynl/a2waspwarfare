...
$VER='b51'                                # stable-folder
$stem='[55-2hc]warfarev2_073v48co'
$world='chernarus'
$newName="${stem}_${VER}.${world}"       # [55-2hc]warfarev2_073v48co_sf.chernarus  (FOLDER; world stays chernarus)
$srcZip='C:\WASP\staging\aicom-chernarus-b51.zip'   # full consolidated update (A8/CB/rearm-heal/teams/join-robustness)
