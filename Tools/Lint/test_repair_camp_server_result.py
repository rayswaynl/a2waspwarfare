#!/usr/bin/env python3
"""Regression checks for paid camp-repair server result and settlement flow."""
...
def test_paid_camp_repair_receives_a_server_result_after_server_settlement() -> None:
    for mission in MISSIONS:
        ...
        assert "WFBE_CL_FNC_ChangeClientFunds" not in result_handler
        assert "[_repairTeam, -_repairPrice] Call WFBE_CO_FNC_ChangeTeamFunds" in server_handler
