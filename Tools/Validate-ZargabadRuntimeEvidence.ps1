...
Assert-Pattern "runtime audit reports Zargabad base and fortification counts" $content 'Zargabad_RuntimeAudit\.sqf: bases WEST .* EAST .* distance \[[0-9]+\] westStatic \[4\] eastStatic \[4\] baseWalls \[13\] baseFootprint \[35,45,74,78\] centralWallPieces \[60\] centralWallCrewed \[0\] centralWallOrigin \[3425,3375\] centralWallDir \[316\] centralWallGaps .*4053.*2725.*3789.*2998.*3504.*3293.*3195.*3613.*2903.*3915'
...
Assert-Pattern "runtime audit reports Zargabad economy and range constants" $content 'Zargabad_RuntimeAudit\.sqf: economy supplyCap \[[0-9]+\] teamSupplyCap \[30000\] fastTravelMax \[1800\] respawnCampRange \[400\].*supportRange \[55\].*baseDefenseAI \[56\] baseDefenseRange \[500\] edgeGuard \[120,325,45\] weapons missileRange \[1500\] uavRange \[650\] townRanges \[45,420,300\] purchaseHangar \[35\] countermeasures \[12,18\]'
...
Assert-Pattern "runtime audit reports Zargabad price multipliers and samples" $content 'Zargabad_RuntimeAudit\.sqf: priceMultipliers .*0\.95.*1\.15.*1\.4.*1\.75.*2\.0.*1\.0.*priceSamples .*US_Soldier_EP1.*M1126_ICV_M2_EP1.*M2A2_EP1.*MH6J_EP1.*C130J_US_EP1'
