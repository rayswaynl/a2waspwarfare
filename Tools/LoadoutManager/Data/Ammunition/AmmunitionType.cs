...
public enum AmmunitionType
{
    ...
    FOURROUNDCH29,
    [EnumMember(Value = "4Rnd_Ch29")]
    VANILLA_FOURROUNDCH29,
    [EnumMember(Value = "6Rnd_Ch29")]
    SIXROUNDCH29,

    [EnumMember(Value = "40Rnd_S8T")]
    FOURTYROUNDS8,
    [EnumMember(Value = "40Rnd_80mm")]
    VANILLA_FOURTYROUNDS8WITH80MMLAUNCHER,
    [EnumMember(Value = "40Rnd_S8T")]
    ...
    FOURROUNDATAKA,
    [EnumMember(Value = "8Rnd_AT9_Mi24V")]
    EIGHTROUNDATAKA,
    ...
    // Modded ammunitions
    [EnumMember(Value = "520Rnd_23mm_GSh23L")]
    MODDED_FIVEHUNDREDTWENTYROUND23MMGSH23L,

    [EnumMember(Value = "PRACS_AA8x4")]
    MODDED_FOURR60ROUND,
}