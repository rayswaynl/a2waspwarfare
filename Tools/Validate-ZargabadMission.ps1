...
Assert-True "runtime audit logs uncrewed central wall evidence" ($runtimeAuditSource -match 'centralWallCrewed \[%8\]')
Assert-True "runtime audit logs central wall gap checkpoints" ($runtimeAuditSource -match 'centralWallGaps %9')
