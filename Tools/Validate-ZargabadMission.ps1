...
Assert-True "runtime report validator requires all Claude Notes rows" ($runtimeReportValidatorSource -match 'Claude Notes required rows are present' -and $runtimeReportValidatorSource -match 'Hosted boot context' -and $runtimeReportValidatorSource -match 'Dedicated boot context' -and $runtimeReportValidatorSource -match 'Base safety and spawn sightlines' -and $runtimeReportValidatorSource -match 'Economy and factory pricing feel')
...
Assert-True "runtime report validator requires row-specific Claude evidence" ($runtimeReportValidatorSource -match 'Claude Notes .* evidence is specific' -and $runtimeReportValidatorSource -match 'hosted' -and $runtimeReportValidatorSource -match 'dedicated' -and $runtimeReportValidatorSource -match 'zargabad-map-audit\\.md' -and $runtimeReportValidatorSource -match 'Recommended Codex action')
