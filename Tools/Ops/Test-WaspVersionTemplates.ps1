...
Assert-Match $chernarus '(?m)^#define WF_MAXPLAYERS 34\r?$' "Chernarus max-player define is 34"
...
Assert-Match $takistan '(?m)^#define WF_MAXPLAYERS 34\r?$' "Takistan max-player define is 34"
...
Assert-Match $zargabad '(?m)^#define WF_MAXPLAYERS 34\r?$' "Zargabad max-player define is 34"
