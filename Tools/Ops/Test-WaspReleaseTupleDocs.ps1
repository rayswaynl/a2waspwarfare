...
[CmdletBinding()]
param(
	[string]$ExpectedBranchHeadFull = "6363f4cb5b23448abc55ceb7e39cda2448233ac5",
	[string]$ExpectedGitFull = "6363f4cb5b23448abc55ceb7e39cda2448233ac5",
	[string]$ExpectedGit = "6363f4cb5b",
	[string]$ExpectedArchiveSha256 = "ECC6F9D51DD9BD459677863E585F313921E55BAE905C83431EB7EB7596E7D416",
	[string]$ExpectedPackageSize = "7,164,669",
	[string]$ExpectedWikiCommit = "4f35132",
