...
[CmdletBinding()]
param(
	[string]$ExpectedBranchHeadFull = "cf4e93af1a2665bdab13448a03d2fbf3e3b33edf",
	[string]$ExpectedGitFull = "cf4e93af1a2665bdab13448a03d2fbf3e3b33edf",
	[string]$ExpectedGit = "cf4e93af1a",
	[string]$ExpectedArchiveSha256 = "F4F19086A4D51881C61B16CA024FE1C586478161672C7EFE268F5A42C4852B7A",
	[string]$ExpectedPackageSize = "7,166,267",
	[string]$ExpectedWikiCommit = "a82afcd",
