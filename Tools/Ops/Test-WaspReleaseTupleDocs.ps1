...
[CmdletBinding()]
param(
	[string]$ExpectedBranchHeadFull = "f894419db929d0900160944760f1c6646a6fa3d9",
	[string]$ExpectedGitFull = "f894419db929d0900160944760f1c6646a6fa3d9",
	[string]$ExpectedGit = "f894419db9",
	[string]$ExpectedArchiveSha256 = "0EFED527088FE4EBD0F0C94702DE9A1818972EE9741597F8B400E9B78268A74C",
	[string]$ExpectedPackageSize = "7,164,905",
	[string]$ExpectedWikiCommit = "8099a35",
