...
[CmdletBinding()]
param(
	[string]$ExpectedBranchHeadFull = "fa3d0a159d1746e860c1cbf12062b2f45835ab57",
	[string]$ExpectedGitFull = "fa3d0a159d1746e860c1cbf12062b2f45835ab57",
	[string]$ExpectedGit = "fa3d0a159d",
	[string]$ExpectedArchiveSha256 = "76A5EE569DDA8E1486A16A7C20DF44E3332170F7590A2AE3008C6058E32E25DA",
	[string]$ExpectedPackageSize = "7,165,509",
	[string]$ExpectedWikiCommit = "299fad9",
