...
[CmdletBinding()]
param(
	[string]$ExpectedBranchHeadFull = "fa2e4019d9e7d81ccfffcb16a67f17d1746c6bc8",
	[string]$ExpectedGitFull = "fa2e4019d9e7d81ccfffcb16a67f17d1746c6bc8",
	[string]$ExpectedGit = "fa2e4019d9",
	[string]$ExpectedArchiveSha256 = "E887E7920AAE620A7DFCB20FFD17FFAB5F16DF8B1F40D58E73173DB9CD236B77",
	[string]$ExpectedPackageSize = "7,166,244",
	[string]$ExpectedWikiCommit = "6d0dfa8",
