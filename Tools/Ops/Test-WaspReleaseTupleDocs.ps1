...
[CmdletBinding()]
param(
	[string]$ExpectedBranchHeadFull = "9e628781a8a0e6ed9089d55f5226c2b03031bece",
	[string]$ExpectedGitFull = "9e628781a8a0e6ed9089d55f5226c2b03031bece",
	[string]$ExpectedGit = "9e628781a8",
	[string]$ExpectedArchiveSha256 = "FB52623DAC5CF93EE8E4E9E2B1542E1A531C5EF0FE063AADED33892439027245",
	[string]$ExpectedPackageSize = "7,166,946",
	[string]$ExpectedWikiCommit = "0cc616e",
