...
param(
	...
	[string]$ExpectedArchiveSha256 = "F60F3C7D2C568BB1713A9C550D180B3DFA47C1400C7B1725680B8EFC3BC6B00F",
	[string]$ExpectedPackageSize = "7,167,223",
	[string]$ExpectedWikiCommit = "c27aa57",
