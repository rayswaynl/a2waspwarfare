...
[CmdletBinding()]
param(
	[string]$ExpectedBranchHeadFull = "e2b26027a63b8606dd14fdc248e6cdd3def5f6bd",
	[string]$ExpectedGitFull = "e2b26027a63b8606dd14fdc248e6cdd3def5f6bd",
	[string]$ExpectedGit = "e2b26027a6",
	[string]$ExpectedArchiveSha256 = "3E98F3B65C3D1FA4EB04F02D752EB6484DCDA94411BEAAB3F18E22C77E36678A",
	[string]$ExpectedPackageSize = "7,167,199",
	[string]$ExpectedWikiCommit = "f593b34",
