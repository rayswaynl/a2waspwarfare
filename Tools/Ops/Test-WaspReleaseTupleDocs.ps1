...
[CmdletBinding()]
param(
	[string]$ExpectedBranchHeadFull = "d8f15b554faf7e1a5f08fa037d5db58eac616918",
	[string]$ExpectedGitFull = "d8f15b554faf7e1a5f08fa037d5db58eac616918",
	[string]$ExpectedGit = "d8f15b554f",
	[string]$ExpectedArchiveSha256 = "35B864A10626B8AA92F4C7A7729E1CF889310A8DA8E3BAEE58C09BA2BFC5053E",
	[string]$ExpectedPackageSize = "7,163,413",
	[string]$ExpectedWikiCommit = "99d0ddf",
