...
$report.Add("")
$report.Add("- Hosted/dedicated context:")
$report.Add("- Base safety and sightlines:")
$report.Add("- Central wall/pathing:")
$report.Add("- Side hills/rim behavior:")
$report.Add("- Economy/factory pricing feel:")
$report.Add("- Mystery feature behavior:")
$report.Add("- Recommended Codex action:")
$report.Add("")
