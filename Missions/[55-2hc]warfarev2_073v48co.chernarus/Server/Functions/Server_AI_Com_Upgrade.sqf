...
Private["_can_upgrade","_cost","_funds","_level","_logik","_path","_side","_upgrade","_upgrades","_supplyReserve","_supply","_lastWarnKey","_lastWarnTime","_lastExhaustedKey","_lastExhaustedTime","_nowTime","_currency","_headUpgrade","_headCost","_chosen","_chosenCost"];
