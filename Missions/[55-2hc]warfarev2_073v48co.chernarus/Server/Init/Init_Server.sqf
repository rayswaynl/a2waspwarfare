...
WFBE_SE_FNC_AI_Com_EndgameTeleport = Compile preprocessFileLineNumbers "Server\AI\Commander\AI_Commander_EndgameTeleport.sqf"; //--- END-GAME TELEPORT closer; flag WFBE_C_AICOM_ENDGAME_TELEPORT_ENABLE default 0 = inert.
...
WFBE_SE_FNC_AICOM2_AirStrike = Compile preprocessFileLineNumbers "Server\AI\Commander\AI_Commander_AirStrike.sqf"; //--- AICOM v2 (M7): AIRSTRIKE factory-strike closer (flag WFBE_C_AICOM2_AIRSTRIKE_ENABLE, default 0 = inert/shadow). Owner directive 2026-07-25: give AI commander air the ability to target enemy factories; see PR body for evidence caveats.
