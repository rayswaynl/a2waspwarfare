...
[[Format ["wfbe_supply_temp_%1", str _side], [_side, -_costFoundation, Format ["Star Fortress foundation by commander %1.", _reqName]]], _side, true] Call WFBE_SE_FNC_HandleSideSupplyChange;
