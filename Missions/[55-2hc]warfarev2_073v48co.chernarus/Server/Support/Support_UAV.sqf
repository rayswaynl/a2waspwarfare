...
//--- Post-debit create fail-clean (r34): funds + cooldown were reserved above. Null hull must
//--- restore both or the player pays and is rate-limited for a vehicle that never existed.
