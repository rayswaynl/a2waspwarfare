...
if (isNull _playerTeam || {(side _playerTeam) != _side}) exitWith {["WARNING", Format ["Support_ScudStrike.sqf : denied -- null calling team or team/side mismatch (side %1).", str _side]] Call WFBE_CO_FNC_LogContent};
