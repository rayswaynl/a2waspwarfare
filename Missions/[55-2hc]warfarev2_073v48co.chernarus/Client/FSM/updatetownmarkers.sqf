...
while {!gameOver} do {
	//--- client-FPS: town SV markers are map-only; skip the per-town distance scan + marker writes while
	//--- the map is closed. SpecOps keeps running so its supply-ready cue + countdown still fire off-map.
