...
WFBE_CO_FNC_CanUseUAV2FOB = Compile preprocessFileLineNumbers "Common\Functions\Common_CanUseUAV2FOB.sqf"; //--- shared client/server eligibility; server still re-derives every field.
