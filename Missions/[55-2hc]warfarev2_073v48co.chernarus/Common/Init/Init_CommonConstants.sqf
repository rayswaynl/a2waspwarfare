...
if (isNil "WFBE_C_CMD_TEAM_DOCTRINE")          then {WFBE_C_CMD_TEAM_DOCTRINE = 0};           //--- master: 0 = verb rejected AND the AssignTowns/Allocate doctrine reads never run (byte-identical). 1 = on.
