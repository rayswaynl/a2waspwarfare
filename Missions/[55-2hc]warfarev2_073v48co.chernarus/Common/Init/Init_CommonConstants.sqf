...
//--- Modules.
	...
	if (isNil "WFBE_C_PLAYERS_SUPPORT_ICBM_COST") then {WFBE_C_PLAYERS_SUPPORT_ICBM_COST = 75000}; //--- Commander ICBM call price.
	if (isNil "WFBE_C_PLAYERS_SUPPORT_PARAAMMO_COST") then {WFBE_C_PLAYERS_SUPPORT_PARAAMMO_COST = 9500}; //--- Tactical ammo paradrop call price.
	if (isNil "WFBE_C_PLAYERS_SUPPORT_PARAVEHI_COST") then {WFBE_C_PLAYERS_SUPPORT_PARAVEHI_COST = 3500}; //--- Tactical vehicle paradrop call price.
	if (isNil "WFBE_C_PLAYERS_SUPPORT_PARATROOPERS_COST") then {WFBE_C_PLAYERS_SUPPORT_PARATROOPERS_COST = 8500}; //--- Tactical paratroopers call price.
	if (isNil "WFBE_C_PLAYERS_SUPPORT_UAV_COST") then {WFBE_C_PLAYERS_SUPPORT_UAV_COST = 12500}; //--- Tactical UAV call price.
