...
//--- AI.
	...
	if (isNil "WFBE_C_UNIT_CAMERA_AI_TEAMS")           then {WFBE_C_UNIT_CAMERA_AI_TEAMS = 0};          //--- Lane 178: 1 = Unit Camera also lists live AI-led teams from the side-logic roster as camera-only targets.
