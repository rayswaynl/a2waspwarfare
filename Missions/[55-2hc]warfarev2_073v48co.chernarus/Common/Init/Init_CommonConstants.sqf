...
//--- Units.
	...
	if (isNil "WFBE_C_PATROL_CONVOY_COOLDOWN") then {WFBE_C_PATROL_CONVOY_COOLDOWN = 60};
	if (isNil "WFBE_C_PATROL_CONVOY_MAX_PER_ROUND") then {WFBE_C_PATROL_CONVOY_MAX_PER_ROUND = 300};
