...
missionNamespace setVariable [Format['WFBE_%1_ARTILLERY_RANGES_MAX', _side], if (IS_zargabad_lowpop_map) then {[2800,2200,3200,2400]} else {[7000,5500,9000,8000]}]; //--- Unit max firing range.
