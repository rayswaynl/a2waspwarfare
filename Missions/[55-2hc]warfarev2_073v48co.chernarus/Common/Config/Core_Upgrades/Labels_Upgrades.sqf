...
missionNamespace setVariable [Format["WFBE_C_UPGRADES_DESCRIPTIONS"], [
	...
	"Fields autonomous side patrols (max 3 active) that spawn near your HQ and push toward the frontline, capturing as they go.<br /><br />Level 1: light infantry patrol.<br />Level 2: motorized patrol (requires Light Factory).<br />Level 3: armored patrol (requires Heavy Factory 2).<br />Level 4: Convoys — patrols field a supply truck that pays your team cash at every town stop.<br /><br />Patrol equipment follows your side's tech, and running patrols reduces every player's max AI by 1."
]];
