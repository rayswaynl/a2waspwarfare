...
} forEach [["HQ",_HQ],["BAR",_BAR],["LVF",_LVF],["CC",_CC],["HEAVY",_HEAVY],["AIR",_AIR],["SP",_SP],["AAR",_AAR],["CBR","Land_Antenna"],["RT","Land_Antenna"],["BANK","Land_Mil_hangar_EP1"],["ARTRAD",_ARTRAD],["RES",_RES]];
