...
- **Federal Reserve / Bank Rossii** (`WFBE_C_ECONOMY_BANK`) — 9,500-supply endgame structure, must be built >800 m outside your base, one per side, global map marker both sides (it's a raid objective). Drips a fixed **$6,000 pool split among living owning-side players** every 5 min while the side's HQ stands. Destruction reward: **+10,000 side supply + $25,000 to the killer** (post-balance — was a flat 150k-to-one-wallet whale mechanic).
