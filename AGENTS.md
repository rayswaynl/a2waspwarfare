...
1. Run the lint gate:
   ```
   python Tools\Lint\check_sqf.py --select A3CMD,A3HASH,A3MARKER,A3NUMGATE,A3PRIVATE,A3REVEAL,A3SELECT,A3SORT,A3STRING,BAREEXIT,BOOLCMP,BRACKET,DBLBOM,DEADNOQA,FLAGGATE,GROUPGETVAR,MARKERCOLOR,MARKERTYPE,MILMARKER,NSSETVAR3,PUBVARSV,QUOTEPARITY,TRAILCOMMA --no-classname-index
   ```
