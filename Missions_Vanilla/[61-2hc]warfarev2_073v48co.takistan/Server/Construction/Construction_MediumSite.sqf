...
if (_aicomCommitCheck) then {
	...
	if (!_aicomPlacementOK) exitWith {
		...
		diag_log Format ["CONSTRUCTION|v1|reject|reason=aicom-commit-position-invalid|script=Construction_MediumSite|type=%1|side=%2|pos=%3", _type, str _side, _position];
	};
};
