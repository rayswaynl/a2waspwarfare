/* =====================================================================
   ...
   Takistan-aware replacement for Client\GUI\GUI_Menu_Help.sqf.
...
<t color='" + KEY + "'>CTI</t> (Conquer The Island) pits <t color='" + KEY + "'>West</t> against <t color='" + KEY + "'>East</t> for control of Takistan. Each side is led by a <t color='" + WARN + "'>Commander</t> who builds a base from the <t color='" + WARN + "'>MHQ</t> (Mobile HQ) and reinforces the team with bought units and vehicles.<br /><br />
...
Hold <t color='" + GOLD + "'>Loy Manara</t> -> Czech T-72 at Heavy Factory L4 ($7,000). Hold <t color='" + GOLD + "'>Rasman AF</t> -> RM-70 rocket artillery at Light Factory L4 ($6,800). Unlocks are for the holding side only.<br />",
...
Loy Manara AF and Rasman AF are capturable (40 SV, PMC garrison). Taking one gives a repair point, a permanent 2,000 m CBR and an exclusive hangar with the captured-airfield aircraft pool. Aircraft buy at hangars (green map symbol) when an Air Factory exists.<br />",
