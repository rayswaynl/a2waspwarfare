...
if (_isMan) then {
	...
	//--- Lock / Unlock.
	_vehicle addAction [localize "STR_WF_Unlock","Client\Action\Action_ToggleLock.sqf", [false], 95, false, true, '', 'alive _target && {(locked _target) > 0}'];
	_vehicle addAction [localize "STR_WF_Lock","Client\Action\Action_ToggleLock.sqf", [true], 94, false, true, '', 'alive _target && {(locked _target) == 0}'];
