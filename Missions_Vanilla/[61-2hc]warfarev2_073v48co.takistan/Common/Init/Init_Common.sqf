...
WFBE_CO_FNC_IsHcName = Compile preprocessFileLineNumbers "Common\Functions\Common_IsHcName.sqf"; //--- fix0807b/hc-quoted-names: belt-and-braces HC-name membership test (strips a quote-wrapped candidate before testing WFBE_C_HC_NAMES).
