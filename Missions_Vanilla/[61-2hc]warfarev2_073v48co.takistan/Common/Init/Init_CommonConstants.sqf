...
//--- AI.
	...
	if (isNil "WFBE_C_AICOM_WITHDRAW_NON_HC")         then {WFBE_C_AICOM_WITHDRAW_NON_HC = 0};         //--- opt-in fallback: server-local/non-HC bled teams are released through SetTeamMoveMode/Pos.
