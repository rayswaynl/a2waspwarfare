...
//--- wired (owner-rejected) and antistack is not touched; this is pure lever-retuning of the existing systems.
	if (worldName == "Zargabad") then {
		...
		WFBE_C_AICOM_TEAMS_PC_LOW  = 21;               //--- ZG (owner 2026-07-26, was 9 -> LOW 17-1=16). Rollback: 9.
		WFBE_C_AICOM_TEAMS_PC_MID  = 21;               //--- ZG (owner 2026-07-26, was 7 -> MID 17-1=16). Rollback: 7.
