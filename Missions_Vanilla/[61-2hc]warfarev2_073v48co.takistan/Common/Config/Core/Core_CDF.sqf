...
/* Infantry */
_c = _c + ['CDF_Soldier'];
_i = _i + [['','',150,4,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Engineer'];
_i = _i + [['','',225,5,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Light'];
_i = _i + [['','',175,4,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_GL'];
_i = _i + [['','',180,4,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Militia'];
_i = _i + [['','',160,3,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Medic'];
_i = _i + [['','',210,4,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Sniper'];
_i = _i + [['','',230,5,-1,2,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Spotter'];
_i = _i + [['','',240,6,-1,2,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Marksman'];
_i = _i + [['','',235,7,-1,4,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_RPG'];
_i = _i + [['','',250,6,-1,2,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Strela'];
_i = _i + [['','',400,6,-1,3,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_AR'];
_i = _i + [['','',165,6,-1,2,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_MG'];
_i = _i + [['','',180,5,-1,1,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_TL'];
_i = _i + [['','',210,6,-1,3,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Officer'];
_i = _i + [['','',230,7,-1,2,0,1,'CDF',[]]];

_c = _c + ['CDF_Commander'];
_i = _i + [['','',280,7,-1,4,0,1,'CDF',[]]];

_c = _c + ['CDF_Soldier_Pilot'];
_i = _i + [['','',130,5,-1,1,0,1,'CDF',[]]];
