...
missionNamespace setVariable [Format['WFBE_%1_ARTILLERY_WEAPONS', _side], ['D30','2B14','GRAD','GRAD']]; //--- Weapon classname.
...
missionNamespace setVariable [Format['WFBE_%1_ARTILLERY_RANGES_MAX', _side], [8000,7500,9000,9000]]; //--- Unit max firing range.
...
missionNamespace setVariable [Format['WFBE_%1_ARTILLERY_VELOCITIES', _side], [500,475,550,550]]; //--- Projectile fall velocity.
