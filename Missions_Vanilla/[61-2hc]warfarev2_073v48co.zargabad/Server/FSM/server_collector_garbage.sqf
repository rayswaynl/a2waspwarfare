...
while {!WFBE_GameOver} do {
	...
	{
		if (!isNull _x && {isNil {_x getVariable "wfbe_trashable"} && isNil {_x getVariable "wfbe_trashed"} && !(_x getVariable ["wfbe_airlifted", false]) && !(_x in gc_collector)  && (_x != _whq) && (_x != _ehq)}) then {
