Private ["_building","_built","_config","_crew","_direction","_dir","_distance","_factoryType","_factoryPosition","_id","_index","_isVehicle","_longest","_position","_price","_queu","_queu2","_refunded","_ret","_side","_sideID","_sideText","_soldier","_team","_turrets","_type","_unitConfig","_unitType","_unitTypeGet","_vehicle","_waitTime"];
_id = _this select 0;
