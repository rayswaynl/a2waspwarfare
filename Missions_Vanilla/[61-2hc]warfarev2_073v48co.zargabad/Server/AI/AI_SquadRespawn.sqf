Private ["_availableSpawn","_autonomous","_buildings","_campBunker","_checks","_closestRespawn","_deadspawnGuardApplied","_deathLoc","_enemySide","_hq","_isForcedRespawn","_leader","_liveSpawn","_loadout","_mobileRespawns","_moveMode","_pos","_ran","_range","_rcm","_rd","_respawn","_respawnLoc","_side","_sideID","_sideText","_team","_update","_upgrades"];
