...
if (IS_chernarus_map_dependent) then {
    ...
    _u = _u		+ ['T810_ACR']; //--- fable/acr-activation: old name never existed (Core_ACR cmdcon44n, verified vs wheeled_acr.pbo)
    _u = _u		+ ['T810Repair_ACR']; //--- fable/acr-activation: corrected
    _u = _u		+ ['T810Refuel_ACR']; //--- fable/acr-activation: corrected
    _u = _u		+ ['T810Reammo_ACR']; //--- fable/acr-activation: corrected
    _u = _u		+ ['RHIB'];
    _u = _u		+ ['RHIB2Turret'];
    _u = _u		+ ['LAV25'];
    _u = _u		+ ['BAF_ATV_W'];
