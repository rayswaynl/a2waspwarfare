...
missionNamespace setVariable [Format['WFBE_%1_ARTILLERY_WEAPONS', _side], ['M119','M252','MLRS','M120','GRAD']]; //--- Weapon classname.
...
missionNamespace setVariable [Format['WFBE_%1_ARTILLERY_RANGES_MAX', _side], [8000,7500,9000,6500,9000]]; //--- Unit max firing range.
...
missionNamespace setVariable [Format['WFBE_%1_ARTILLERY_BURST', _side], [10,4,6,6,10]]; //--- Burst sent per fire mission.
missionNamespace setVariable [Format['WFBE_%1_ARTILLERY_VELOCITIES', _side], [500,475,550,475,550]]; //--- Projectile fall velocity.
