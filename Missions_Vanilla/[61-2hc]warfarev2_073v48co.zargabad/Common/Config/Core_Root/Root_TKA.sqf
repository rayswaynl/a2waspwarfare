...
if (isServer) then {
	...
	missionNamespace setVariable [Format["WFBE_%1_PATROL_MEDIUM", _side], [
		...
		['BRDM2_ATGM_TK_EP1','TK_Soldier_SL_EP1','TK_Soldier_HAT_EP1','TK_Soldier_AT_EP1','TK_Soldier_Medic_EP1']
	]];
	...
	missionNamespace setVariable [Format["WFBE_%1_PATROL_HEAVY", _side], [
		...
		['Ural_ZU23_TK_EP1','BMP2_TK_EP1','TK_Soldier_AA_EP1','TK_Soldier_AAT_EP1','TK_Soldier_SL_EP1']
	]];
