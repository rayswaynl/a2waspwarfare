...
//--- AI.
	...
	if (isNil "WFBE_C_NAVAL_TWIN_GAP")                then {WFBE_C_NAVAL_TWIN_GAP = 32};               //--- armed 2026-07-27 owner report ("decks do not touch"): lateral centre-to-centre offset (m) of the twin hull, was hard-coded 42 in Init_NavalHVT.sqf. LHD beam is ~32 m (measured ~16 m half-beam), so 32 = deck edges meet. Tune per restart; rollback 42.
