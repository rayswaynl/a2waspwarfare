...
if (isNil "WFBE_C_SPECTATOR_DIRECTOR") then {WFBE_C_SPECTATOR_DIRECTOR = 0};
...
if (isNil "WFBE_C_SPECTATOR_DIRECTOR_W_TOWN_CONTEST") then {WFBE_C_SPECTATOR_DIRECTOR_W_TOWN_CONTEST = 100};
if (isNil "WFBE_C_SPECTATOR_DIRECTOR_W_TOWN_TREND") then {WFBE_C_SPECTATOR_DIRECTOR_W_TOWN_TREND = 4};
if (isNil "WFBE_C_SPECTATOR_DIRECTOR_W_TOWN_SIZE") then {WFBE_C_SPECTATOR_DIRECTOR_W_TOWN_SIZE = 2};
if (isNil "WFBE_C_SPECTATOR_DIRECTOR_W_TEAM_CONTACT") then {WFBE_C_SPECTATOR_DIRECTOR_W_TEAM_CONTACT = 60};
if (isNil "WFBE_C_SPECTATOR_DIRECTOR_W_TEAM_SIZE") then {WFBE_C_SPECTATOR_DIRECTOR_W_TEAM_SIZE = 3};
if (isNil "WFBE_C_SPECTATOR_DIRECTOR_W_PLAYER_CONTACT") then {WFBE_C_SPECTATOR_DIRECTOR_W_PLAYER_CONTACT = 40};
if (isNil "WFBE_C_SPECTATOR_DIRECTOR_W_PLAYER_BASE") then {WFBE_C_SPECTATOR_DIRECTOR_W_PLAYER_BASE = 5};
if (isNil "WFBE_C_SPECTATOR_DIRECTOR_W_HQ_BASE") then {WFBE_C_SPECTATOR_DIRECTOR_W_HQ_BASE = 10};
if (isNil "WFBE_C_SPECTATOR_DIRECTOR_W_HQ_UNDER_ATTACK") then {WFBE_C_SPECTATOR_DIRECTOR_W_HQ_UNDER_ATTACK = 150};
