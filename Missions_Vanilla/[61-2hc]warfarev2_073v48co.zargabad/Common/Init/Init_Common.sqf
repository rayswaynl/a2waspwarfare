...
WFBE_CO_FNC_SMLCampSplit = Compile preprocessFileLineNumbers "Common\Functions\Common_SMLCampSplit.sqf"; //--- SML-1 (GR-2026-07-03a): camp-split captures; per-unit doStop/doMove with TTL watchdog. Flag WFBE_C_SML_CAMP_SPLIT default 1 (owner-armed).
WFBE_CO_FNC_SMLDismounts = Compile preprocessFileLineNumbers "Common\Functions\Common_SMLDismounts.sqf"; //--- SML-2 (GR-2026-07-03a): real dismounts; cargo infantry dismount for foot assault, crew stays mounted for fire support. Flag WFBE_C_SML_DISMOUNTS default 1 (owner-armed).
WFBE_CO_FNC_SMLRetreat   = Compile preprocessFileLineNumbers "Common\Functions\Common_SMLRetreat.sqf";   //--- SML-3 (GR-2026-07-03a): graceful retreats; mauled individuals pull back with TTL watchdog. Flag WFBE_C_SML_RETREAT default 1 (owner-armed).
WFBE_CO_FNC_SMLOverwatch = Compile preprocessFileLineNumbers "Common\Functions\Common_SMLOverwatch.sqf"; //--- SML-4 (GR-2026-07-03a): AT overwatch; launcher pre-positions on armor approach before assault. Flag WFBE_C_SML_AT_OVERWATCH default 1 (owner-armed).
WFBE_CO_FNC_SMLUnstuck   = Compile preprocessFileLineNumbers "Common\Functions\Common_SMLUnstuck.sqf";   //--- SML-5 (GR-2026-07-03a): surgical unstuck; nudge only individually-wedged units (pre-tier). Flag WFBE_C_SML_SURGICAL_UNSTUCK default 1 (owner-armed).
